...
int16_t PasswordDlg(uint16_t hwnd, uint16_t message, uint16_t wParam, int32_t lParam);                                                                               /* MEMORY_UTILGEN:0x5a72 */
int16_t ProgressGaugeDlg(uint16_t hwnd, uint16_t message, uint16_t wParam, int32_t lParam);                                                                          /* MEMORY_UTILGEN:0x647e */
uint16_t HbrGet(uint32_t cr);                                                                                                                                        /* MEMORY_UTILGEN:0x4448 */
...
uint16_t DibFromBitmap(uint16_t hbm, uint32_t biStyle, uint16_t biBits, uint16_t hpal);                                                                              /* MEMORY_UTILGEN:0x4e90 */
void DrawFuzzyBorder(uint16_t hdc, RECT *prc);                                                                                                                       /* MEMORY_UTILGEN:0x427a */
...
int16_t RandomSeedDlg(uint16_t hwnd, uint16_t message, uint16_t wParam, int32_t lParam);                                                                             /* MEMORY_UTILGEN:0x188a */
...
void StickyDlgPos(uint16_t hwnd, POINT *ppt, int16_t fInit);                                                                                                         /* MEMORY_UTILGEN:0x3094 */
...
void FreeHbr(uint16_t hbr);                                                                                                                                          /* MEMORY_UTILGEN:0x4532 */
int16_t FTrackBtn(BTNT *pbtnt);                                                                                                                                      /* MEMORY_UTILGEN:0x364a */
void IntToRoman(int16_t i, char *pszOut);                                                                                                                            /* MEMORY_UTILGEN:0x5830 */
int16_t NewPasswordDlg(uint16_t hwnd, uint16_t message, uint16_t wParam, int32_t lParam);                                                                            /* MEMORY_UTILGEN:0x5cba */
void WrapTextOut(uint16_t hdc, int16_t *px, int16_t *py, char *psz, int16_t cLen, int16_t xLeft, int16_t dxWidth, int16_t *pxMax, int16_t fNewLine, int16_t fPrint); /* MEMORY_UTILGEN:0x25fe */
int16_t DxStreamTextOut(uint16_t hdc, int16_t *px, int16_t y, char *psz, int16_t cLen, int16_t fPrint);                                                              /* MEMORY_UTILGEN:0x2590 */
...
int32_t LDrawGauge(uint16_t hdc, RECT *prc, int16_t cSegs, int32_t *rgSize, uint16_t *rghbr, int32_t cTot);                                                          /* MEMORY_UTILGEN:0x31a2 */
