...
LRESULT CALLBACK PlanetWndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam); /* MEMORY_PLANET:0x0000 */

void DrawPlanetShipList(HDC hdc, TILE *ptile, OBJ obj);                                                       /* MEMORY_PLANET:0x377e */
void DrawPlanetStarbase(HDC hdc, TILE *ptile, OBJ obj);                                                       /* MEMORY_PLANET:0x22cc */
void DrawPlanetMinSum(HDC hdc, TILE *ptile, OBJ obj);                                                         /* MEMORY_PLANET:0x12b2 */
void DrawCBEntireItem(DRAWITEMSTRUCT *lpdis, int16_t inflate);                                                /* MEMORY_PLANET:0x6128 */
void DrawMassWarpGauge(HDC hdc, RECT *prc, int16_t iBest, int16_t iCur);                                      /* MEMORY_PLANET:0x2afa */
void DrawPlanetProduction(HDC hdc, TILE *ptile, OBJ obj);                                                     /* MEMORY_PLANET:0x2c38 */
void DrawPlanShipBitmap(HDC hdc, TILE *ptile, OBJ obj);                                                       /* MEMORY_PLANET:0x3336 */
int16_t FDrawTileNC(HDC hdc, TILE *ptile, RECT *prc, char *pszTitle);                                         /* MEMORY_PLANET:0x1086 */
void SetPlanetTitleBar(HWND hwnd);                                                                            /* MEMORY_PLANET:0x3dec */
...
void DrawProductionItem(HDC hdc, RECT *prc, char *psz, int16_t inflate, int16_t fSelected, int16_t fListbox); /* MEMORY_PLANET:0x6208 */
void FillPlanetProdLB(HWND hwnd, PLPROD *lpplprod, PLANET *lppl);                                             /* MEMORY_PLANET:0x6692 */
...
void DrawPlanShip(HDC hdc, int16_t grbit);                                                                    /* MEMORY_PLANET:0x0d16 */
void DrawPlanetStats(HDC hdc, TILE *ptile, OBJ obj);                                                          /* MEMORY_PLANET:0x1716 */
