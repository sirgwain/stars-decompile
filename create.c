...
BTLPLAN rgbtlplanT[5] = {
    ...
    {.iplan = 2,
     ...
     .iplrAttack = iplrAttackNeutralsEnemies,
     .szName = "Max-Defense"},
    {.iplan = 3, .mdTactic = mdTacticDisengageIfChallenged, .mdTarget1 = mdTargetUnarmedShips, .iplrAttack = iplrAttackNeutralsEnemies, .szName = "Sniper"},
    {.iplan = 4, .mdTarget1 = mdTargetAny, .iplrAttack = iplrAttackNeutralsEnemies, .szName = "Chicken"}};
char   rgNG3Width[9][2] = {{-3, 0}, {2, 1}, {5, 0}, {-3, 0}, {3, 0}, {3, 0}, {3, 0}, {1, 0}, {3, 0}};
