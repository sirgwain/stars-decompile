...

{
    ...
    if (sVar4 == 1) {
        ...
        pSVar8 = &shdef;
        uVar7 = part.u_PART_0x0004.parmor._0_2_;
        for (iVar5 = 0x3d; iVar5 != 0; iVar5 = iVar5 + -1) {
            pSVar2 = pSVar8;
            pSVar8 = (pSVar8->hul).rgTech;
            pAVar1 = (ARMOR *)uVar7;
            uVar7 = ((ARMOR *)uVar7)->rgTech;
            (pSVar2->hul).ihuldef = pAVar1->id;
        }
        *&(pSVar8->hul).ihuldef = (char)((ARMOR *)uVar7)->id;
        shdef.hul.ihuldef = lphul->ihuldef;
        for (ihs = 0; ihs < (int)(uint)(part.u_PART_0x0004.phul._0_2_)->chs; ihs = ihs + 1) {
            sVar4 = FGetAIPart((uint)((byte *)rgaip)[ihs], &part);
            if (sVar4 == 0) {
                return 0;
            }
            uVar6 = part.hs.wFlags_0x2 & 0xff | *(uint *)(part.u_PART_0x0004.parmor._0_2_[1].szName + ihs * 4 + -2) & 0xff00;
            part.hs.wFlags_0x2 = uVar6;
            (shdef.hul.rghs + ihs)->grhst = part.hs.grhst;
            shdef.hul.rghs[ihs].wFlags_0x2 = uVar6;
        }
        ...
        if (ishdef < 0) {
            ...
            *&(pSVar9->hul).ihuldef = (char)(pSVar8->hul).ihuldef;
            ...
            PickANameAndBmp(&shdef, ids, cItem, (part.u_PART_0x0004.parmor._0_2_)->ibmp);
...

{
    ...
    if ((pshdef->wFlags >> 10 & 0x1f) < 0x10) {
        for (ishdef = 0; ishdef < 0x10; ishdef = ishdef + 1) {
            if (((*(uint *)((int)&rgshdef[0].wFlags + ishdef * 0x93) >> 9 & 1) == 0) && (*(HullDef *)(ishdef * 0x93 + rgshdef) == (pshdef->hul).ihuldef)) {
                rgfBmpUsed[*(int *)((int)&rgshdef[0].hul + 0x32 + ishdef * 0x93) - ibmpStart] = 1;
            }
        }
    } else {
        for (ishdef = 0; ishdef < 10; ishdef = ishdef + 1) {
            if (((*(uint *)(*(int *)(idPlayer * 4 + rglpshdefSB) + ishdef * 0x93 + 0x7b) >> 9 & 1) == 0) &&
                (*(HullDef *)(*(int *)(idPlayer * 4 + rglpshdefSB) + ishdef * 0x93) == (pshdef->hul).ihuldef)) {
                rgfBmpUsed[*(int *)(*(int *)(idPlayer * 4 + rglpshdefSB) + ishdef * 0x93 + 0x32) - ibmpStart] = 1;
            }
        }
    }
    ...
    do {
        if (0x13 < i) {
            ...
            _wsprintf((pshdef->hul).szClass, "%s %d", pcVar2, 0x1120);
            return;
        }
        ...
        if ((pshdef->wFlags >> 10 & 0x1f) < 0x10) {
            ishdef = 0;
            while ((ishdef < 0x10 && (((*(uint *)((int)&rgshdef[0].wFlags + ishdef * 0x93) >> 9 & 1) != 0 ||
                                       (sVar1 = _strcmp((pshdef->hul).szClass, (char *)((int)&rgshdef[0].hul + 8 + ishdef * 0x93)), sVar1 != 0))))) {
                ishdef = ishdef + 1;
            }
            if (ishdef == 0x10) {
                return;
            ...
            ishdef = 0;
            while ((ishdef < 10 &&
                    ((((*(uint *)(*(int *)(idPlayer * 4 + rglpshdefSB) + ishdef * 0x93 + 0x7b) >> 9 & 1) != 0 ||
                       (*(HullDef *)(*(int *)(idPlayer * 4 + rglpshdefSB) + ishdef * 0x93) != (pshdef->hul).ihuldef)) ||
                      (sVar1 = __fstrcmp((pshdef->hul).szClass, (char *)CONCAT22(*(undefined2 *)(idPlayer * 4 + rglpshdefSB_0x2),
                                                                                 (char *)(*(int *)(idPlayer * 4 + rglpshdefSB) + ishdef * 0x93 + 8))),
                       sVar1 != 0))))) {
                ishdef = ishdef + 1;
            }
            if (ishdef == 10) {
...

{
    ...
    for (iVar6 = 0x49; iVar6 != 0; iVar6 = iVar6 + -1) {
        pSVar4 = pSVar7;
        pSVar7 = (pSVar7->hul).rgTech;
        pSVar3 = pshdef;
        pshdef = (pshdef->hul).rgTech;
        (pSVar4->hul).ihuldef = (pSVar3->hul).ihuldef;
    }
    *&(pSVar7->hul).ihuldef = (char)(pshdef->hul).ihuldef;
    shdef.wFlags = shdef.wFlags & 0x83ff | (ishdef & 0x1fU) << 10;
    ...
    if (ishdef < 0x10) {
        lpshdefBase._0_2_ = (SHDEF *)*(undefined2 *)(idPlayer * 4 + rglpshdef);
        lpshdefBase._2_2_ = *(undefined2 *)(idPlayer * 4 + rglpshdef_0x2);
        ishdefWork = ishdef;
    } else {
        lpshdefBase._0_2_ = (SHDEF *)*(undefined2 *)(idPlayer * 4 + rglpshdefSB);
        lpshdefBase._2_2_ = *(undefined2 *)(idPlayer * 4 + rglpshdefSB_0x2);
        ishdefWork = ishdef + -0x10;
    }
    UpdateShdefCost(&shdef);
    if ((shdef.wFlags >> 9 & 1) == (((SHDEF *)lpshdefBase)[ishdefWork].wFlags >> 9 & 1)) {
        if ((((SHDEF *)lpshdefBase)[ishdefWork].wFlags >> 9 & 1) == 0) {
            ((SHDEF *)lpshdefBase)[ishdefWork].wFlags = ((SHDEF *)lpshdefBase)[ishdefWork].wFlags & 0xfdff | 0x200;
        ...
        if (ishdef < 0x10) {
            ...
            *pcVar2 = *pcVar2 + (char)iVar6;
            ...
            iVar5 = *(int *)((int)&rgplr[0].wFlags_0x4 + idPlayer * 0xc0);
    ...
    *&(pSVar8->hul).ihuldef = (char)(pSVar7->hul).ihuldef;
...

{
    ...
    if (cQuan == 0) {
        ...
        lVar3 = ChgCargo(grobjSrc, idSrc, iSupply, 0, 0);
        if (lVar3 < cQuan) {
            cQuan = (short)lVar3;
        }
        if (cQuan == 0) {
            ...
            lVar3 = ChgCargo(grobjDst, idDst, iSupply, (long)cQuan, 0);
            sVar2 = (short)lVar3;
            if (sVar2 != 0) {
                ChgCargo(grobjSrc, idSrc, iSupply, (long)-sVar2, 0);
            }
        }
    }
    return sVar2;
...

{
    ...
    if (cQuan == 0) {
        ...
        lVar2 = ChgCargo(grobjFleet, idSrc, 3, 0, 0);
        ...
        if (cQuan == 0) {
            ...
            ChgCargo(grobjFleet, idSrc, 3, (long)-cQuan, 0);
            ChgCargo(grobjPlanet, idDst, 3, (long)cQuan, 0);
        }
    }
    return cQuan;
}
...

{
    ...
    if ((*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd == 0) || (*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd == 5)) {
        iVal._0_1_ = 0;
    } else {
        iVal._0_1_ = 0x10;
        if (fMarkedPlanets != 0)
            goto AIU_LFindNearest;
    }
    ...
    for (ifl = 0; ifl < cFleet; ifl = ifl + 1) {
        ...
        if ((pFVar1 == 0) && (iVar5 == 0))
            break;
        if ((((pFVar1->iPlayer == idPlayer) && ((1 < pFVar1->cord && (lpflCol != (FLEET *)CONCAT22(iVar5, pFVar1))))) &&
             ((((PLORD *)pFVar1->lpplord + 7)->wFlags >> 8 & 0xf) == 1)) &&
            (((*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd != 0 && (*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd != 5)) ||
...
AIU_LFindNearest:
    ...
    for (i = 0; i < game.cPlanMax; i = i + 1) {
        if (*lpb == 0) {
            ...
            if (((sVar2 < d2_00) && (sVar3 < d2_00)) && (uVar7 = __aFulmul((long)sVar2, (long)sVar2), (long)uVar7 < d2_00)) {
    ...
    if (plpthWorm != 0) {
        *plpthWorm = 0;
        ...
        if ((((FLEET *)lpflCol)->idPlanet != -1) && (game.turn < 0x78)) {
            ...
            if ((((PLANET *)pPVar9 != 0) || (iVar5 != 0)) && (((PLANET *)pPVar9)->iPlayer == idPlayer)) {
                pTVar10 = LpthWormFind(&pt, d2_00);
                *plpthWorm = (THING *)pTVar10;
                plpthWorm[1] = (THING *)((ulong)pTVar10 >> 0x10);
            }
        }
        if ((*plpthWorm != 0) || (plpthWorm[1] != 0)) {
            idBest = -1;
        }
    }
    return idBest;
...

{
    ...
    while ((THING *)lpth < pTVar5) {
        ...
        if (lpth->idFull >> 0xd == 2) {
            ...
            if (((int)uVar3 <= lVar8) && ((iVar6 < 0 || ((iVar6 < 1 && (uVar3 < 0xb641)))))) {
                ...
                if ((pctGood < iVal) || (((iVal == pctGood && (iVar6 <= d2Worm._2_2_)) && ((iVar6 < d2Worm._2_2_ || (uVar3 < (uint)d2Worm)))))) {
                    pctGood = iVal;
    ...
    if ((((THING *)lpthBest == 0) && (lpthBest._2_2_ == 0)) || (sVar1 = Random(100), pctGood <= sVar1)) {
        lpthBest._0_2_ = 0;
        lpthBest._2_2_ = 0;
    }
...

{
    ...
    do {
        ...
        if (pFVar4->rgcsh[ishdef] != 0) {
            iVar5 = iVar1 * 4;
            uVar2 = *(undefined2 *)(iVar5 + rglpshdef_0x2);
            iVar5 = *(int *)(iVar5 + rglpshdef) + ishdef * 0x93;
            uVar7 = __aFulmul(CONCAT22(*(undefined2 *)(iVar5 + 0x89), *(undefined2 *)(iVar5 + 0x87)), (long)pFVar4->rgcsh[ishdef]);
            uVar3 = uVar7 + uVar3;
...

{
    ...
    if (fMarkedPlanets == 0) {
        IdNearestColonizablePlanet(lpfl, 0);
    }
    lpb = (byte *)CONCAT22(vlpbAiPlanet._2_2_, (byte *)vlpbAiPlanet + 0xf);
    d2_00 = 99999999;
    ...
    for (i = 0; i < game.cPlanMax; i = i + 1) {
        if (*lpb == 0x10) {
            ...
            if (((sVar2 < d2_00) && (sVar1 < d2_00)) && (uVar3 = __aFulmul((long)sVar2, (long)sVar2), (long)uVar3 < d2_00)) {
...

{
    ...
    do {
        ...
        if ((*(int *)&pPVar2->lpplprod != 0) || (*(int *)((int)&pPVar2->lpplprod + 2) != 0)) {
            ...
            uVar11 = __aFulshr(CONCAT22(prod.dwFlags._2_2_, (ushort)prod.dwFlags), 0x11);
            if (((uint)uVar11 & 7) == 1) {
                uVar11 = __aFulshr(CONCAT22(prod.dwFlags._2_2_, (ushort)prod.dwFlags), 10);
            ...
            LAB_1090_18c8:
                ...
                PszProductionETA(&sel.pl, sel.pl.lpplprod, 0, &etaFirst, 0);
                if (etaFirst != 1) {
                    if (etaFirst == -1) {
                        etaFirst = 600;
                    }
                    GetProductionCosts((PLANET *)CONCAT22(iVar3, pPVar2), &prod, rgCost, idPlayer, 1);
                    cRes._0_2_ = CResourcesAtPlanet(&sel.pl, idPlayer);
                    cRes._2_2_ = (int)(uint)cRes >> 0xf;
                    uVar11 = __aFulshr(CONCAT22(sel.pl.rgbImp._6_2_, sel.pl.rgbImp._4_2_), 0x17);
                    if ((uVar11 & 1) == 0) {
                        uVar9 = 0;
                        uVar8 = 100;
                        uVar11 = __aFulmul((long)(int)(uint)cRes, (long)(int)*(char *)((int)&rgplr[0].pctResearch + idPlayer * 0xc0));
                    ...
                    if (CONCAT22(rgCost[3]._2_2_, (undefined2)rgCost[3]) <= (long)uVar11) {
                        uVar11 = __aFulshr(CONCAT22(sel.pl.rgbImp._2_2_, sel.pl.rgbImp._0_2_), 8);
                        ...
                        if (cBuild < 1) {
                            ...
                            FinishProduction(1);
                            PszProductionETA(&sel.pl, sel.pl.lpplprod, 1, &etaBetterMines, 0);
                            if (etaBetterMines == -1) {
                                etaBetterMines = 700;
                            }
                            ...
                            (pPVar7 + 1)->wFlags = (pPVar7 + 1)->wFlags & 0xfc00 | 1;
                            *(undefined2 *)&pPVar7[1].iprodMax = uVar8;
                            uVar8 = (undefined2)((ulong)sel.pl.lpplprod >> 0x10);
                            pPVar7 = (PLPROD *)sel.pl.lpplprod;
                            uVar4 = *(uint *)&pPVar7[1].iprodMax;
                            (pPVar7 + 1)->wFlags = (pPVar7 + 1)->wFlags & 0x3ff | 0xc00;
                            *(uint *)&pPVar7[1].iprodMax = uVar4 & 0xfffe;
                        }
                        PszProductionETA(&sel.pl, sel.pl.lpplprod, 1, &etaBetterAlchemy, 0);
                        if (etaBetterAlchemy == -1) {
                            etaBetterAlchemy = 700;
                        }
                        if (((etaFirst <= etaBetterAlchemy) || (etaBetterMines <= etaBetterAlchemy)) && (0 < cBuild)) {
                            uVar8 = (undefined2)((ulong)sel.pl.lpplprod >> 0x10);
                            pPVar7 = (PLPROD *)sel.pl.lpplprod;
                            uVar4 = *(uint *)&pPVar7[1].iprodMax;
                            (pPVar7 + 1)->wFlags = (pPVar7 + 1)->wFlags & 0x3ff | 0x2000;
                            *(uint *)&pPVar7[1].iprodMax = uVar4 & 0xfffe;
                            if ((etaFirst < etaBetterMines) || (cBuild < 1)) {
                                ...
                                *pbVar1 = *pbVar1 - 1;
                                uVar8 = (undefined2)((ulong)sel.pl.lpplprod >> 0x10);
                                pPVar7 = (PLPROD *)sel.pl.lpplprod;
                                __fmemmove((PLPROD *)CONCAT22(uVar8, pPVar7 + 1), (PLPROD *)CONCAT22(uVar8, pPVar7 + 2), (uint)pPVar7->iprodMac << 2);
                            } else {
                                lVar12 = __aFlshl((ulong)((ushort)cBuild & 0x3ff), 0);
                                uVar8 = (undefined2)((ulong)sel.pl.lpplprod >> 0x10);
                                pPVar7 = (PLPROD *)sel.pl.lpplprod;
                                uVar4 = *(uint *)&pPVar7[1].iprodMax;
                                (pPVar7 + 1)->wFlags = (pPVar7 + 1)->wFlags & 0xfc00 | (uint)lVar12;
...

{
    ...
    return (uint)((long)(uVar7 + uVar6) < CONCAT22(*(undefined2 *)((int)&pTVar3->u_THING_0x0006 + 2), ((&pTVar3->u_THING_0x0006)->thp).wFlags));
}
...

{
    ...
    if (bVar2) {
        ...
        i = IWarpBestForWaypoint(lpfl, (ORDER *)CONCAT22(*(undefined2 *)((int)&pFVar5->lpplord + 2), (ORDER *)(*(int *)&pFVar5->lpplord + 0x16)));
    }
    if (i != (((PLORD *)pFVar5->lpplord + 7)->wFlags >> 4 & 0xf)) {
        uVar7 = (undefined2)((ulong)sel.fl.lpplord >> 0x10);
        ((PLORD *)sel.fl.lpplord + 7)->wFlags = ((PLORD *)sel.fl.lpplord + 7)->wFlags & 0xff0f | (i & 0xfU) << 4;
...

{
    ...
    while (true) {
        if (((FLEET *)lpflT == 0) && (lpflT._2_2_ == 0))
            break;
        if ((fOnlyHumans == 0) || ((*(uint *)((int)&rgplr[0].wMdPlr + ((FLEET *)lpflT)->iPlayer * 0xc0) >> 9 & 1) == 0)) {
            lpflAtk2 = lpflAtk;
            cShipsDst = 0;
            while (true) {
                if (lpflAtk2 == 0)
                    break;
                if ((((lpfl != lpflAtk2) && (1 < ((FLEET *)lpflAtk2)->cord)) && (*(int *)&((PLORD *)((FLEET *)lpflAtk2)->lpplord)[6].iordMax == lpflT->id)) &&
                ...
                /* WARNING: Load size is inaccurate */
                lpflAtk2 = (FLEET *)CONCAT22(*(undefined2 *)((int)&((FLEET *)lpflAtk2)->lpflNext + 2), ((FLEET *)lpflAtk2)->lpflNext);
            }
            if (((cShipsDst < 1) || (sVar2 = Random(3), sVar2 != 0)) &&
                ((cShipsDst * 5 - cShipsAtk == 0 || cShipsDst * 5 < cShipsAtk || (sVar2 = Random(0xf), sVar2 != 0)))) {
    ...
    if (lVar9 < 0x7e90) {
        ...
        if (((FLEET *)lpflClosest == 0) && (lpflClosest._2_2_ == 0)) {
            if (fOnlyHumans != 0) {
            ...
            uVar11 = 0;
            uVar10 = 2;
            lVar9 = LGetFleetStat(lpfl, grStatFuel);
            lVar9 = __aFldiv(lVar9, CONCAT22(uVar11, uVar10));
            iVar6 = (int)((ulong)lVar9 >> 0x10);
            iVar1 = *(int *)((int)((FLEET *)lpfl)->rgwtMin + 0x12);
            if ((iVar1 <= iVar6) &&
                (((iVar1 < iVar6 || (*(uint *)(((FLEET *)lpfl)->rgwtMin + 4) < (uint)lVar9)) && (sVar2 = FMoveToNearestStarbase(lpfl, 0), sVar2 != 0)))) {
                return 0;
            }
            ...
            while ((PLANET *)lppl < pPVar5) {
                lpflAtk2 = lpflAtk;
                while (true) {
                    if ((lpflAtk2 == 0) || (((lpfl != lpflAtk2 && (1 < ((FLEET *)lpflAtk2)->cord)) &&
                                             ((*(int *)&((PLORD *)((FLEET *)lpflAtk2)->lpplord)[6].iordMax == lppl->id &&
                                               ((((PLORD *)((FLEET *)lpflAtk2)->lpplord + 7)->wFlags >> 8 & 0xf) == 1))))))
                        break;
                    /* WARNING: Load size is inaccurate */
                    lpflAtk2 = (FLEET *)CONCAT22(*(undefined2 *)((int)&((FLEET *)lpflAtk2)->lpflNext + 2), ((FLEET *)lpflAtk2)->lpflNext);
                }
            ...
            if ((((PLANET *)lpplClosest != 0) || (lpplClosest._2_2_ != 0)) && (lpplClosest->id != ((FLEET *)lpfl)->idPlanet)) {
...
AIU_ThwakSumthin:
    if (((((FLEET *)lpfl)->cord < 2) || ((((PLORD *)((FLEET *)lpfl)->lpplord + 7)->wFlags >> 8 & 0xf) != 1)) || ((ord.wFlags_0x6 >> 8 & 0xf) != 1)) {
...

{
    ...
    ishFreighter = 0;
    while (true) {
        if ((0xf < ishFreighter) || (0 < ((FLEET *)lpflFr)->rgcsh[ishFreighter]))
            break;
        ishFreighter = ishFreighter + 1;
    }
    lWorst._0_2_ = 0xca00;
    lWorst._2_2_ = 0x3b9a;
    lWorst2._0_2_ = 0xca00;
    lWorst2._2_2_ = 0x3b9a;
    i = 0;
    while (true) {
        if (2 < i)
            break;
        uVar1 = *(uint *)((int)(((PLANET *)lpplHome)->rgwtMin + i) + 2);
        if (((int)uVar1 <= lWorst._2_2_) && (((int)uVar1 < lWorst._2_2_ || (*(uint *)(((PLANET *)lpplHome)->rgwtMin + i) < (uint)lWorst)))) {
            lWorst2._0_2_ = (uint)lWorst;
            lWorst2._2_2_ = lWorst._2_2_;
            iWorst2 = iWorst;
    ...
    lVar11 = __aFlshr(CONCAT22(lWorst2._2_2_, (uint)lWorst2), 1);
    fNeedy = (short)(CONCAT22(lWorst._2_2_, (uint)lWorst) < lVar11);
    lVar11 = __aFlshr(CONCAT22(lWorst2._2_2_, (uint)lWorst2), 2);
    if (CONCAT22(lWorst._2_2_, (uint)lWorst) < lVar11) {
        fNeedy = fNeedy + 1;
    }
    for (ifl = 0; ifl < cFleet; ifl = ifl + 1) {
        /* WARNING: Load size is inaccurate */
        ...
        if ((pFVar2 == 0) && (iVar4 == 0))
            break;
        if (((pFVar2->iPlayer == idPlayer) && (((1 < pFVar2->cord && (lpflFr != lpfl)) && ((((PLORD *)pFVar2->lpplord + 7)->wFlags >> 8 & 0xf) == 1)))) &&
            ((pFVar2->rgcsh[ishFreighter] != 0 && (*(int *)&((PLORD *)pFVar2->lpplord)[6].iordMax != lpplHome->id)))) {
    ...
    lVar11 = wtCargoMax;
    uVar12 = __aFulmul(wtCargoFree, 100);
    lVar11 = __aFldiv(uVar12, lVar11);
    pctFull = 100 - (int)lVar11;
    lVar11 = 0;
    idBest = -1;
    ...
    while ((PLANET *)lppl < pPVar6) {
        if ((lppl->id == ((FLEET *)lpflFr)->idPlanet) || (((byte *)vlpbAiPlanet)[lppl->id * 0x10 + 0xe] != 0))
            goto LAB_1090_3272;
        uVar9 = (undefined2)((ulong)lppl >> 0x10);
        if ((((PLANET *)lppl)->iPlayer == -1) && ((((byte *)vlpbAiPlanet)[lppl->id * 0x10 + 1] & 0x80) != 0)) {
            iVar4 = pt.x - ((POINT *)rgptPlan + lppl->id)->x;
            dy = pt.y - *(int *)((int)&rgptPlan[0].y + lppl->id * 4);
            uVar12 = __aFulmul((long)dy, (long)dy);
            uVar14 = __aFulmul((long)iVar4, (long)iVar4);
            uVar10 = 0;
            uVar9 = 0x19;
            _sqrt((double)(long)(uVar14 + uVar12));
            lVar13 = __ftol((double)CONCAT26(unaff_SI, CONCAT24(unaff_DI, CONCAT22(uVar10, uVar9))));
            l = __aFldiv(lVar13 + 0x18, CONCAT22(uVar10, uVar9));
            if (((int)((ulong)l >> 0x10) < 1) && ((l < 0 || ((int)l == 0)))) {
                l = 1;
            }
            lVar13 = __aFldiv((long)(int)((((byte *)vlpbAiPlanet)[lppl->id * 0x10 + 1] & 0x7f) * 500), l);
            goto AIU_LScore;
        }
        if (((PLANET *)lppl)->iPlayer != idPlayer) {
            if (((*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd != 0) || (lpplHome->id != ((FLEET *)lpflFr)->idPlanet)) ||
                (((iVar4 = *(int *)((int)((PLANET *)lpplHome)->rgwtMin + 0xe),
                   iVar4 < 0 || (((iVar4 < 1 && (*(uint *)(((PLANET *)lpplHome)->rgwtMin + 3) < 0x44d)) || (0x3d < (((PLANET *)lppl)->uGuesses & 0xfff))))) &&
                  ((iVar4 = *(int *)((int)((PLANET *)lpplHome)->rgwtMin + 0xe),
                    iVar4 < 0 ||
                        (((iVar4 < 1 && (*(uint *)(((PLANET *)lpplHome)->rgwtMin + 3) < 0x12d)) || (0xe < (((PLANET *)lppl)->uGuesses & 0xfff))))))))) {
                if (((((byte *)vlpbAiPlanet)[lppl->id * 0x10 + 3] == 0) || ((((byte *)vlpbAiPlanet)[lppl->id * 0x10 + 3] & 0x80) != 0)) ||
        ...
        AIU_ScorePctHere:
            ...
            lVar13 = __aFldiv((long)(pctHere * 100), l);
            goto AIU_LScore;
        }
    LAB_1090_2e39:
        if (lpplHome == lppl) {
            if (0x22 < pctFull) {
                if (pctFull == 100) {
                    ...
                    _sqrt((double)(long)(uVar14 + uVar12));
                    lVar13 = __ftol((double)CONCAT26(unaff_SI, CONCAT24(unaff_DI, CONCAT22(uVar10, uVar9))));
                    lVar13 = __aFldiv(lVar13 + 0x18, CONCAT22(uVar10, uVar9));
                    if (((int)lVar13 == 0) && ((int)((ulong)lVar13 >> 0x10) == 0))
                        goto LAB_1090_3272;
                    lVar13 = __aFldiv((long)(pctFull * 0x14), lVar13);
                }
            AIU_LScore:
                if (lVar11 < lVar13) {
                    lpplBest = lppl;
            ...
            if ((*(int *)&((PLANET *)lppl)->lpplprod != 0) || (*(int *)((int)&((PLANET *)lppl)->lpplprod + 2) != 0)) {
                ...
                uVar12 = __aFulshr(CONCAT22(*(undefined2 *)&pPVar8[1].iprodMax, (pPVar8 + 1)->wFlags), 0x11);
                if (((uint)uVar12 & 7) == 2) {
                    pPVar3 = ((PLANET *)lppl)->lpplprod;
                    uVar9 = (undefined2)((ulong)pPVar3 >> 0x10);
                    pPVar8 = (PLPROD *)pPVar3;
                    uVar12 = __aFulshr(CONCAT22(*(undefined2 *)&pPVar8[1].iprodMax, (pPVar8 + 1)->wFlags), 10);
                    if (0xf < ((uint)uVar12 & 0x7f))
                        goto LAB_1090_3272;
                }
            }
            if (((((byte *)vlpbAiPlanet)[lppl->id * 0x10 + 2] != 0) && ((((byte *)vlpbAiPlanet)[lppl->id * 0x10 + 2] & 0x80) == 0)) &&
                (lpplHome->id == ((FLEET *)lpflFr)->idPlanet)) {
                lVar13 = 25000;
                goto AIU_LScore;
            }
            if (fNeedy == 2) {
                wtPlanCargo = CONCAT22(*(undefined2 *)((int)(((PLANET *)lppl)->rgwtMin + iWorst) + 2), (int)((PLANET *)lppl)->rgwtMin[iWorst]);
            } else {
                wtPlanCargo = 0;
                for (i = 0; i < 3; i = i + 1) {
                    if ((fNeedy == 0) || (i == iWorst)) {
                        wtPlanCargo = wtPlanCargo + CONCAT22(*(undefined2 *)((int)(((PLANET *)lppl)->rgwtMin + i) + 2), (int)((PLANET *)lppl)->rgwtMin[i]);
                    } else {
                        lVar13 = __aFlshr(CONCAT22(*(undefined2 *)((int)(((PLANET *)lppl)->rgwtMin + i) + 2), (int)((PLANET *)lppl)->rgwtMin[i]), 1);
                        wtPlanCargo = lVar13 + wtPlanCargo;
                    }
                }
            }
            if (9 < wtPlanCargo) {
                lVar13 = wtCargoMax;
                uVar12 = __aFulmul(wtPlanCargo, 100);
                lVar13 = __aFldiv(uVar12, lVar13);
                pctHere = (short)lVar13;
    ...
    lpthBest = 0;
    sVar5 = FSalvageTargetFreighter2(lpflFr, fNeedy, iWorst, pctFull, wtCargoMax, lVar11, &lpthBest, &idBest);
    if (sVar5 != 0) {
        lVar11 = GetCargoFree(lpflFr);
        if (lVar11 == 0) {
            lpthBest = 0;
            lpplBest = lpplHome;
            idBest = lpplHome->id;
    ...
    _memset(&ord, 0, 0x12);
    if (((THING *)lpthBest == 0) && (lpthBest._2_2_ == 0)) {
        ord.wFlags_0x6 = ord.wFlags_0x6 & 0xf0ff | 0x100;
        ord.pt.x = ((POINT *)rgptPlan + idBest)->x;
        ord.pt.y = *(short *)((int)&rgptPlan[0].y + idBest * 4);
    } else {
        ord.wFlags_0x6 = ord.wFlags_0x6 & 0xf0ff | 0x800;
        ord.pt.x = (&((THING *)lpthBest)->pt)->x;
        ord.pt.y = (((THING *)lpthBest)->pt).y;
    }
    ord.id = idBest;
    ord.wFlags_0x6 = ord.wFlags_0x6 & 0xef00 | 0x1041;
    i = 0;
    while (true) {
        if (2 < i)
            break;
        if ((((THING *)lpthBest == 0) && (lpthBest._2_2_ == 0)) && (idBest == lpplHome->id)) {
            iVar4 = 2;
        } else {
            iVar4 = 1;
        }
        *(uint *)((int)&ord.u_ORDER_0x0008 + i * 2) = *(uint *)((int)&ord.u_ORDER_0x0008 + i * 2) & 0xfff | iVar4 << 0xc;
        i = i + 1;
    }
    if (*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd == 1) {
        if (lpplHome->id == ((FLEET *)lpflFr)->idPlanet) {
            ...
            iVar4 = *(int *)((int)((PLANET *)lpplHome)->rgwtMin + 0xe);
            if ((-1 < iVar4) && ((((0 < iVar4 || (0x4b0 < *(uint *)(((PLANET *)lpplHome)->rgwtMin + 3))) && ((THING *)lpthBest == 0)) &&
                                  ((lpthBest._2_2_ == 0 && (((PLANET *)lpplBest)->iPlayer != -1)))))) {
                iVar4 = *(int *)((int)((PLANET *)lpplHome)->rgwtMin + 0xe);
                iVar7 = *(int *)((int)((PLANET *)lpplBest)->rgwtMin + 0xe);
                if ((iVar7 <= iVar4) && ((iVar7 < iVar4 || (*(uint *)(((PLANET *)lpplBest)->rgwtMin + 3) < *(uint *)(((PLANET *)lpplHome)->rgwtMin + 3))))) {
        ...
        lVar11 = wtCargoFree;
        if (((((THING *)lpthBest == 0) && (lpthBest._2_2_ == 0)) && (((PLANET *)lpplBest)->iPlayer != -1)) && (lpplHome != lpplBest)) {
            ord.u_ORDER_0x0008.txp.rgia[3].wFlags = (ITEMACTION)(ITEMACTION)((uint)ord.u_ORDER_0x0008.txp.rgia[3].wFlags & 0xfff | 0x2000);
        }
    } else {
        lVar11 = wtCargoFree;
        if (((*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd == 0) && (lpplHome->id == ((FLEET *)lpflFr)->idPlanet)) &&
            (((THING *)lpthBest == 0 && ((lpthBest._2_2_ == 0 && (((PLANET *)lpplBest)->iPlayer != -1)))))) {
            if (((PLANET *)lpplBest)->iPlayer == idPlayer) {
                iVar4 = *(int *)((int)((PLANET *)lpplBest)->rgwtMin + 0xe);
                if ((iVar4 < 1) && ((iVar4 < 0 || (*(uint *)(((PLANET *)lpplBest)->rgwtMin + 3) < 1000)))) {
                    uVar10 = 0;
                    uVar9 = 2;
                    uVar12 = __aFulmul(CONCAT22(*(undefined2 *)((int)((PLANET *)lpplBest)->rgwtMin + 0xe), (int)((PLANET *)lpplBest)->rgwtMin[3]), 3);
                    lVar13 = __aFldiv(uVar12, CONCAT22(uVar10, uVar9));
                    iVar7 = (int)((ulong)lVar13 >> 0x10);
                    iVar4 = *(int *)((int)((PLANET *)lpplHome)->rgwtMin + 0xe);
                    lVar11 = wtCargoFree;
                    if (((iVar7 <= iVar4) && (((iVar7 < iVar4 || ((uint)lVar13 < *(uint *)(((PLANET *)lpplHome)->rgwtMin + 3))) &&
                                               (iVar4 = *(int *)((int)((PLANET *)lpplHome)->rgwtMin + 0xe), -1 < iVar4)))) &&
                        ((0 < iVar4 || (500 < *(uint *)(((PLANET *)lpplHome)->rgwtMin + 3))))) {
                        iVar4 = *(int *)((int)((PLANET *)lpplHome)->rgwtMin + 0xe);
                        if ((iVar4 < 0) || ((iVar4 < 1 && (*(uint *)(((PLANET *)lpplHome)->rgwtMin + 3) < 0x7d1)))) {
                            iVar4 = *(int *)((int)((PLANET *)lpplHome)->rgwtMin + 0xe);
                            if ((iVar4 < 0) || ((iVar4 < 1 && (*(uint *)(((PLANET *)lpplHome)->rgwtMin + 3) < 0x5dd)))) {
                                iVar4 = *(int *)((int)((PLANET *)lpplHome)->rgwtMin + 0xe);
                                if ((iVar4 < 0) || ((iVar4 < 1 && (*(uint *)(((PLANET *)lpplHome)->rgwtMin + 3) < 0x3e9)))) {
                                    l = __aFldiv(CONCAT22(*(int *)((int)((PLANET *)lpplHome)->rgwtMin + 0xe) + -1 +
                                                              (uint)(399 < *(uint *)(((PLANET *)lpplHome)->rgwtMin + 3)),
                        ...
                        uVar10 = 0;
                        uVar9 = 100;
                        uVar12 = __aFulmul(CONCAT22(*(undefined2 *)((int)((PLANET *)lpplHome)->rgwtMin + 0xe), (int)((PLANET *)lpplHome)->rgwtMin[3]), l);
                        lVar11 = __aFldiv(uVar12, CONCAT22(uVar10, uVar9));
                        ChangeMainObjSel(2, lpflFr->id);
                        XferAiSupply(1, ((FLEET *)lpflFr)->idPlanet, 2, lpflFr->id, 3, (short)lVar11);
                        FLookupFleet(lpflFr->id, (FLEET *)&sel.fl);
                        ord.u_ORDER_0x0008.txp.rgia[3].wFlags = (ITEMACTION)(ITEMACTION)((uint)ord.u_ORDER_0x0008.txp.rgia[3].wFlags & 0xfff | 0x2000);
                        lVar11 = wtCargoFree;
                    }
                ...
                ChangeMainObjSel(2, lpflFr->id);
                iVar4 = *(int *)((int)((PLANET *)lpplHome)->rgwtMin + 0xe);
                if ((iVar4 < 0) || ((iVar4 < 1 && (*(uint *)(((PLANET *)lpplHome)->rgwtMin + 3) < 0x385)))) {
    ...
    wtCargoFree._2_2_ = (int)((ulong)lVar11 >> 0x10);
    wtCargoFree._0_2_ = (uint)lVar11;
    if (((THING *)lpthBest == 0) && (lpthBest._2_2_ == 0)) {
        if ((lpplHome->id != idBest) && (fNeedy != 0)) {
            if (fNeedy != 2) {
                uVar1 = *(uint *)((int)(((PLANET *)lpplBest)->rgwtMin + iWorst) + 2);
                if (((int)uVar1 < wtCargoFree._2_2_) ||
                    (((int)uVar1 <= wtCargoFree._2_2_ && (*(uint *)(((PLANET *)lpplBest)->rgwtMin + iWorst) < (uint)wtCargoFree)))) {
                    if (((PLANET *)lpplBest)->iPlayer != -1) {
                        for (i = 0; i < 3; i = i + 1) {
                            wtCargoFree = lVar11;
                            *(uint *)((int)&ord.u_ORDER_0x0008 + i * 2) = *(uint *)((int)&ord.u_ORDER_0x0008 + i * 2) & 0xfff | 0x5000;
                            if (i == iWorst) {
                                l._0_2_ = 0x42;
                            } else {
                                l._0_2_ = 0x21;
                            }
                            *(uint *)((int)&ord.u_ORDER_0x0008 + i * 2) = *(uint *)((int)&ord.u_ORDER_0x0008 + i * 2) & 0xf000 | (uint)l;
                            lVar11 = wtCargoFree;
                        }
                    }
                    goto LAB_1090_392a;
            ...
            for (i = 0; i < 3; i = i + 1) {
                if (i != iWorst) {
                    wtCargoFree = lVar11;
                    *(uint *)((int)&ord.u_ORDER_0x0008 + i * 2) = *(uint *)((int)&ord.u_ORDER_0x0008 + i * 2) & 0xfff;
                    lVar11 = wtCargoFree;
                }
            }
        }
    } else {
        ord.wFlags_0x6 = ord.wFlags_0x6 & 0xeff0;
    }
LAB_1090_392a:
    wtCargoFree = lVar11;
    sVar5 = FMoveAiFleet(lpflFr, &ord, 0);
    if (sVar5 == 0) {
        idBest = -1;
    }
    return idBest;
...
short FSalvageTargetFreighter2(FLEET *lpflFr, short fNeedy, short iWorst, short pctFull, long wtCargoMax, long scoreBest, THING **plpthBest, short *pidBest)

{
    ...
    while ((THING *)lpth < pTVar7) {
        ...
        if ((lpth->idFull >> 0xd == 1) && ((((&((THING *)lpth)->u_THING_0x0006)->thp).wFlags >> 10 & 0xf) == 0)) {
            ...
            if ((iVar3 == 0) && (iVar4 == 0)) {
                if ((fNeedy != 0) && (*(int *)((((THING *)lpth)->u_THING_0x0006).rgb + iWorst * 2 + 2) != 0)) {
                    XferAiSupply(8, lpth->idFull, 2, lpflFr->id, iWorst, *(short *)((((THING *)lpth)->u_THING_0x0006).rgb + iWorst * 2 + 2));
                }
                if (fNeedy != 2) {
                    for (i = 0; i < 3; i = i + 1) {
                        if (*(int *)((((THING *)lpth)->u_THING_0x0006).rgb + i * 2 + 2) != 0) {
                            XferAiSupply(8, lpth->idFull, 2, lpflFr->id, i, *(short *)((((THING *)lpth)->u_THING_0x0006).rgb + i * 2 + 2));
                        }
                    }
                }
                fSalvage = 1;
                ...
                if (iVar5 < 0xc9) {
                    if (fNeedy == 2) {
                        wtPlanCargo._0_2_ = *(uint *)((((THING *)lpth)->u_THING_0x0006).rgb + iWorst * 2 + 2);
                        ...
                        for (i = 0; i < 3; i = i + 1) {
                            if ((fNeedy == 0) || (i == iWorst)) {
                                ...
                                wtPlanCargo._2_2_ = wtPlanCargo._2_2_ + ((int)uVar6 >> 0xf) + (uint)CARRY2((uint)wtPlanCargo, uVar6);
                            } else {
                                uVar6 = *(int *)((((THING *)lpth)->u_THING_0x0006).rgb + i * 2 + 2) >> 1;
                                wtPlanCargo._2_2_ = wtPlanCargo._2_2_ + (*(int *)((((THING *)lpth)->u_THING_0x0006).rgb + i * 2 + 2) >> 0xf) +
                    ...
                    if ((0 < wtPlanCargo._2_2_) || ((-1 < wtPlanCargo._2_2_ && (9 < (uint)wtPlanCargo)))) {
                        lVar11 = wtCargoMax;
                        uVar10 = __aFulmul((ulong)CONCAT62(CONCAT42(100, wtPlanCargo._2_2_), (uint)wtPlanCargo), 100);
                        lVar11 = __aFldiv(uVar10, lVar11);
                        pctHere = (short)lVar11;
                        if (100 - pctFull < pctHere) {
                            pctHere = 100 - pctFull;
                        }
                        uVar10 = __aFulmul((long)iVar4, (long)iVar4);
                        uVar12 = __aFulmul((long)iVar3, (long)iVar3);
                        uVar13 = 0;
                        uVar8 = 0x19;
                        _sqrt((double)(long)(uVar12 + uVar10));
                        lVar11 = __ftol((double)CONCAT26(unaff_SI, CONCAT24(unaff_DI, CONCAT22(uVar13, uVar8))));
                        l = __aFldiv(lVar11 + 0x18, CONCAT22(uVar13, uVar8));
                        if (((int)((ulong)l >> 0x10) < 1) && ((l < 0 || ((int)l == 0)))) {
                            l = 1;
                        }
                        lVar11 = __aFldiv((long)(pctHere * 100), l);
                        if (scoreBest < lVar11) {
        ...
        lpth = (THING *)CONCAT22(pTVar9, (THING *)lpth + 1);
    }
    return fSalvage;
}
...

{
    ...
    bVar3 = false;
    if ((sel.pl.lpplprod != 0) && (200 < ((PLPROD *)sel.pl.lpplprod)->iprodMac)) {
        return;
    }
    if (((PLPROD *)lpplProdGlob == 0) && (lpplProdGlob._2_2_ == 0)) {
        ...
        i = 0;
        while ((i < cProdGlob &&
                ((uVar6 = __aFulshr(CONCAT22(*(undefined2 *)((int)&rgprod[i].dwFlags + 2), (int)(rgprod + i)->dwFlags), 10),
                  ((uint)uVar6 & 0x7f) != iItem || (uVar6 = __aFulshr(CONCAT22(*(undefined2 *)((int)&rgprod[i].dwFlags + 2), (int)(rgprod + i)->dwFlags), 0x11),
    ...
    if (mdAddItem != 2) {
        ...
        if (pPVar4->iprodMac == pPVar4->iprodMax) {
            lpplProdGlob = LpplReAlloc(lpplProdGlob, pPVar4->iprodMac + 3);
        }
    }
    pPVar4 = (PLPROD *)lpplProdGlob;
    uVar5 = (undefined2)((ulong)lpplProdGlob >> 0x10);
    if (mdAddItem == 0) {
        iprod = 0;
        __fmemmove((PLPROD *)CONCAT22(uVar5, pPVar4 + 2), (PLPROD *)CONCAT22(uVar5, pPVar4 + 1), (uint)pPVar4->iprodMac << 2);
        __fmemset((PLPROD *)lpplProdGlob + 1, 0, 4);
    } else {
        if (mdAddItem != 1) {
            if (mdAddItem != 2)
                goto LAB_1090_407b;
...
LAB_1090_407b:
    lVar7 = __aFlshl((ulong)(cItem & 0x3ff), 0);
    ...
    *(undefined1 *)((int)&rgplr[0].pctResearch + idPlayer * 0xc0) = (char)pct;
    ...
    while (true) {
        if (cRes <= i) {
            iSmallest = 0;
            for (i = 1; i < 6; i = i + 1) {
                if (*(char *)(idPlayer * 0xc0 + 0x59bc + i) < *(char *)(idPlayer * 0xc0 + 0x59bc + iSmallest)) {
                    iSmallest = i;
                }
            }
            if (((int)*(char *)((int)&rgplr[0].iTechCur + idPlayer * 0xc0) & 0xfU) != iSmallest) {
                *(byte *)((int)&rgplr[0].iTechCur + idPlayer * 0xc0) = *(byte *)((int)&rgplr[0].iTechCur + idPlayer * 0xc0) & 0xf0 | (byte)iSmallest;
                if ((*(byte *)((int)&rgplr[0].iTechCur + idPlayer * 0xc0) & 0xf) == 0x1a) {
                    *(undefined1 *)((int)&rgplr[0].pctResearch + idPlayer * 0xc0) = 0;
                }
                pctTech = (int)*(char *)((int)&rgplr[0].pctResearch + idPlayer * 0xc0) + *(char *)((int)&rgplr[0].iTechCur + idPlayer * 0xc0) * 0x100;
                WriteMemRt(0x22, 2, &pctTech);
            }
            return 0x39e;
        }
        iVar2 = (int)*(char *)(idPlayer * 0xc0 + 0x59bc + ((int)(uint)((byte *)lpbRes)[i] >> 5));
        if (iVar2 < (int)(((byte *)lpbRes)[i] & 0x1f))
            break;
        i = i + 1;
    }
    *(byte *)((int)&rgplr[0].iTechCur + idPlayer * 0xc0) =
        *(byte *)((int)&rgplr[0].iTechCur + idPlayer * 0xc0) & 0xf0 | (byte)((int)(uint)((byte *)lpbRes)[i] >> 5);
    if ((i < cRes + -1) && (iVar2 + 1U == (((byte *)lpbRes)[i] & 0x1f))) {
        *(byte *)((int)&rgplr[0].iTechCur + idPlayer * 0xc0) =
            *(byte *)((int)&rgplr[0].iTechCur + idPlayer * 0xc0) & 0xf | (byte)(((int)(uint)((byte *)lpbRes)[i + 1] >> 5) << 4);
    }
    pctTech = (int)*(char *)((int)&rgplr[0].pctResearch + idPlayer * 0xc0) + *(char *)((int)&rgplr[0].iTechCur + idPlayer * 0xc0) * 0x100;
    WriteMemRt(0x22, 2, &pctTech);
    return i;
...

{
    ...
    do {
        ...
        AIU_LKeepMovn:
            ...
            while (true) {
                ...
                if ((pFVar1->iPlayer == idPlayer) && (1 < pFVar1->cord)) {
                    if ((*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd == 0) || (4 < game.turn)) {
                        i = -1;
        ...
        if (((lpth->idFull >> 0xd == 0) && ((lpth->idFull >> 9 & 0xf) != idPlayer)) && (*(char *)((int)&((THING *)lpth)->u_THING_0x0006 + 6) != '\x02')) {
            if (ith == 100) {
                ith = -1;
                goto AIU_LKeepMovn;
            }
...

{
    ...
    if (((*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 10 & 7) == 0) && ((game.turn & 1) != 0)) {
        sVar5 = 0;
                ...
                if ((game.cPlanMax << 2) / 5 < cColFl + cColPl) {
                    ...
                    for (i = iMin; i < iVar1; i = i + 1) {
                        if (0 < rgish[i]) {
                            ...
                            cBuilt._2_2_ = cBuilt._2_2_ + *(int *)((int)&rgshdef[0].cBuilt + 2 + i * 0x93) + (uint)bVar6;
                        }
                    }
                    uVar4 = cColPl + cColFl;
                    if (((cBuilt._2_2_ - ((int)uVar4 >> 0xf) == (uint)((uint)cBuilt < uVar4)) && ((uint)cBuilt - uVar4 < 0x1a)) ||
...

{
    ...
    do {
        ...
        if (0 < ((FLEET *)lpfl)->rgcsh[i]) {
            ...
            if (iVar1 == 5) {
                uVar2 = *(undefined2 *)(idPlayer * 4 + rglpshdef_0x2);
            ...
            if (((iVar1 == 0x1f) || (iVar1 == 0x1d)) && (sVar3 = WtMaxShdefStat((SHDEF *)(i * 0x93 + rgshdef), grStatCargo), sVar3 < 500)) {
                uVar2 = *(undefined2 *)(idPlayer * 4 + rglpshdef_0x2);
                iVar4 = *(int *)(idPlayer * 4 + rglpshdef) + i * 0x93;
                iVar1 = *(int *)(iVar4 + 0x89);
                if ((-1 < iVar1) && ((0 < iVar1 || (*(int *)(iVar4 + 0x87) != 0)))) {
...

{
    ...
    while (true) {
        ...
        if (((0 < ((FLEET *)lpfl)->rgcsh[i]) && (iVar1 = *(int *)(i * 0x93 + rgshdef), 3 < iVar1)) && (iVar1 < 0xb))
            break;
        i = i + 1;
    }
    return 1;
...

{
    ...
    do {
        ...
        if (0 < ((FLEET *)lpfl)->rgcsh[i]) {
            ...
            if ((iVar1 == 0x1f) && (sVar3 = WtMaxShdefStat((SHDEF *)(i * 0x93 + rgshdef), grStatCargo), 499 < sVar3)) {
                uVar2 = *(undefined2 *)(idPlayer * 4 + rglpshdef_0x2);
                iVar4 = *(int *)(idPlayer * 4 + rglpshdef) + i * 0x93;
                iVar1 = *(int *)(iVar4 + 0x89);
                if ((-1 < iVar1) && ((0 < iVar1 || (*(int *)(iVar4 + 0x87) != 0)))) {
...

{
    ...
    if ((*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd != 4) && (*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd != 5)) {
        if (*vlpbAiData < 3) {
            uVar17 = (ulong)vlpbAiData >> 0x10;
        ...
        if (0x13 < game.turn) {
            ...
            while (true) {
                ...
                if ((((PLANET *)pPVar16 != 0) || (iVar7 != 0)) && (((PLANET *)pPVar16)->iPlayer == idPlayer)) {
                    if (iWrite != i) {
            ...
            *(short *)(pbVar11 + 2) = iWrite;
            ...
            while (((PLANET *)lppl < pPVar10 && (*(int *)((byte *)vlpbAiData + 2) < 0x40))) {
                ...
                if (((((PLANET *)lppl)->iPlayer == idPlayer) && ((((PLANET *)lppl)->wFlags_0x4 >> 9 & 1) == 0)) &&
                    ((iVar7 = *(int *)((int)((PLANET *)lppl)->rgwtMin + 0xe),
                      0 < iVar7 || ((-1 < iVar7 && (0x4f < *(uint *)(((PLANET *)lppl)->rgwtMin + 3))))))) {
                    l._0_2_ = 0;
                    l._2_2_ = 0;
                    for (i = 0; i < 3; i = i + 1) {
                        uVar17 = __aFulmul((ulong)((PLANET *)lppl)->rgMinConc[i], (ulong)((PLANET *)lppl)->rgMinConc[i]);
                        lVar18 = __aFlshl(uVar17, 2);
                        puVar1 = (uint *)(((PLANET *)lppl)->rgwtMin + i);
                        uVar5 = (uint)lVar18 + *puVar1;
                        bVar15 = CARRY2((uint)l, uVar5);
                        l._0_2_ = (uint)l + uVar5;
                        l._2_2_ = l._2_2_ + (int)((ulong)lVar18 >> 0x10) + *(uint *)((int)(((PLANET *)lppl)->rgwtMin + i) + 2) +
                                  (uint)CARRY2((uint)lVar18, *puVar1) + (uint)bVar15;
                    }
                    if (((-1 < l._2_2_) &&
                         (((0 < l._2_2_ || (6999 < (uint)l)) &&
                           (uVar17 = __aFulshr(CONCAT22(*(undefined2 *)(((PLANET *)lppl)->rgbImp + 2), *(undefined2 *)((PLANET *)lppl)->rgbImp), 8),
                            0x13 < ((uint)uVar17 & 0xfff))))) &&
                        ...
                        while (true) {
                            ...
                            if ((*(int *)((byte *)vlpbAiData + 2) <= i) || (iVar7 = *(int *)((byte *)vlpbAiData + i * 0x14 + 4), iVar7 == lppl->id))
                                break;
                            if (*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd == 0) {
                                iVar6 = ((POINT *)rgptPlan + iVar7)->x - ((POINT *)rgptPlan + lppl->id)->x;
                                iVar7 = *(int *)((int)&rgptPlan[0].y + iVar7 * 4) - *(int *)((int)&rgptPlan[0].y + lppl->id * 4);
                                uVar17 = __aFulmul((long)iVar7, (long)iVar7);
                                uVar19 = __aFulmul((long)iVar6, (long)iVar6);
                                if ((long)(uVar19 + uVar17) < 0x9c4)
                                    break;
                            }
                            i = i + 1;
                        }
                        ...
                        pbVar11 = (byte *)vlpbAiData;
                        if (*(int *)(pbVar11 + 2) <= i) {
                            *(short *)(pbVar11 + *(int *)(pbVar11 + 2) * 0x14 + 4) = lppl->id;
                            pbVar2 = (byte *)vlpbAiData + *(int *)((byte *)vlpbAiData + 2) * 0x14 + 6;
                            pbVar2[0] = 0;
                            pbVar2[1] = 0;
                            *(int *)((byte *)vlpbAiData + 2) = *(int *)((byte *)vlpbAiData + 2) + 1;
                        }
            ...
            for (ifl = 0; ifl < cFleet; ifl = ifl + 1) {
                ...
                if ((pFVar4 == 0) && (iVar7 == 0))
                    break;
                if ((pFVar4->iPlayer == idPlayer) && (sVar8 = FIsAiTransport((FLEET *)CONCAT22(iVar7, pFVar4)), sVar8 != 0)) {
                    i = 0;
                    while (true) {
                        uVar13 = (undefined2)((ulong)vlpbAiData >> 0x10);
                        pbVar11 = (byte *)vlpbAiData;
                        if (*(int *)(pbVar11 + 2) <= i)
                            break;
                        j = 0;
                        while ((j < *(int *)(pbVar11 + i * 0x14 + 6) && (*(int *)(pbVar11 + j * 2 + i * 0x14 + 8) != lpfl->id))) {
                            j = j + 1;
                        }
                        if (j < *(int *)(pbVar11 + i * 0x14 + 6))
                            break;
                        i = i + 1;
                    }
                    if (i == *(int *)(pbVar11 + 2)) {
                        ...
                        while (true) {
                            ...
                            if (*(int *)(pbVar11 + i * 0x14 + 6) < 8) {
                                iVar6 = ((POINT *)rgptPlan + *(int *)(pbVar11 + i * 0x14 + 4))->x - (&pFVar4->pt)->x;
                                iVar9 = *(int *)((int)&rgptPlan[0].y + *(int *)(pbVar11 + i * 0x14 + 4) * 4) - (pFVar4->pt).y;
                                uVar17 = __aFulmul((long)iVar9, (long)iVar9);
                                uVar19 = __aFulmul((long)iVar6, (long)iVar6);
                                if ((long)(uVar19 + uVar17) < lVar18) {
                                    iBest = i;
            ...
            while (true) {
                ...
                if (*(int *)(pbVar11 + i * 0x14 + 6) < 4) {
                    j = 0;
                    while ((j < *(int *)(pbVar11 + 2) && (*(int *)(pbVar11 + j * 0x14 + 6) < *(int *)(pbVar11 + i * 0x14 + 6) + 2))) {
                        j = j + 1;
                    }
                    if (j < *(int *)(pbVar11 + 2)) {
                        ...
                        *(int *)((byte *)vlpbAiData + i * 0x14 + 6) = *(int *)((byte *)vlpbAiData + i * 0x14 + 6) + 1;
                        *(undefined2 *)(pbVar11 + iVar7 * 2 + i * 0x14 + 8) = uVar13;
                    }
                }
                i = i + 1;
            }
            *vlpbAiData = *(int *)(pbVar11 + 2) * 0x14 + 4;
        }
    }
    return;
}
...

{
    ...
    if ((uVar6 & 1) == 0) {
        uVar9 = 0;
        uVar8 = 100;
        uVar6 = __aFulmul((long)(int)(uint)cRes, (long)(int)*(char *)((int)&rgplr[0].pctResearch + idPlayer * 0xc0));
...

{
    ...
    if ((*(int *)&pPVar6->lpplprod != 0) || (*(int *)((int)&pPVar6->lpplprod + 2) != 0)) {
        ...
        lpprod._0_2_ = pPVar3;
        for (i = 0; lpprod._0_2_ = (PROD *)lpprod + 1, i < (int)(uint) * (byte *)((int)&pPVar3->dwFlags + 3); i = i + 1) {
            GetProductionCosts(lppl, (PROD *)CONCAT22(uVar7, (PROD *)lpprod), rgCostCur, idPlayer, 0);
            for (j = 0; j < 4; j = j + 1) {
...

{
    ...
    do {
        ...
        LAB_1090_5b67:
            if (((FLEET *)lpflNextPass == 0) && (lpflNextPass._2_2_ == 0)) {
                return;
            }
            ...
            if ((i != iVar1) && (lVar6 = CMineFromLpfl(lpfl), lVar6 != 4000)) {
                for (i = 0; i < crglpflW; i = i + 1) {
                    if (((FLEET *)rglpflW[i])->idPlanet == pFVar2->idPlanet) {
                        ...
                        if (((&pFVar3->pt)->x == (&pFVar2->pt)->x) && ((pFVar3->pt).y == (pFVar2->pt).y))
                            break;
                    }
                }
                if (i < crglpflW) {
                    /* WARNING: Load size is inaccurate */
                    Merge2Fleets((FLEET *)CONCAT22(*(undefined2 *)((int)rglpflW + i * 4 + 2), rglpflW[i]), lpfl, 0);
...

{
    ...
    for (ish = 0; ish < cFleet; ish = ish + 1) {
        ...
        if ((long)(uVar13 + uVar12) < lVar6) {
            sVar10 = (*(fn_pfn_conflict *)pfn)(a0, a0);
            pFVar7 = pFVar3;
            iVar8 = iVar4;
            lVar5 = uVar13 + uVar12;
            if (sVar10 == 0) {
...

{
    ...
    while ((PLANET *)lpplT < pPVar7) {
        ...
        if ((long)(uVar9 + uVar8) < lVar3) {
            sVar6 = (*(fn_pfn_conflict *)pfn)((PLANET *)lppl, (PLANET *)lppl);
            if (sVar6 != 0) {
...

{
    ...
    while (true) {
        ...
        if ((idBest == -1) || (cExtraAttempts < 1))
            break;
        pPVar7 = LpplFromId(idBest);
        iVar3 = (int)((ulong)pPVar7 >> 0x10);
        if (((PLANET *)pPVar7 == 0) && (iVar3 == 0)) {
            return idBest;
        }
...

{
    ...
    *(uint *)&((PLORD *)sel.fl.lpplord)[2].iordMax = *(uint *)&((PLORD *)sel.fl.lpplord)[2].iordMax & 0xfff0;
    FLookupFleet(-1, (FLEET *)&sel.fl);
    return;
}
    ...
    while (true) {
        ...
        if ((((FLEET *)lpfl)->rgcsh[ishdef] != 0) &&
            (iVar2 = ((uint)lpfl->id >> 9 & 0xf) * 4,
             sVar1 = FHullHasTeeth((HUL *)CONCAT22(*(undefined2 *)(iVar2 + rglpshdef_0x2), (HUL *)(*(int *)(iVar2 + rglpshdef) + ishdef * 0x93))), sVar1 != 0))
            break;
        ishdef = ishdef + 1;
    }
    return 1;
...

{
    ...
    iVar6 = (pFVar7->pt).y;
    _memset(&ord, 0, 0x12);
    sVar1 = FFleetMightHaveTeeth(lpfl);
    if (sVar1 != 0) {
        while (true) {
            if (((FLEET *)lpflT == 0) && (lpflT._2_2_ == 0))
                break;
            if ((fOnlyHumans == 0) || ((*(uint *)((int)&rgplr[0].wMdPlr + ((FLEET *)lpflT)->iPlayer * 0xc0) >> 9 & 1) == 0)) {
                ...
                if ((lpflAtk2 == 0) || (sVar1 = Random(3), sVar1 != 0)) {
                    iVar2 = (&((FLEET *)lpflT)->pt)->x - iVar8;
                    iVar3 = (((FLEET *)lpflT)->pt).y - iVar6;
                    uVar10 = __aFulmul((long)iVar3, (long)iVar3);
                    uVar11 = __aFulmul((long)iVar2, (long)iVar2);
                    if ((long)(uVar11 + uVar10) < lVar12) {
                        lpflClosest = lpflT;
        ...
        if (((FLEET *)lpflClosest == 0) && (lpflClosest._2_2_ == 0)) {
            if (fOnlyHumans != 0) {
                sVar1 = IdTargetScout(lpfl, lpflAtk, lpflEnemy, 0, plpthWorm);
                return sVar1;
            }
        } else {
            uVar16 = 0;
            uVar14 = 2;
            lVar12 = LGetFleetStat(lpfl, grStatFuel);
            lVar12 = __aFldiv(lVar12, CONCAT22(uVar16, uVar14));
            iVar6 = (int)((ulong)lVar12 >> 0x10);
            iVar8 = *(int *)((int)pFVar7->rgwtMin + 0x12);
            if ((iVar8 <= iVar6) &&
                (((iVar8 < iVar6 || (*(uint *)(pFVar7->rgwtMin + 4) < (uint)lVar12)) && (sVar1 = FMoveToNearestStarbase(lpfl, 0), sVar1 != 0)))) {
                return 0;
            }
            iVar8 = (&((FLEET *)lpflClosest)->pt)->x;
            iVar6 = (((FLEET *)lpflClosest)->pt).y;
            lpplClosest = 0;
            lVar12 = 1000000;
            pPVar5 = (PLANET *)lpPlanets + cPlanet;
            ...
            while ((PLANET *)lppl < pPVar5) {
                ...
                if (lpflAtk2 == 0) {
                    iVar2 = ((POINT *)rgptPlan + lppl->id)->x - iVar8;
                    iVar3 = *(int *)((int)&rgptPlan[0].y + lppl->id * 4) - iVar6;
                    uVar10 = __aFulmul((long)iVar3, (long)iVar3);
                    uVar11 = __aFulmul((long)iVar2, (long)iVar2);
                    if ((long)(uVar11 + uVar10) < lVar12) {
                        lpplClosest = lppl;
            ...
            if ((((PLANET *)lpplClosest != 0) || (lpplClosest._2_2_ != 0)) && (lpplClosest->id != pFVar7->idPlanet)) {
                ord.pt.x = ((POINT *)rgptPlan + lpplClosest->id)->x;
                ord.pt.y = *(short *)((int)&rgptPlan[0].y + lpplClosest->id * 4);
                ord.wFlags_0x6 = ord.wFlags_0x6 & 0xf0ff | 0x100;
                ord.id = lpplClosest->id;
    ...
    if ((plpthWorm == 0) || ((*plpthWorm == 0 && (plpthWorm[1] == 0)))) {
        if (idClosest == -1) {
            if (*(int *)((int)&rgplr[0].idPlanetHome + idPlayer * 0xc0) == -1) {
                idClosest = Random(game.cPlanMax);
            } else {
                uVar14 = 0x1088;
                pfVar15 = (fn_pfn_conflict *)&rgptPlan[0xd1].y;
                pPVar13 = LpplFromId(*(short *)((int)&rgplr[0].idPlanetHome + idPlayer * 0xc0));
                pPVar13 = LpplFindBestEnum(pPVar13, (fn_pfn_conflict *)CONCAT22(uVar14, pfVar15));
                if (((PLANET *)pPVar13 == 0) && ((int)((ulong)pPVar13 >> 0x10) == 0)) {
                    idClosest = Random(game.cPlanMax);
                } else {
                    idClosest = pPVar13->id;
                }
            }
        }
        ord.id = idClosest;
        ...
        uVar14 = (undefined2)((ulong) * (undefined4 *)plpthWorm >> 0x10);
        iVar8 = (int)*(undefined4 *)plpthWorm;
        ord.pt.x = *(short *)(iVar8 + 2);
        ord.pt.y = *(short *)(iVar8 + 4);
        ord.wFlags_0x6 = ord.wFlags_0x6 & 0xf0ff | 0x800;
        ord.id = **(short **)plpthWorm;
    }
AIU_ThwakSumthin_2:
    if (((pFVar7->cord < 2) || ((((PLORD *)pFVar7->lpplord + 7)->wFlags >> 8 & 0xf) != 1)) || ((ord.wFlags_0x6 >> 8 & 0xf) != 1)) {
        if ((ord.wFlags_0x6 >> 8 & 0xf) == 1) {
            ((byte *)vlpbAiPlanet)[ord.id * 0x10 + 0xf] = 4;
        }
        ord.wFlags_0x6 = ord.wFlags_0x6 & 0xeff0 | 0x1000;
        uVar4 = IFindIdealWarp(lpfl, 1);
        ord.wFlags_0x6 = ord.wFlags_0x6 & 0xff0f | (uVar4 & 0xf) << 4;
...

{
    ...
    while (true) {
        ...
        if ((*(int *)(iVar1 + 2) != idPlayer) && (*(int *)(iVar1 + 6) != -1)) {
            i = 0;
            while ((i < 0x10 &&
                    (((*(int *)(iVar1 + 0xc + i * 2) < 1 || (iVar3 = *(int *)(iVar1 + 2) * 4, *(int *)(*(int *)(iVar3 + rglpshdef) + i * 0x93) < 0x10)) ||
                      (iVar3 = *(int *)(iVar1 + 2) * 4, 0x13 < *(int *)(*(int *)(iVar3 + rglpshdef) + i * 0x93)))))) {
                i = i + 1;
            }
            if ((i != 0x10) && (pPVar4 = LpplFromId(*(short *)(iVar1 + 6)), ((PLANET *)pPVar4)->iPlayer == idPlayer)) {
...

{
    ...
    if ((*(int *)&pPVar4->lpplprod != 0) || (*(int *)((int)&pPVar4->lpplprod + 2) != 0)) {
        i = 0;
        lpprod = (PROD *)CONCAT22(*(undefined2 *)((int)&pPVar4->lpplprod + 2), (PROD *)(*(int *)&pPVar4->lpplprod + 4));
        for (; i < (int)(uint)((PLPROD *)pPVar4->lpplprod)->iprodMac; i = i + 1) {
            uVar10 = (undefined2)((ulong)lpprod >> 0x10);
            pPVar5 = (PROD *)lpprod;
            uVar8 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pPVar5->dwFlags + 2), (int)lpprod->dwFlags), 0x11);
            if ((((uint)uVar8 & 7) == 1) &&
                (uVar8 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pPVar5->dwFlags + 2), (int)lpprod->dwFlags), 10), ((uint)uVar8 & 0x7f) == 9)) {
                return;
            }
    ...
    if ((0 < rgRes[3]._2_2_) || ((-1 < rgRes[3]._2_2_ && (0x31 < (uint)rgRes[3])))) {
        ...
        i = 0;
        while ((i < cProdGlob &&
                (((uVar8 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pProdGlob[i].dwFlags + 2), (int)(pProdGlob + i)->dwFlags), 0x11),
                   ((uint)uVar8 & 7) != 1 || (uVar8 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pProdGlob[i].dwFlags + 2), (int)(pProdGlob + i)->dwFlags), 10),
                                              ((uint)uVar8 & 0x7f) != 9)) ||
        ...
        if (i == cProdGlob) {
            ...
            cCur = 100;
            for (i = 0; i < 3; i = i + 1) {
                lVar9 = __aFldiv(CONCAT22(*(undefined2 *)((int)rgRes + i * 4 + 2), (int)rgRes[i]), 5);
                if (lVar9 < cCur) {
                    cCur = (short)lVar9;
                }
            }
            lVar9 = __aFldiv(CONCAT22(rgRes[3]._2_2_, (uint)rgRes[3]), 0x19);
            cRes = (short)lVar9;
            if (5 < cRes) {
                cRes = cRes - cRes / 6;
            }
            lVar9 = __aFldiv(CONCAT22(rgRes[3]._2_2_, (uint)rgRes[3]), 10);
            bVar7 = (uint)rgRes[3] < (uint)lVar9;
            rgRes[3]._0_2_ = (uint)rgRes[3] - (uint)lVar9;
            rgRes[3]._2_2_ = (rgRes[3]._2_2_ - (int)((ulong)lVar9 >> 0x10)) - (uint)bVar7;
            if (cRes <= (int)uVar1) {
                uVar1 = cRes;
            }
            cRes = uVar1;
            if (cCur < cRes) {
                uVar10 = 0;
                uVar6 = 0x96;
                sVar3 = GetRaceGrbit((PLAYER *)rgplr + idPlayer, ibitRaceMineralAlchemy);
                if (sVar3 == 0) {
                    iVar2 = 100;
                } else {
                    iVar2 = 0x19;
                ...
                uVar1 = iVar2 * cCur;
                lVar9 = __aFldiv(CONCAT22((rgRes[3]._2_2_ - ((int)uVar1 >> 0xf)) - (uint)((uint)rgRes[3] < uVar1), (uint)rgRes[3] - uVar1),
...

{
    ...
    while ((PLANET *)lpplT < pPVar8) {
        ...
        if (((((long)(uVar12 + uVar11) < lVar4) && (((PLANET *)lpplT)->iPlayer == idPlayer)) && ((((PLANET *)lpplT)->wFlags_0x4 >> 9 & 1) != 0)) &&
            ((fBigOnes == 0 || ((iVar5 = *(int *)((int)((PLANET *)lpplT)->rgwtMin + 0xe),
                                 -1 < iVar5 && ((0 < iVar5 || (0xfa < *(uint *)(((PLANET *)lpplT)->rgwtMin + 3))))))))) {
            lpplBest = lpplT;
            lVar4 = uVar12 + uVar11;
        }
        lpplT = (PLANET *)lpplT + 1;
...

{
    ...
    lpplT = (PLANET *)CONCAT22(lpPlanets._2_2_, (PLANET *)lpPlanets);
    while ((PLANET *)lpplT < pPVar7) {
        iVar4 = uVar1 - ((POINT *)rgptPlan + lpplT->id)->x;
        iVar5 = iVar2 - *(int *)((int)&rgptPlan[0].y + lpplT->id * 4);
        uVar12 = __aFulmul((long)iVar5, (long)iVar5);
        uVar13 = __aFulmul((long)iVar4, (long)iVar4);
        if ((((long)(uVar13 + uVar12) < lVar3) && (((PLANET *)lpplT)->iPlayer != idPlayer)) && (((PLANET *)lpplT)->iPlayer != -1)) {
            lpplBest = lpplT;
            lVar3 = uVar13 + uVar12;
        }
        lpplT = (PLANET *)lpplT + 1;
    }
    if ((((PLANET *)lpplBest == 0) && (lpplBest._2_2_ == 0)) || (uVar12 = __aFulmul((long)dEnemyRange, (long)dEnemyRange), (long)uVar12 < lVar3)) {
        pt_00.y = (pFVar8->pt).y;
        pt_00.x = (&pFVar8->pt)->x;
...

{
    ...
    if (0x31 < game.turn) {
        ...
        if ((iSetLast != -1) && (wTurnLast + 0x28 <= game.turn)) {
            ...
            for (; i < iVar3 + 5; i = i + 2) {
                if ((*(uint *)(*(int *)(idPlayer * 4 + rglpshdefSB) + i * 0x93 + 0x7b) >> 9 & 1) == 0) {
                    uVar1 = *(undefined2 *)(idPlayer * 4 + rglpshdefSB_0x2);
                    iVar4 = *(int *)(idPlayer * 4 + rglpshdefSB) + i * 0x93;
                    if ((*(int *)(iVar4 + 0x85) != 0) || (*(int *)(iVar4 + 0x83) != 0))
                        goto AIU_LOrbital;
                }
            }
    ...
    AIU_LOrbital:
        ...
        if ((iSetLast != -1) && (wTurnLast + 0x28 <= game.turn)) {
            ...
            if ((*(uint *)(*(int *)(idPlayer * 4 + rglpshdefSB) + iVar3 * 0x93 + 0x7b) >> 9 & 1) == 0) {
                uVar1 = *(undefined2 *)(idPlayer * 4 + rglpshdefSB_0x2);
            ...
            if ((*(uint *)(*(int *)(idPlayer * 4 + rglpshdefSB) + (iVar3 + 2) * 0x93 + 0x7b) >> 9 & 1) == 0) {
                uVar1 = *(undefined2 *)(idPlayer * 4 + rglpshdefSB_0x2);
    ...
    *rgSB = 0;
    ...
    do {
        if (3 < i) {
            iOld = -1;
            for (i = 1; i < 4; i = i + 1) {
                if ((1 < rgSB[i]) && (((iOld == -1 || (rgSB[iOld] < rgSB[i])) ||
                                       ((rgSB[i] == rgSB[iOld] && (*(uint *)(*(int *)(idPlayer * 4 + rglpshdefSB) + i * 0x93 + 0x7d) <
            ...
            do {
                if (1 < i) {
                    for (i = 4; i < 10; i = i + 1) {
                        rgSB[i] = (*(uint *)(*(int *)(idPlayer * 4 + rglpshdefSB) + i * 0x93 + 0x7b) >> 9 & 1) != 0;
                    }
                    uVar2 = *(undefined4 *)(idPlayer * 4 + rglpshdefSB);
                    ...
                    if (game.turn - *(int *)(*(int *)(idPlayer * 4 + rglpshdefSB) + iOld * 0x93 + 0x7d) < 0x1e) {
                        j._0_1_ = 2;
                    } else {
                        j._0_1_ = 3;
                    }
                ...
                for (j = 0; j < 3; j = j + 1) {
                    if ((*(uint *)(*(int *)(idPlayer * 4 + rglpshdefSB) + (i * 3 + 4 + j) * 0x93 + 0x7b) >> 9 & 1) == 0) {
                        uVar1 = *(undefined2 *)(idPlayer * 4 + rglpshdefSB_0x2);
                        iVar5 = *(int *)(idPlayer * 4 + rglpshdefSB) + (i * 3 + 4 + j) * 0x93;
                        if ((*(int *)(iVar5 + 0x85) != 0) || (*(int *)(iVar5 + 0x83) != 0))
                            break;
                    }
                }
                if (j == 3) {
                    for (j = 0; j < 3; j = j + 1) {
                        k = 5;
                        while ((2 < k && (sVar4 = FCreateAiStarbase(i * 3 + 4 + j, j + 1, (uint)((byte *)vrgSBMacAisb)[k], k + -1), sVar4 == 0))) {
                            k = k + -1;
                        }
                    }
                }
        ...
        if ((*(uint *)(*(int *)(idPlayer * 4 + rglpshdefSB) + i * 0x93 + 0x7b) >> 9 & 1) == 0) {
            ...
            if ((*(int *)(iVar5 + 0x83) == 0) && (*(int *)(iVar5 + 0x85) == 0))
                goto LAB_1090_7759;
            iVar5 = game.turn - *(int *)(*(int *)(idPlayer * 4 + rglpshdefSB) + i * 0x93 + 0x7d);
            if (iVar5 < 0x23) {
                if (((game.turn < 0x1a) || (i != 1)) || (*(char *)(*(int *)(idPlayer * 4 + rglpshdefSB) + 0x10d) == '\b')) {
                    rgSB[i] = 0;
                } else {
                    rgSB[1] = 3;
                }
...

{
    ...
    sVar6 = FCreateAiShdef(-1, isb, (byte *)vrgSBAip + aisb);
    if (sVar6 == 0) {
        sVar6 = 0;
    } else {
        ...
        if (iLevel < 3) {
            for (i = 0; i < (int)(uint)shdef.hul.chs; i = i + 1) {
                ...
                if (shdef.hul.rghs[i].wFlags_0x2 >> 8 < 4) {
                    if (((iLevel < 2) && (*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd != 4)) &&
...

{
    ...
    if (*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd != 4) {
        ...
        for (i = 0; i < (int)(uint)((PLPROD *)lpplProdGlob)->iprodMac; i = i + 1) {
            ...
            pPVar7 = (PROD *)lpprod;
            uVar10 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pPVar7->dwFlags + 2), (int)lpprod->dwFlags), 0x11);
            if (((((uint)uVar10 & 7) == 1) &&
                 (uVar10 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pPVar7->dwFlags + 2), (int)lpprod->dwFlags), 10), 0xd < ((uint)uVar10 & 0x7f))) &&
                (uVar10 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pPVar7->dwFlags + 2), (int)lpprod->dwFlags), 10), ((uint)uVar10 & 0x7f) < 0x12)) {
                return 0;
            }
            lpprod = (PROD *)CONCAT22(uVar9, pPVar7 + 1);
        }
        if (1 < (*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 10 & 7)) {
            uVar3 = *(uint *)rgResAvail + *(uint *)(rgResAvail + 1);
            iVar6 = *(int *)((int)rgResAvail + 2) + *(int *)((int)rgResAvail + 6) + (uint)CARRY2(*(uint *)rgResAvail, *(uint *)(rgResAvail + 1)) +
            ...
            if ((-1 < iVar6) && ((0 < iVar6 || (3000 < uVar3 + *(uint *)(rgResAvail + 2))))) {
                ...
                if (((((PLANET *)lppl)->wFlags_0x4 >> 9 & 1) != 0) &&
                    ((sVar4 = IWarpMAFromLppl(lppl, &fTwoMAs), 9 < sVar4 && (sVar4 = Random(4), sVar4 == 0)))) {
                    pt.x = ((POINT *)rgptPlan + lppl->id)->x;
                    pt.y = *(short *)((int)&rgptPlan[0].y + lppl->id * 4);
                    for (iT = 0; iT < 3; iT = iT + 1) {
                        plVar8 = ((PLANET *)lppl)->rgwtMin + iT;
                        uVar3 = *(uint *)((int)plVar8 + 2);
                        if ((-1 < (int)uVar3) && ((0 < (int)uVar3 || (0x30d4 < *(uint *)plVar8))))
                            break;
                    }
                    ...
                    if (iT < 3) {
                        dBigAssPacket = __aFulmul(CONCAT22(dBigAssPacket._2_2_, (undefined2)dBigAssPacket), 3);
                    }
                    pPVar5 = (PLANET *)lpPlanets + cPlanet;
                    lpplHit = (PLANET *)CONCAT22(lpPlanets._2_2_, (PLANET *)lpPlanets);
                    while ((PLANET *)lpplHit < pPVar5) {
                        uVar9 = (undefined2)((ulong)lpplHit >> 0x10);
                        if ((((((PLANET *)lpplHit)->iPlayer != -1) && (((PLANET *)lpplHit)->iPlayer != idPlayer)) &&
                             (game.turn <= ((PLANET *)lpplHit)->turn + 2U)) &&
                            ((((PLANET *)lpplHit)->uGuesses >> 0xc < 0xe || ((((PLANET *)lpplHit)->uGuesses & 0xfff) < 0x2ee)))) {
                            sVar4 = GetRaceStat((PLAYER *)rgplr + ((PLANET *)lpplHit)->iPlayer, rsMajorAdv);
                            if (sVar4 != raMacintosh) {
                                if ((((PLANET *)lpplHit)->wFlags_0x4 >> 9 & 1) != 0) {
                                    sVar4 = GetRaceStat((PLAYER *)rgplr + ((PLANET *)lpplHit)->iPlayer, rsMajorAdv);
                                    if (sVar4 == raMassAccel)
                                        goto LAB_1090_819e;
                                }
                                iVar6 = pt.x - ((POINT *)rgptPlan + lpplHit->id)->x;
                                dy._0_2_ = pt.y - *(int *)((int)&rgptPlan[0].y + lpplHit->id * 4);
                                dy._2_2_ = (int)dy >> 0xf;
                                uVar10 = __aFulmul((long)(int)dy, (long)(int)dy);
                                uVar11 = __aFulmul((long)iVar6, (long)iVar6);
                                d2 = uVar11 + uVar10;
                                if (d2 <= dBigAssPacket) {
                                    cFound = cFound + 1;
                    ...
                    LAB_1090_819e:
                        lpplHit = (PLANET *)CONCAT22(uVar9, (PLANET *)lpplHit + 1);
                    }
                    if (9 < iLevelBest) {
                        sel.pl.lStarbase._2_2_ = sel.pl.lStarbase._2_2_ & 0xc000 | (iLevelBest - 4U & 0xf) << 10 | lpplBest->id + 1U & 0x3ff;
                        FLookupPlanet(-1, (PLANET *)&sel.pl);
                        if ((-1 < *(int *)((int)rgResAvail + 10)) &&
                            ((0 < *(int *)((int)rgResAvail + 10) || ((char *)rgbCur + 0x289 <= *(char **)(rgResAvail + 2))))) {
                            sVar4 = Random(3);
                            if (sVar4 != 0) {
                        ...
                        if ((((*(int *)((int)rgResAvail + 2) < 0) ||
                              (((*(int *)((int)rgResAvail + 2) < 1 && (*(uint *)rgResAvail < 0xbb9)) || (*(int *)((int)rgResAvail + 6) < 0)))) ||
                             (((*(int *)((int)rgResAvail + 6) < 1 && (*(uint *)(rgResAvail + 1) < 0xfa1)) || (*(int *)((int)rgResAvail + 10) < 0)))) ||
                            ((*(int *)((int)rgResAvail + 10) < 1 && (*(uint *)(rgResAvail + 2) < 0xbb9)))) {
                            if (((*(int *)((int)rgResAvail + 2) < 0) ||
                                 (((*(int *)((int)rgResAvail + 2) < 1 && (*(uint *)rgResAvail < 0x5dd)) || (*(int *)((int)rgResAvail + 6) < 0)))) ||
                                (((*(int *)((int)rgResAvail + 6) < 1 && (*(uint *)(rgResAvail + 1) < 0x8cb)) ||
                                  ((*(int *)((int)rgResAvail + 10) < 0 || ((*(int *)((int)rgResAvail + 10) < 1 && (*(uint *)(rgResAvail + 2) < 0x5dd)))))))) {
                                for (iT = 0; iT < 3; iT = iT + 1) {
                                    if (iT == 1) {
                                        uVar3 = 0x9c4;
                                    } else {
                                    ...
                                    if ((-1 < (int)uVar1) && ((0 < (int)uVar1 || (uVar3 < *(uint *)(rgResAvail + iT))))) {
                                        uVar1 = *(uint *)(rgResAvail + iT);
                                        lVar12 = __aFldiv(CONCAT22(*(uint *)((int)(rgResAvail + iT) + 2) - (uint)(uVar1 < uVar3), uVar1 - uVar3), 200);
                                        lVar2 = lVar12;
                                        if (lVar12 < 2) {
                                            lVar2 = 1;
                                        }
                                        ...
                                        AddItemToQueue(iT + 0xe, (ushort)lVar12, grobjPlanet, 1);
                                    }
                                }
                            } else {
...

{
    ...
    if (((*(uint *)((int)uVar1 + 0x3ed) >> 9 & 1) == 0) &&
        (uVar1 = *(undefined4 *)(idPlayer * 4 + rglpshdefSB), uVar2 = *(undefined4 *)(idPlayer * 4 + rglpshdefSB),
...

{
    ...
    if (((ishdefSBLatest != -1) && (*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd != 5)) &&
        (((((uint)gd.grBits >> 0xb & 1) == 0 &&
           ((((int)game.lid != -0x10b7 || (game.lid._2_2_ != 0x8c)) || (*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd != 1)))) ||
          (game.turn < 0x1f)))) {
        ...
        while ((PLANET *)lppl < pPVar2) {
            uVar6 = (undefined2)((ulong)lppl >> 0x10);
            if (*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd == 4) {
                if ((((PLANET *)lppl)->iPlayer == idPlayer) && (ishdefSBLatest = iBuildCyberStarbase(lppl), ishdefSBLatest != -1)) {
                LAB_1090_870e:
                    ChangeMainObjSel(1, lppl->id);
                    InitProduction(rgprod);
                    lpprod = (PROD *)((PLPROD *)lpplProdGlob + 1);
                    for (i = 0; i < (int)(uint)((PLPROD *)lpplProdGlob)->iprodMac; i = i + 1) {
                        ...
                        pPVar4 = (PROD *)lpprod;
                        uVar7 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pPVar4->dwFlags + 2), (int)lpprod->dwFlags), 0x11);
                        if ((((uint)uVar7 & 7) == 2) &&
                            (uVar7 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pPVar4->dwFlags + 2), (int)lpprod->dwFlags), 10), 0xf < ((uint)uVar7 & 0x7f)))
                            break;
                        lpprod = (PROD *)CONCAT22(uVar5, pPVar4 + 1);
                    }
                    if (i < (int)(uint)((PLPROD *)lpplProdGlob)->iprodMac) {
                        ...
                        (((((PLANET *)lppl)->wFlags_0x4 >> 9 & 1) == 0 || (9 < (*(uint *)&((PLANET *)lppl)->lStarbase & 0xf))))) &&
                       ((iVar1 = *(int *)((int)((PLANET *)lppl)->rgwtMin + 0xe),
                         -1 < iVar1 &&
                             (((0 < iVar1 || (0x4f < *(uint *)(((PLANET *)lppl)->rgwtMin + 3))) && (((byte *)vlpbAiPlanet)[lppl->id * 0x10 + 2] == 0)))))) {
                i = 0;
                while (true) {
                    uVar5 = (undefined2)((ulong)vlpbAiData >> 0x10);
                    pbVar3 = (byte *)vlpbAiData;
                    if ((*(int *)(pbVar3 + 2) <= i) || (*(int *)(pbVar3 + i * 0x14 + 4) == lppl->id))
                        break;
                    i = i + 1;
                }
                if (i != *(int *)(pbVar3 + 2))
...

{
    ...
    if ((pPVar5->wFlags_0x4 >> 9 & 1) != 0) {
        ...
        for (i = 0; i < (int)(uint)((PLPROD *)lpplProdGlob)->iprodMac; i = i + 1) {
            ...
            pPVar6 = (PROD *)lpprod;
            uVar9 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pPVar6->dwFlags + 2), (int)lpprod->dwFlags), 0x11);
            if ((((uint)uVar9 & 7) == 2) &&
                (uVar9 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pPVar6->dwFlags + 2), (int)lpprod->dwFlags), 10), 0xf < ((uint)uVar9 & 0x7f))) {
                return 0;
            }
    ...
    if (*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd != 5) {
        if ((*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd == 4) && (game.turn < 0x28)) {
            return 0;
        }
        if ((pPVar5->wFlags_0x4 >> 9 & 1) != 0) {
            if (((((*(uint *)&pPVar5->lStarbase & 0xf) == 1) || ((*(uint *)&pPVar5->lStarbase & 0xf) == 3)) || ((*(uint *)&pPVar5->lStarbase & 0xf) == 6)) ||
            ...
            if (((*(uint *)&pPVar5->lStarbase & 0xf) < (uint)ishdefSBLatest) ||
                ...
                pctUpg = (game.turn - *(int *)(*(int *)(idPlayer * 4 + rglpshdefSB) + ishdefSBLatest * 0x93 + 0x7d)) + -10;
                if (pctUpg < 0) {
                    pctUpg = 0;
                } else if (pctUpg < 0x32) {
                    pctUpg = pctUpg >> 1;
                ...
                if (sVar3 < pctUpg + 5) {
                    if ((((*(uint *)&pPVar5->lStarbase & 0xf) == 1) || ((*(uint *)&pPVar5->lStarbase & 0xf) == 3)) ||
                        (((*(uint *)&pPVar5->lStarbase & 0xf) == 6 || ((*(uint *)&pPVar5->lStarbase & 0xf) == 8)))) {
                    ...
                    return 1;
                        ...
                        ((*(uint *)(*(int *)(idPlayer * 4 + rglpshdefSB) + ((*(uint *)&pPVar5->lStarbase & 0xf) + 2) * 0x93 + 0x7b) >> 9 & 1) == 0)) &&
                       (sVar3 = Random(100), sVar3 < 6)) {
                i = 0;
                while (true) {
                    if (2 < i) {
    ...
    if ((vAiMacRecycleSB[uVar1] != 3) && ((vAiMacRecycleSB[uVar1] != 2 || (sVar3 = Random(100), 9 < sVar3)))) {
        if ((3 < uVar1) && (((uVar1 != 6 && (uVar1 != 9)) && (sVar3 = Random(100), sVar3 < 8)))) {
            isbNew = uVar1 + 1;
            goto AIU_LDoMacUpgrade2;
        }
        if (((3 < uVar1) || (sVar3 = PctPlanetCapacity(lppl), sVar3 < 0x10)) || (sVar2 = Random(100), (sVar3 + -0xf) * 6 <= sVar2)) {
            return 0;
        }
    }
    isbNew = uVar1;
    ...
    if (*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd != 4) {
        ...
        if ((0 < iVar2) || ((-1 < iVar2 && (199 < *(uint *)(pPVar5->rgwtMin + 3))))) {
            ...
            for (i = 0; i < (int)(uint)((PLPROD *)lpplProdGlob)->iprodMac; i = i + 1) {
                ...
                uVar9 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pPVar6->dwFlags + 2), (int)lpprod->dwFlags), 0x11);
                if ((((uint)uVar9 & 7) == 1) &&
                    (uVar9 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pPVar6->dwFlags + 2), (int)lpprod->dwFlags), 10), ((uint)uVar9 & 0x7f) == 0xc)) {
                    return 0;
                }
                lpprod = (PROD *)CONCAT22(uVar8, pPVar6 + 1);
            }
            ...
            dEnv = 0;
            for (i = 0; i < 3; i = i + 1) {
                sVar3 = _abs((int)pPVar5->rgEnvVar[i] - (int)*(char *)(idPlayer * 0xc0 + 0x59b2 + i));
                if (dEnv < sVar3) {
                    j = i;
                    dEnv = _abs((int)pPVar5->rgEnvVar[i] - (int)*(char *)(idPlayer * 0xc0 + 0x59b2 + i));
                }
            }
            if (j != -1) {
                for (i = 0; i < cProdGlob; i = i + 1) {
                    uVar9 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pProdGlob[i].dwFlags + 2), (int)(pProdGlob + i)->dwFlags), 0x11);
                    if (((((uint)uVar9 & 7) == 1) &&
                         (uVar9 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pProdGlob[i].dwFlags + 2), (int)(pProdGlob + i)->dwFlags), 10),
                          ((uint)uVar9 & 0x7f) == 0xc)) &&
                        (((pProdGlob + i)->dwFlags & 0x3ff) != 0)) {
                        sVar3 = 1;
                        grobj = grobjPlanet;
                        ...
                        pPVar6 = pProdGlob + i;
                        *&pPVar6->dwFlags = (uint)(pProdGlob + i)->dwFlags & 0xfc00;
                        *(undefined2 *)((int)&pPVar6->dwFlags + 2) = uVar7;
                        ...
                        for (j = 0; j < 4; j = j + 1) {
                            ...
                            uVar9 = __aFulmul(CONCAT22(*(undefined2 *)((int)rgItemCost + j * 4 + 2), (int)rgItemCost[j]), (ulong)uVar4);
...

{
    ...
    lpprod = (PROD *)((PLPROD *)lpplProdGlob + 1);
    for (i = 0; iVar4 = cProdGlob, i < (int)(uint)((PLPROD *)lpplProdGlob)->iprodMac; i = i + 1) {
        uVar6 = (undefined2)((ulong)lpprod >> 0x10);
        pPVar5 = (PROD *)lpprod;
        uVar7 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pPVar5->dwFlags + 2), (int)lpprod->dwFlags), 0x11);
        if (((((uint)uVar7 & 7) == 1) &&
             (uVar7 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pPVar5->dwFlags + 2), (int)lpprod->dwFlags), 10), 0x11 < ((uint)uVar7 & 0x7f))) &&
            (uVar7 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pPVar5->dwFlags + 2), (int)lpprod->dwFlags), 10), ((uint)uVar7 & 0x7f) < 0x1b)) {
            return 0;
        }
        lpprod = (PROD *)CONCAT22(uVar6, pPVar5 + 1);
    }
    do {
        i = iVar4 + -1;
        if (i < 0)
            break;
        uVar7 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pProdGlob[i].dwFlags + 2), (int)(pProdGlob + i)->dwFlags), 0x11);
        iVar4 = i;
    } while (((((uint)uVar7 & 7) != 1) ||
              (uVar7 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pProdGlob[i].dwFlags + 2), (int)(pProdGlob + i)->dwFlags), 10), ((uint)uVar7 & 0x7f) < 0x12)) ||
             (uVar7 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pProdGlob[i].dwFlags + 2), (int)(pProdGlob + i)->dwFlags), 10), 0x1a < ((uint)uVar7 & 0x7f)));
    if (-1 < i) {
        GetProductionCosts(lppl, pProdGlob + i, rgItemCost, idPlayer, 1);
        for (j = 0; j < 4; j = j + 1) {
            ...
            if ((-1 < iVar4) && ((0 < iVar4 || ((int)rgItemCost[j] != 0)))) {
                puVar1 = (uint *)(rgResCost + j);
                iVar4 = *(int *)((int)rgItemCost + j * 4 + 2) + *(uint *)((int)(rgResCost + j) + 2) + (uint)CARRY2(*(uint *)(rgItemCost + j), *puVar1);
                uVar2 = *(uint *)((int)(rgResAvail + j) + 2);
                if (((int)uVar2 <= iVar4) && (((int)uVar2 < iVar4 || (*(uint *)(rgResAvail + j) < *(uint *)(rgItemCost + j) + *puVar1))))
                    break;
            }
        }
        if (j == 4) {
            ...
            grobj = grobjPlanet;
            cItem = 1;
            uVar7 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pProdGlob[i].dwFlags + 2), (int)(pProdGlob + i)->dwFlags), 10);
            AddItemToQueue((uint)uVar7 & 0x7f, cItem, grobj, mdAddItem);
            for (j = 0; j < 4; j = j + 1) {
...

{
    ...
    if ((-1 < iVar1) && ((0 < iVar1 || (0x63f < *(uint *)(pPVar2->rgwtMin + 3))))) {
        lVar5 = __aFldiv(CONCAT22(*(undefined2 *)((int)pPVar2->rgwtMin + 0xe), (int)pPVar2->rgwtMin[3]), 0x50);
        if ((0xffff < lVar5) || ((-1 < lVar5 && ((*(uint *)(pPVar2->rgbImp + 4) & 0xfff) < (uint)lVar5)))) {
            lpprod = (PROD *)((PLPROD *)lpplProdGlob + 1);
            for (i = 0; i < (int)(uint)((PLPROD *)lpplProdGlob)->iprodMac; i = i + 1) {
                uVar4 = (undefined2)((ulong)lpprod >> 0x10);
                pPVar3 = (PROD *)lpprod;
                uVar6 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pPVar3->dwFlags + 2), (int)lpprod->dwFlags), 0x11);
                if ((((uint)uVar6 & 7) == 1) &&
                    (uVar6 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pPVar3->dwFlags + 2), (int)lpprod->dwFlags), 10), ((uint)uVar6 & 0x7f) == 9)) {
                    return 0;
                }
                lpprod = (PROD *)CONCAT22(uVar4, pPVar3 + 1);
            }
            i = 0;
            while ((i < cProdGlob && (((uVar6 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pProdGlob[i].dwFlags + 2), (int)(pProdGlob + i)->dwFlags), 0x11),
                                        ((uint)uVar6 & 7) != 1 ||
                                            (uVar6 = __aFulshr(CONCAT22(*(undefined2 *)((int)&pProdGlob[i].dwFlags + 2), (int)(pProdGlob + i)->dwFlags), 10),
                                             ((uint)uVar6 & 0x7f) != 9)) ||
                                       (((pProdGlob + i)->dwFlags & 0x3ff) == 0))))) {
                i = i + 1;
            }
...
void HandleBasicAiTasks(short iroCur, PROD *rgprod, short ishdefSBLatest, long *rgResAvail, long *rgResCost)

{
    ...
    for (ipl = 0; ipl < vclpplAi; ipl = ipl + 1) {
        ...
        if (*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd == 0) {
            ...
            iVar3 = *(int *)((int)pPVar1->rgwtMin + 0xe);
            if ((0 < iVar3) || (((-1 < iVar3 && (0x3b < *(uint *)(pPVar1->rgwtMin + 3))) || (((byte *)vlpbAiPlanet)[lppl->id * 0x10 + 2] != 0)))) {
            LAB_1090_9692:
                ...
                if (*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd != 5) {
                    for (i = 0; i < 4; i = i + 1) {
                        ...
                        if (((int)uVar5 <= (int)uVar4) && (((int)uVar5 < (int)uVar4 || (*(uint *)(rgResAvail + i) < *(uint *)(rgResCost + i)))))
                            break;
                    }
                    if (i < 3)
                        goto LAB_1090_95c8;
                ...
                InitProduction(rgprod);
                fWrite = 0;
                if ((*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd == 0) || (((byte *)vlpbAiPlanet)[lppl->id * 0x10 + 2] == 0)) {
                    sVar6 = FUpgradeAiStarbase((PLANET *)CONCAT22(iVar2, pPVar1), ishdefSBLatest);
                    if ((((sVar6 != 0) || (sVar6 = FAIFling((PLANET *)CONCAT22(iVar2, pPVar1), rgResAvail), sVar6 != 0)) ||
                         (sVar6 = FQueueAiScanner((PLANET *)CONCAT22(iVar2, pPVar1), rgResAvail, rgResCost), sVar6 != 0)) ||
                        (sVar6 = FQueueAiDefenses((PLANET *)CONCAT22(iVar2, pPVar1), rgResAvail, rgResCost), sVar6 != 0)) {
                        fWrite = 1;
                    }
                } else if ((*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd == 4) &&
                           (sVar6 = FUpgradeAiStarbase((PLANET *)CONCAT22(iVar2, pPVar1), ishdefSBLatest), sVar6 != 0)) {
                    fWrite = 1;
                }
                if (((*(uint *)((int)&rgplr[0].wMdPlr + idPlayer * 0xc0) >> 0xd != 0) && (fWrite == 0)) &&
                    (sVar6 = FQueueAiTerraforming((PLANET *)CONCAT22(iVar2, pPVar1), rgResAvail, rgResCost), sVar6 != 0)) {
                    fWrite = 1;
                }
    ...
    if (iFirst != -1) {
        while ((*(uint *)((int)&rgplr[0].wFlags_0x4 + idPlayer * 0xc0) & 0xfff) < 0x1f5) {
            ...
            while (true) {
                ...
                if ((pFVar7->iPlayer == idPlayer) && ((pFVar7->wFlags_0x4 >> 10 & 1) == 0))
                    break;
            LAB_1090_995c:
                ifl = ifl + 1;
            }
...
short CheckAiShdefStatus(short ishBeg, short ishEnd, ushort cRecyclePeriod, short *piLatest, byte *rgbOld)
    ...
    *piLatest = -1;
    ...
    for (i = ishBeg; i <= ishEnd; i = i + 1) {
        if ((*(uint *)((int)&rgshdef[0].wFlags + i * 0x93) >> 9 & 1) == 0) {
            ...
            cExist._2_2_ = cExist._2_2_ + *(int *)((int)&rgshdef[0].cExist + 2 + i * 0x93) + (uint)bVar7;
            if ((*piLatest == -1) ||
                (unique0x00017100 = *(uint *)((int)&rgshdef[0].turn + i * 0x93), *(uint *)((int)&rgshdef[0].turn + *piLatest * 0x93) < unique0x00017100)) {
                *piLatest = i;
            }
            if (cRecyclePeriod < game.turn - *(int *)((int)&rgshdef[0].turn + i * 0x93)) {
                if ((*(int *)((int)&rgshdef[0].cExist + i * 0x93) == 0) && (*(int *)((int)&rgshdef[0].cExist + 2 + i * 0x93) == 0)) {
                    ...
                    *&(pSVar6->hul).ihuldef = (char)*pHVar5;
...

{
    ...
    while ((THING *)lpth < pTVar1) {
        ...
        if (lpth->idFull >> 0xd == 0) {
            ...
            uVar3 = __aFulmul((ulong)CONCAT62(CONCAT42(uVar3, (int)(uVar3 >> 0x10)), (int)uVar3), uVar3);
            ((&((THING *)lpth)->u_THING_0x0006)->thp).wFlags = (ushort)uVar3;
            *(undefined2 *)((int)&((THING *)lpth)->u_THING_0x0006 + 2) = (int)(uVar3 >> 0x10);
        }
...

{
    ...
    while (true) {
        ...
        if (pFVar1->iPlayer == idPlayer) {
            if (lpfl == (FLEET *)CONCAT22(iVar2, pFVar1))
                break;
    ...
    if ((((FLEET *)lpflBest == 0) && (lpflBest._2_2_ == 0)) ||
        ((uVar6 = __aFulmul(lMaxDist1, lMaxDist1),
          (long)uVar6 < lVar3 && ((uVar6 = __aFulmul(lMaxDist2, lMaxDist2), (long)uVar6 < lVar3 || (sVar4 = Random(2), sVar4 == 0)))))) {
        sVar4 = 0;
    } else {
...

{
    ...
    if (game.turn < 0x3c) {
        ...
        for (i = 0; i < game.cPlanMax; i = i + 1) {
            if ((*lpb == 0) && (pt2.y = *(short *)((int)&rgptPlan[0].y + i * 4), pt2.x = ((POINT *)rgptPlan + i)->x, pt1.y = sVar1, pt1.x = sVar3,
                                lVar4 = LDistance2(pt1, pt2), lVar4 < lVar2)) {
                lVar2 = lVar4;
            }
            lpb = (byte *)lpb + 0x10;
        }
        if (((lVar2 < 0x1de85) && ((lVar2 < 0x15f91 || (sVar3 = Random(2), sVar3 == 0)))) && ((lVar2 < 0xf425 || (sVar3 = Random(2), sVar3 == 0)))) {
            sVar3 = 1;
        } else {
            sVar3 = 0;
        }
