    ...
    if ((*(int *)&((PLANET *)lppl)->lpplprod == 0) && (*(int *)((int)&((PLANET *)lppl)->lpplprod + 2) == 0)) {
        ...
        if ((*(int *)&ppl->lpplprod == 0) && (*(int *)((int)&ppl->lpplprod + 2) == 0)) {
            ...
            *(undefined2 *)((int)&ppl->lpplprod + 2) = (int)((ulong)pPVar8 >> 0x10);
            ...
            pPVar8 = LpplReAlloc((PL *)CONCAT22(*(undefined2 *)((int)&ppl->lpplprod + 2), *(PL **)&ppl->lpplprod),
                                 (uint)((PLPROD *)((PLANET *)lppl)->lpplprod)->iprodMax);
            *(PL **)&ppl->lpplprod = (PL *)pPVar8;
            *(undefined2 *)((int)&ppl->lpplprod + 2) = (int)((ulong)pPVar8 >> 0x10);
        }
        __fmemcpy((void *)CONCAT22(*(undefined2 *)((int)&ppl->lpplprod + 2), (void *)(*(int *)&ppl->lpplprod + 4)),
                  (void *)CONCAT22(*(undefined2 *)((int)&((PLANET *)lppl)->lpplprod + 2), (void *)(*(int *)&((PLANET *)lppl)->lpplprod + 4)),
...

{
    ...
    pPVar6 = (PLANET *)lppl;
    if ((pPVar6->iPlayer == -1) || ((*(uint *)(pPVar6->rgbImp + 4) & 0xfff) == 0)) {
        pct = fRam11201c9e;
    } else {
        idPlayer = pPVar6->iPlayer;
        sVar2 = FGetBestDefensePart(&part);
        if (sVar2 == 0) {
            pct = fRam11201c9e;
        } else {
            uVar3 = *(uint *)(pPVar6->rgbImp + 4) & 0xfff;
            cDefenses = (long)uVar3;
            uVar4 = CMaxOperableDefenses((PLANET *)CONCAT42(CONCAT22(pPVar6->iPlayer, uVar7), pPVar6), pPVar6->iPlayer, 0);
            if (((int)uVar4 >> 0xf < 1) && (((int)uVar4 >> 0xf < 0 || (uVar4 < uVar3)))) {
                cDefenses = (long)(int)uVar4;
            }
            local_20 = (long)((ARMOR *)part.u_PART_0x0004.parmor)->dp;
            pdVar5 = _pow(DOUBLE_1_0__1120_1caa - (double)local_20 / DOUBLE_1000_0__1120_1ca2, (double)cDefenses);
            pct = (float)*pdVar5;
            if (ppctSmart != 0) {
                local_20 = (long)((ARMOR *)part.u_PART_0x0004.parmor)->dp;
                pdVar5 = _pow(DOUBLE_1_0__1120_1caa - (double)local_20 / DOUBLE_2000_0__1120_1cb2, (double)cDefenses);
                *ppctSmart = (float)*pdVar5;
            }
        }
    }
    idPlayer = sVar1;
...

{
    ...
    if ((*(int *)&pPVar2->lpplprod != *(int *)&ppl->lpplprod) || (*(int *)((int)&pPVar2->lpplprod + 2) != *(int *)((int)&ppl->lpplprod + 2))) {
        if ((*(int *)&pPVar2->lpplprod == 0) && (*(int *)((int)&pPVar2->lpplprod + 2) == 0)) {
            ...
            FreePl((PL *)CONCAT22(*(undefined2 *)((int)&pPVar2->lpplprod + 2), *(PL **)&pPVar2->lpplprod));
        ...
        if (((PLPROD *)pPVar2->lpplprod)->iprodMax < ((PLPROD *)ppl->lpplprod)->iprodMac) {
            pPVar9 =
                LpplReAlloc((PL *)CONCAT22(*(undefined2 *)((int)&pPVar2->lpplprod + 2), *(PL **)&pPVar2->lpplprod), ((PLPROD *)ppl->lpplprod)->iprodMac + 2);
            *(PL **)&pPVar2->lpplprod = (PL *)pPVar9;
            *(undefined2 *)((int)&pPVar2->lpplprod + 2) = (int)((ulong)pPVar9 >> 0x10);
        }
        __fmemcpy((void *)CONCAT22(*(undefined2 *)((int)&pPVar2->lpplprod + 2), (void *)(*(int *)&pPVar2->lpplprod + 4)),
                  (void *)CONCAT22(*(undefined2 *)((int)&ppl->lpplprod + 2), (void *)(*(int *)&ppl->lpplprod + 4)),
                  (uint)((PLPROD *)ppl->lpplprod)->iprodMac << 2);
        ((PLPROD *)pPVar2->lpplprod)->iprodMac = ((PLPROD *)ppl->lpplprod)->iprodMac;
    }
UTIL_FinishCopy:
    __fmemcpy(pPVar8, ppl, 0x34);
...

{
    ...
    uVar4 = __aFulmul((long)pFVar1->rgcsh[ishdef],
                      (long)(int)(((int)((pFVar1->rgcsh[ishdef + 0x10] & 0x7fU) * *(int *)(*(int *)(iVar2 + rglpshdef) + ishdef * 0x93 + 0x38)) / 10) *
    ...
    while (true) {
        if (game.cPlanMax <= i) {
            ...
            if ((((sVar3 == 0) || (scan.grobj != grobjThing)) || (scan.ith == -1)) ||
                ((((THING *)lpThings + scan.ith)->idFull >> 0xd != 1 || ((((&((THING *)lpThings)[scan.ith].u_THING_0x0006)->thp).wFlags >> 10 & 0xf) != 0)))) {
                if (id != -1) {
                    SelectAdjFleet(0, id);
                }
            } else {
        ...
        if ((((POINT *)rgptPlan + i)->x == pt.x) && (*(int *)((int)&rgptPlan[0].y + i * 4) == pt.y))
            break;
        i = i + 1;
    }
    SelectAdjPlanet(0, i);
...

{
    ...
    while (true) {
        ...
        if ((part.hs.wFlags_0x2 >> 8 != 0) && (sVar4 = FLookupPart(&part), sVar4 != 0)) {
            ...
            if (part.hs.grhst == hstBeam) {
                ...
                uVar3 = (pBVar7->dp + pBVar7->init) * (part.hs.wFlags_0x2 >> 8) * 2;
                bVar9 = CARRY2((uint)dpBombs, uVar3);
                dpBombs._0_2_ = (uint)dpBombs + uVar3;
                dpBombs._2_2_ = dpBombs._2_2_ + (uint)bVar9;
            } else if ((part.hs.grhst == hstSpecialE) && (((part.hs.wFlags_0x2 & 0xff) == 0xc || ((part.hs.wFlags_0x2 & 0xff) == 0xd)))) {
                for (i = part.hs.wFlags_0x2 >> 8; 0 < i; i = i + -1) {
                    lVar13 = 100;
                    uVar3 = ((ARMOR *)part.u_PART_0x0004.parmor)->dp;
                    uVar11 = __aFulmul(uVar11, CONCAT22(((int)uVar3 >> 0xf) + (uint)(0xff9b < uVar3), uVar3 + 100));
    ...
    sVar4 = SpdOfShip(0, 0, 0, 0, lpshdef);
    lVar13 = 10;
...

{
    ...
    for (iplr = 0; iplr < game.cPlayer; iplr = iplr + 1) {
        if ((*(int *)(iplr * 4 + rglpshdef) != 0) || (*(int *)(iplr * 4 + rglpshdef_0x2) != 0)) {
            for (ishdef = 0; ishdef < 0x10; ishdef = ishdef + 1) {
                if ((*(uint *)(*(int *)(iplr * 4 + rglpshdef) + ishdef * 0x93 + 0x7b) >> 9 & 1) == 0) {
                    lVar3 =
                        LComputePower((SHDEF *)CONCAT22(*(undefined2 *)(iplr * 4 + rglpshdef_0x2), (SHDEF *)(*(int *)(iplr * 4 + rglpshdef) + ishdef * 0x93)));
                    uVar1 = *(undefined2 *)(iplr * 4 + rglpshdef_0x2);
                    iVar2 = *(int *)(iplr * 4 + rglpshdef) + ishdef * 0x93;
...

{
    ...
    for (ihs = 0; lVar2 = CONCAT22(dpShdef._2_2_, (uint)dpShdef), ihs < (int)(uint)bVar1; ihs = ihs + 1) {
        ...
        if ((lphs->grhst == hstShield) && (pHVar5->wFlags_0x2 >> 8 != 0)) {
            part.hs.grhst = lphs->grhst;
            part.hs.wFlags_0x2 = pHVar5->wFlags_0x2;
            FLookupPart(&part);
            uVar3 = ((ARMOR *)part.u_PART_0x0004.parmor)->dp * (pHVar5->wFlags_0x2 >> 8);
            bVar7 = CARRY2((uint)dpShdef, uVar3);
            dpShdef._0_2_ = (uint)dpShdef + uVar3;
            dpShdef._2_2_ = dpShdef._2_2_ + (uint)bVar7;
        } else if (((lphs->grhst == hstArmor) && (pHVar5->wFlags_0x2 >> 8 != 0)) && ((pHVar5->wFlags_0x2 & 0xff) == 6)) {
            uVar3 = (pHVar5->wFlags_0x2 >> 8) * 0x32;
            bVar7 = CARRY2((uint)dpShdef, uVar3);
            dpShdef._0_2_ = (uint)dpShdef + uVar3;
            dpShdef._2_2_ = dpShdef._2_2_ + (uint)bVar7;
        } else if ((lphs->grhst == hstArmor) && ((pHVar5->wFlags_0x2 & 0xff) == 9)) {
            uVar3 = (pHVar5->wFlags_0x2 >> 8) * 100;
            bVar7 = CARRY2((uint)dpShdef, uVar3);
            dpShdef._0_2_ = (uint)dpShdef + uVar3;
            dpShdef._2_2_ = dpShdef._2_2_ + (uint)bVar7;
        }
    ...
    if (sVar4 != 0) {
        lVar9 = 5;
        lVar8 = __aFlshl(CONCAT22(dpShdef._2_2_, (uint)dpShdef), 1);
...

{
    ...
    if ((lppl != 0) && ((((PLANET *)lppl)->wFlags_0x4 >> 9 & 1) != 0)) {
        iVar2 = ((PLANET *)lppl)->iPlayer * 4;
        uVar1 = *(undefined2 *)(iVar2 + rglpshdefSB_0x2);
        iVar2 = *(int *)(iVar2 + rglpshdefSB) + (*(uint *)&((PLANET *)lppl)->lStarbase & 0xf) * 0x93;
        lphs = (HS *)CONCAT22(uVar1, (HS *)(iVar2 + 0x3a));
        for (ihs = 0; ihs < (int)(uint) * (byte *)(iVar2 + 0x7a); ihs = ihs + 1) {
            if (((lphs->grhst == hstSpecialSB) && (((HS *)lphs)->wFlags_0x2 >> 8 != 0)) && ((((HS *)lphs)->wFlags_0x2 & 0xff) < 7)) {
...

{
    ...
    if (pplr->szName[0] == '\0') {
        ...
        _wsprintf(szName, pcVar2, iVar1);
        if (fPlural == 0) {
            _strcat(szName, (char *)s__s_1120_0515);
        }
        if (grWord == 1) {
        ...
        if ((fPlural != 0) && (pplr->szNames[0] == '\0')) {
            ...
            if ((szName[uVar3 - 1] != 's') && ((szName[uVar3 - 1] != 'e' || (szName[uVar3 - 2] != 's')))) {
                _strcat(szName, (char *)s_s_1120_0513);
            }
        }
        if (grWord == 1) {
            uVar3 = _strlen(szName);
...
short FCalcFleetBombDamage(FLEET *lpfl, long *pdmgPeople, long *pdmgPeopleMin, long *pdmgPeopleSmart, long *pdmgBldg, long *ppctTerra, short *pfMulti)
    ...
    while (true) {
        ...
        for (ishdef = 0; ishdef < 0x10; ishdef = ishdef + 1) {
            if (0 < ((FLEET *)lpfl)->rgcsh[ishdef]) {
                for (j = 0; j < (int)(uint) * (byte *)(*(int *)(iVar3 * 4 + rglpshdef) + ishdef * 0x93 + 0x7a); j = j + 1) {
                    if (*(int *)(*(int *)(iVar3 * 4 + rglpshdef) + ishdef * 0x93 + 0x3a + j * 4) == 0x40) {
                        uVar4 = *(undefined2 *)(iVar3 * 4 + rglpshdef_0x2);
                        pHVar8 = (HullSlotType *)(*(int *)(iVar3 * 4 + rglpshdef) + ishdef * 0x93 + 0x3a + j * 4);
                        part.hs.grhst = *pHVar8;
                        part.hs.wFlags_0x2 = pHVar8[1];
                        FLookupPart(&part);
                        if ((part.hs.wFlags_0x2 & 0xff) == 9) {
                            uVar9 = __aFulmul((ulong)(part.hs.wFlags_0x2 >> 8), (long)((FLEET *)lpfl)->rgcsh[ishdef]);
                            puVar1 = (uint *)ppctTerra;
                            uVar2 = *puVar1;
                            *puVar1 = *puVar1 + (uint)uVar9;
                            *(int *)((int)ppctTerra + 2) = *(int *)((int)ppctTerra + 2) + (int)(uVar9 >> 0x10) + (uint)CARRY2(uVar2, (uint)uVar9);
                            ...
                            if (((BEAM *)part.u_PART_0x0004.pbeam)->init == 0) {
                                ...
                                uVar11 = (ulong)((BEAM *)part.u_PART_0x0004.pbeam)->dp;
                                uVar9 = __aFulmul((ulong)(part.hs.wFlags_0x2 >> 8), (long)((FLEET *)lpfl)->rgcsh[ishdef]);
                                uVar9 = __aFulmul(uVar9, uVar11);
                                puVar1 = (uint *)pdmgPeople;
                                uVar2 = *puVar1;
                                *puVar1 = *puVar1 + (uint)uVar9;
                                *(int *)((int)pdmgPeople + 2) = *(int *)((int)pdmgPeople + 2) + (int)(uVar9 >> 0x10) + (uint)CARRY2(uVar2, (uint)uVar9);
                                uVar11 = (ulong)((BEAM *)part.u_PART_0x0004.pbeam)->init;
                                uVar9 = __aFulmul((ulong)(part.hs.wFlags_0x2 >> 8), (long)((FLEET *)lpfl)->rgcsh[ishdef]);
                                uVar9 = __aFulmul(uVar9, uVar11);
                                puVar1 = (uint *)pdmgBldg;
                                uVar2 = *puVar1;
                                *puVar1 = *puVar1 + (uint)uVar9;
                                *(int *)((int)pdmgBldg + 2) = *(int *)((int)pdmgBldg + 2) + (int)(uVar9 >> 0x10) + (uint)CARRY2(uVar2, (uint)uVar9);
                                if ((part.hs.wFlags_0x2 & 0xff) < 5) {
                                    uVar11 = 3;
                                    uVar9 = __aFulmul((ulong)(part.hs.wFlags_0x2 >> 8), (long)((FLEET *)lpfl)->rgcsh[ishdef]);
                                    uVar9 = __aFulmul(uVar9, uVar11);
                                    ...
                                    *(int *)((int)pdmgPeopleMin + 2) =
                                        *(int *)((int)pdmgPeopleMin + 2) + (int)(uVar9 >> 0x10) + (uint)CARRY2(uVar2, (uint)uVar9);
                                }
                            }
                        }
                    } else if ((*(int *)(*(int *)(iVar3 * 4 + rglpshdef) + ishdef * 0x93 + 0x3a + j * 4) == 0x10) &&
                               ((*(uint *)(*(int *)(iVar3 * 4 + rglpshdef) + ishdef * 0x93 + j * 4 + 0x3c) & 0xff) == 0x12)) {
                        uVar4 = *(undefined2 *)(iVar3 * 4 + rglpshdef_0x2);
                        pHVar8 = (HullSlotType *)(*(int *)(iVar3 * 4 + rglpshdef) + ishdef * 0x93 + 0x3a + j * 4);
                        part.hs.grhst = *pHVar8;
                        part.hs.wFlags_0x2 = pHVar8[1];
                        ...
                        *(int *)((int)pdmgBldg + 2) = *(int *)((int)pdmgBldg + 2) + (int)(uVar9 >> 0x10) + (uint)CARRY2(uVar2, (uint)uVar9);
                        ...
                        uVar2 = *puVar1;
                        *puVar1 = *puVar1 + (uint)uVar9;
                        *(int *)((int)pdmgPeopleMin + 2) = *(int *)((int)pdmgPeopleMin + 2) + (int)(uVar9 >> 0x10) + (uint)CARRY2(uVar2, (uint)uVar9);
                    } else if ((*(int *)(*(int *)(iVar3 * 4 + rglpshdef) + ishdef * 0x93 + 0x3a + j * 4) == 0x1000) &&
                               ((*(uint *)(*(int *)(iVar3 * 4 + rglpshdef) + ishdef * 0x93 + j * 4 + 0x3c) & 0xff) == 1)) {
                        uVar4 = *(undefined2 *)(iVar3 * 4 + rglpshdef_0x2);
                        pHVar8 = (HullSlotType *)(*(int *)(iVar3 * 4 + rglpshdef) + ishdef * 0x93 + 0x3a + j * 4);
                        part.hs.grhst = *pHVar8;
                        part.hs.wFlags_0x2 = pHVar8[1];
        ...
        cfl = cfl + 1;
        /* WARNING: Load size is inaccurate */
        lpflNext = (FLEET *)CONCAT22(*(undefined2 *)((int)&((FLEET *)lpfl)->lpflNext + 2), ((FLEET *)lpfl)->lpflNext);
        while (true) {
            if ((lpflNext == 0) || (((((FLEET *)lpflNext)->wFlags_0x4 >> 10 & 1) == 0 && (((FLEET *)lpflNext)->iPlayer == iVar3))))
                break;
            /* WARNING: Load size is inaccurate */
            lpflNext = (FLEET *)CONCAT22(*(undefined2 *)((int)&((FLEET *)lpflNext)->lpflNext + 2), ((FLEET *)lpflNext)->lpflNext);
        }
        if ((lpflNext == 0) || ((pFVar6 == lpflNext || (((FLEET *)lpflNext)->idPlanet != ((FLEET *)lpfl)->idPlanet)))) {
            lpfl = 0;
        } else {
            lpfl = lpflNext;
        }
    }
    lVar10 = __ftol((double)CONCAT26(in_stack_0000ffc6, CONCAT24(in_stack_0000ffc4, CONCAT22(unaff_SI, unaff_DI))));
    *(int *)pdmgPeopleSmart = (int)lVar10;
    *(undefined2 *)((int)pdmgPeopleSmart + 2) = (int)((ulong)lVar10 >> 0x10);
    if ((-1 < *(int *)((int)pdmgPeopleSmart + 2)) && ((0 < *(int *)((int)pdmgPeopleSmart + 2) || (999 < *(uint *)pdmgPeopleSmart)))) {
        *(undefined2 *)pdmgPeopleSmart = 1000;
        *(undefined2 *)((int)pdmgPeopleSmart + 2) = 0;
    }
    *pfMulti = (uint)(1 < cfl);
    if ((((((((int)*pdmgPeople == 0) && (*(int *)((int)pdmgPeople + 2) == 0)) && ((int)*pdmgPeopleMin == 0)) &&
           ((*(int *)((int)pdmgPeopleMin + 2) == 0 && ((int)*pdmgPeopleSmart == 0)))) &&
          ((*(int *)((int)pdmgPeopleSmart + 2) == 0 && (((int)*pdmgBldg == 0 && (*(int *)((int)pdmgBldg + 2) == 0)))))) &&
         ((int)*ppctTerra == 0)) &&
...

{
    ...
    do {
        ...
        iVar1 = *(int *)((FLEET **)rglpfl + iflHead);
        iVar2 = *(int *)((int)((FLEET **)rglpfl + iflHead) + 2);
        if ((((*(uint *)(iVar1 + 4) >> 10 & 1) == 0) && (*(int *)(iVar1 + 0x68) == 0)) && (*(int *)(iVar1 + 0x6a) == 0)) {
            for (i = 0; i < cSrc; i = i + 1) {
                uVar7 = (undefined2)((ulong)rglpflSrc[i] >> 0x10);
                pFVar6 = (FLEET *)rglpflSrc[i];
                iVar3 = (pFVar6->pt).y;
                if ((*(int *)(iVar1 + 10) <= iVar3) && ((*(int *)(iVar1 + 10) < iVar3 || (*(uint *)(iVar1 + 8) <= (uint)(&pFVar6->pt)->x)))) {
                    uVar7 = (undefined2)((ulong)rglpflSrc[i] >> 0x10);
                    pFVar6 = (FLEET *)rglpflSrc[i];
                    if ((*(int *)(iVar1 + 8) == (&pFVar6->pt)->x) && (*(int *)(iVar1 + 10) == (pFVar6->pt).y)) {
                        uVar8 = (undefined2)((ulong)rglpflSrc[i] >> 0x10);
                        pFVar6 = (FLEET *)rglpflSrc[i];
                        uVar7 = *(undefined2 *)(undefined1 *)((int)&pFVar6->lpflNext + 2);
                        *(undefined2 *)(iVar1 + 0x68) = *(undefined2 *)&pFVar6->lpflNext;
                        *(undefined2 *)(iVar1 + 0x6a) = uVar7;
                        uVar7 = (undefined2)((ulong)rglpflSrc[i] >> 0x10);
                        pFVar6 = (FLEET *)rglpflSrc[i];
                        *(int *)&pFVar6->lpflNext = iVar1;
                        *(int *)(undefined1 *)((int)&pFVar6->lpflNext + 2) = iVar2;
                        i = -1;
                    }
                    break;
                }
                ...
                if (0x3e < cSrc) {
                    while (iflTail = iflTail + 1, iflTail < cFleet) {
                        ...
                        if ((((*(uint *)(iVar1 + 4) >> 10 & 1) == 0) && (*(int *)(iVar1 + 0x68) == 0)) && (*(int *)(iVar1 + 0x6a) == 0)) {
                            pt.x = *(short *)(iVar1 + 8);
                            pt.y = *(short *)(iVar1 + 10);
                            piVar5 = _bsearch(&pt, rglpflSrc, cSrc, 4, (char *)"R6002\r\n- floating-point support not loaded\r\n" + 0x13);
                            if (piVar5 != 0) {
                                iVar3 = *piVar5;
                                iVar4 = piVar5[1];
                                uVar7 = *(undefined2 *)(iVar3 + 0x6a);
...

{
    ...
    } while ((pFVar2->id < (int)(idFleet & 0x1fffU)) || (iHi = iVar1, iVar1 = iLo, (int)(idFleet & 0x1fffU) < pFVar2->id));
...

{
    ...
    if (cFleet < 1) {
        ...
        pFVar2 = (FLEET *)pFVar8;
        if (((pFVar2 != 0) || (iVar5 != 0)) && (pfl != 0)) {
            if (bVar7) {
                InvalidateReport(1, 0);
                LogChangeFleet(pFVar8, pfl);
                if ((*(int *)&pFVar2->lpplord != *(int *)&pfl->lpplord) || (*(int *)((int)&pFVar2->lpplord + 2) != *(int *)((int)&pfl->lpplord + 2))) {
                    if ((int)(uint)((PLORD *)pFVar2->lpplord)->iordMax < pfl->cord) {
                        pPVar9 = LpplReAlloc((PL *)CONCAT22(*(undefined2 *)((int)&pFVar2->lpplord + 2), *(PL **)&pFVar2->lpplord), pfl->cord + 3);
                        *(PL **)&pFVar2->lpplord = (PL *)pPVar9;
                        *(undefined2 *)((int)&pFVar2->lpplord + 2) = (int)((ulong)pPVar9 >> 0x10);
                    }
                    __fmemcpy((void *)CONCAT22(*(undefined2 *)((int)&pFVar2->lpplord + 2), (void *)(*(int *)&pFVar2->lpplord + 4)),
                              (void *)CONCAT22(*(undefined2 *)((int)&pfl->lpplord + 2), (void *)(*(int *)&pfl->lpplord + 4)),
                              (uint)((PLORD *)pfl->lpplord)->iordMac * 0x12);
                    ((PLORD *)pFVar2->lpplord)->iordMac = ((PLORD *)pfl->lpplord)->iordMac;
                }
                __fmemcpy(pFVar8, pfl, 100);
                if ((((uint)gd.grBits >> 0xb & 1) != 0) && (idPlayer == 0)) {
                    AdvanceTutor();
                }
...

{
    ...
    if ((*(int *)&((FLEET *)lpfl)->lpplord == 0) && (*(int *)((int)&((FLEET *)lpfl)->lpplord + 2) == 0)) {
        if ((pPVar3 != 0) || (iVar4 != 0)) {
        ...
        *(int *)((int)&pfl->lpplord + 2) = iVar4;
        if ((*(int *)&pfl->lpplord == 0) && (*(int *)((int)&pfl->lpplord + 2) == 0)) {
            ...
            *(undefined2 *)((int)&pfl->lpplord + 2) = (int)((ulong)pPVar8 >> 0x10);
            ...
            pPVar8 =
                LpplReAlloc((PL *)CONCAT22(*(undefined2 *)((int)&pfl->lpplord + 2), *(PL **)&pfl->lpplord), (uint)((PLORD *)((FLEET *)lpfl)->lpplord)->iordMax);
            *(PL **)&pfl->lpplord = (PL *)pPVar8;
            *(undefined2 *)((int)&pfl->lpplord + 2) = (int)((ulong)pPVar8 >> 0x10);
        }
        __fmemcpy((void *)CONCAT22(*(undefined2 *)((int)&pfl->lpplord + 2), (void *)(*(int *)&pfl->lpplord + 4)),
                  (void *)CONCAT22(*(undefined2 *)((int)&((FLEET *)lpfl)->lpplord + 2), (void *)(*(int *)&((FLEET *)lpfl)->lpplord + 4)),
...

{
    ...
    if (0 < cFleet) {
        if (cFleet != 0) {
            for (i = 0; i < cFleet; i = i + 1) {
                ...
                if ((((pFVar6->idPlanet == idPlanet) && (lpfl->id != idSkip)) &&
                     ((idSkip == -1 || (((&pFVar6->pt)->x == sel.pt.x && ((pFVar6->pt).y == sel.pt.y)))))) &&
        ...
        lpth = (THING *)CONCAT22(lpThings._2_2_, (THING *)lpThings);
        while ((THING *)lpth < (THING *)lpThings + cThing) {
            if ((((lpth->idFull >> 0xd == 1) && ((&((THING *)lpth)->pt)->x == sel.pt.x)) && ((((THING *)lpth)->pt).y == sel.pt.y)) &&
                (bVar9 = iNth == 0, iNth = iNth + -1, bVar9)) {
                if (pxf != 0) {
                    puVar8 = &pxf->u_XFER_0x0004;
                    pTVar7 = (THING *)lpth;
...

{
    ...
    pTVar5 = LpthFromId(id);
    iVar4 = (int)((ulong)pTVar5 >> 0x10);
    pTVar1 = (THING *)pTVar5;
    if ((pTVar1 == 0) && (iVar4 == 0)) {
        szWork[0] = '\0';
    } else if (pTVar5->idFull >> 0xd == 0) {
        if ((pTVar5->idFull >> 9 & 0xf) == idPlayer) {
            szPlr[0] = '\0';
        } else {
            pcVar3 = PszPlayerName(pTVar5->idFull >> 9 & 0xf, 0, 0, 0, 0, 0);
            _wsprintf(szPlr, "%s ", pcVar3, 0x1120);
        }
        uVar7 = *(undefined2 *)((uint) * (byte *)((int)&pTVar1->u_THING_0x0006 + 6) * 2 + 0x4f2);
        uVar8 = 0x1120;
        pcVar6 = szPlr;
        pcVar3 = PszGetCompressedString(idsSSMineField);
        _wsprintf(szWork, pcVar3, pcVar6, uVar7, uVar8);
    } else if (pTVar5->idFull >> 0xd == 1) {
        if ((((&pTVar1->u_THING_0x0006)->thp).wFlags >> 10 & 0xf) == 0) {
            ...
            _wsprintf(szWork, pcVar2, pcVar3);
        }
    } else if (pTVar5->idFull >> 0xd == 2) {
        pcVar3 = PszGetCompressedString(idsWormhole);
        _strcpy((char *)szWork, pcVar3);
    } else if (pTVar5->idFull >> 0xd == 3) {
        pcVar3 = PszGetCompressedString(idsMysteryTrader);
        _strcpy((char *)szWork, pcVar3);
    } else {
        pcVar3 = PszGetCompressedString(idsMysteryObject);
        _strcpy((char *)szWork, pcVar3);
    }
    return (char *)szWork;
}
...

{
    ...
    if (iPlayer == idPlayer) {
        ...
        pcVar2 = PszPlayerName(iPlayer, 0, 0, 0, 0, 0);
        _wsprintf(szPlr, "%s ", pcVar2, 0x1120);
    }
    if (((pFVar1 == 0) && (iVar4 == 0)) || ((*(int *)&pFVar1->lpszName == 0 && (*(int *)((int)&pFVar1->lpszName + 2) == 0)))) {
        if ((pFVar1 == 0) && (iVar4 == 0)) {
            ...
            if (sVar3 == 0x10) {
                ...
                __fstrcpy(szShdef,
                          (char *)CONCAT22(*(undefined2 *)(iPlayer * 4 + rglpshdef_0x2), (char *)(*(int *)(iPlayer * 4 + rglpshdef) + sVar3 * 0x93 + 8)));
                cch = _strlen(szShdef);
                if (0x1c < cch) {
                    cch = 0x1c;
                }
        ...
        _wsprintf(szWork, "%s%s #%d", szPlr);
    } else {
        _wsprintf(szWork, "%s%s", szPlr);
    }
    return (char *)szWork;
}
...

{
    ...
    uVar1 = w >> 9 & 0xf;
    if ((*(uint *)(*(int *)(idPlayer * 4 + rglpshdef) + uVar1 * 0x93 + 0x7b) >> 9 & 1) == 0) {
        __fstrcpy(szShdef, (char *)CONCAT22(*(undefined2 *)(idPlayer * 4 + rglpshdef_0x2), (char *)(*(int *)(idPlayer * 4 + rglpshdef) + uVar1 * 0x93 + 8)));
        cch = _strlen(szShdef);
        if (0x1c < cch) {
            cch = 0x1c;
        }
    ...
    _wsprintf(szWork, "%s #%d", (char *)lpsz, lpsz._2_2_, (w & 0x1ff) + 1);
    return (char *)szWork;
}
...

{
    ...
    if ((id & 0x8000U) == 0) {
        ...
        _wsprintf(szWork, pcVar2, pcVar1, uVar3);
    }
    return (char *)szWork;
}
...

{
    ...
    while (true) {
        ...
        /* WARNING: Load size is inaccurate */
        if ((((FLEET **)rglpfl)[i] == (FLEET *)lpfl) && (*(int *)((int)((FLEET **)rglpfl + i) + 2) == lpfl._2_2_))
            break;
        i = i + 1;
    }
    return i;
...

{
    ...
    for (i = 0; i < cFleet; i = i + 1) {
        ...
        if (((pFVar5 == 0) && (iVar4 == 0)) || (lpfl->id == idFleet))
            break;
        if (idFleet < lpfl->id) {
            return 0;
        }
    ...
    if (i == cFleet) {
        ...
        FreePl((PL *)CONCAT22(*(undefined2 *)((int)&pFVar5->lpplord + 2), *(PL **)&pFVar5->lpplord));
        if ((*(int *)&pFVar5->lpszName != 0) || (*(int *)((int)&pFVar5->lpszName + 2) != 0)) {
            /* WARNING: Load size is inaccurate */
            FreeLp((void *)CONCAT22(*(undefined2 *)((int)&pFVar5->lpszName + 2), pFVar5->lpszName), htString);
        }
        cFleet = cFleet + -1;
        ...
        *puVar1 = *puVar1 | lppl._2_2_;
        if ((grobjSel == 0) && (pFVar5->idPlanet != -1)) {
            ...
            if ((((PLANET *)pPVar7 != 0) || (iVar4 != 0)) && (((PLANET *)pPVar7)->iPlayer == idPlayer)) {
                grobjSel = 1;
                idSel = pFVar5->idPlanet;
            }
        }
        if (cFleet != i) {
            __fmemmove((FLEET **)CONCAT22(rglpfl._2_2_, (FLEET **)rglpfl + i), (FLEET **)CONCAT22(rglpfl._2_2_, (FLEET **)rglpfl + i + 1), (cFleet - i) * 4);
        }
...

{
    ...
    for (i = 0; i < cFleet; i = i + 1) {
        ...
        if (iPlr <= pFVar4->iPlayer) {
            if ((iPlr < pFVar4->iPlayer) || ((lpfl->id & 0x1ffU) != iflPrev + 1U))
                break;
            iflPrev = lpfl->id & 0x1ff;
        }
    }
    rglpfl = LpReAlloc((FLEET **)CONCAT22(rglpfl._2_2_, (FLEET **)rglpfl), (cFleet + 1) * 4, htMisc);
    uVar6 = (undefined2)((ulong)rglpfl >> 0x10);
    if (cFleet != i) {
        __fmemmove((FLEET **)CONCAT22(uVar6, (FLEET **)rglpfl + i + 1), (FLEET **)CONCAT22(uVar6, (FLEET **)rglpfl + i), (cFleet - i) * 4);
    }
    pFVar9 = LpAlloc(0x7c, htFleets);
    uVar6 = rglpfl._2_2_;
    uVar7 = (undefined2)((ulong)pFVar9 >> 0x10);
    pFVar4 = (FLEET *)pFVar9;
    ppFVar8 = (FLEET **)rglpfl + i;
    *(FLEET **)ppFVar8 = pFVar4;
    *(undefined2 *)((int)ppFVar8 + 2) = uVar7;
    cFleet = cFleet + 1;
    iVar2 = *(int *)((int)&rgplr[0].wFlags_0x4 + iPlr * 0xc0);
    puVar1 = (uint *)((int)&rgplr[0].wFlags_0x4 + iPlr * 0xc0);
    *puVar1 = *puVar1 & 0xf000;
    puVar1 = (uint *)((int)&rgplr[0].wFlags_0x4 + iPlr * 0xc0);
    *puVar1 = *puVar1 | iVar2 + 1U & 0xfff;
    __fmemset(pFVar9, 0, 0x7c);
    pFVar9->id = pFVar9->id & 0xfe00U | iflPrev + 1U & 0x1ff;
    pFVar4->iPlayer = iPlr;
    pFVar9->id = pFVar9->id & 0xe1ffU | (iPlr & 0xfU) << 9;
    pFVar4->wFlags_0x4 = pFVar4->wFlags_0x4 & 0xff00 | 7;
    ...
    pFVar4->cord = 1;
    pFVar4->wFlags_0x4 = pFVar4->wFlags_0x4 & 0xfdff;
    pPVar10 = LpplAlloc(0x12, 3, htOrd);
    *(PL **)&pFVar4->lpplord = (PL *)pPVar10;
    *(undefined2 *)((int)&pFVar4->lpplord + 2) = (int)((ulong)pPVar10 >> 0x10);
    ((PLORD *)pFVar4->lpplord)->iordMac = 1;
    *(uint *)((int)&pFVar4->dirLong + 2) = *(uint *)((int)&pFVar4->dirLong + 2) & 0xffef;
    iVar2 = *(int *)&pFVar4->lpplord;
    uVar6 = *(undefined2 *)((int)&pFVar4->lpplord + 2);
    lpord = (ORDER *)CONCAT22(uVar6, (ORDER *)(iVar2 + 4));
    sVar3 = (pFVar4->pt).y;
...

{
    ...
    pFVar3->wFlags_0x4 = pFVar3->wFlags_0x4 & 0xfdff | (pfl->wFlags_0x4 >> 9 & 1) << 9;
    pFVar3->wFlags_0x4 = pFVar3->wFlags_0x4 & 0xff00 | pfl->wFlags_0x4 & 0xff;
    pFVar3->iplan = pfl->iplan;
    bVar1 = ((PLORD *)pfl->lpplord)->iordMac;
    if ((uint)((PLORD *)pFVar3->lpplord)->iordMax < (uint)bVar1) {
        pPVar6 = LpplReAlloc((PL *)CONCAT22(*(undefined2 *)((int)&pFVar3->lpplord + 2), *(PL **)&pFVar3->lpplord), (uint)((PLORD *)pfl->lpplord)->iordMax);
        *(PL **)&pFVar3->lpplord = (PL *)pPVar6;
        *(undefined2 *)((int)&pFVar3->lpplord + 2) = (int)((ulong)pPVar6 >> 0x10);
    }
    __fmemcpy((void *)CONCAT22(*(undefined2 *)((int)&pFVar3->lpplord + 2), (void *)(*(int *)&pFVar3->lpplord + 4)),
              (void *)CONCAT22(*(undefined2 *)((int)&pfl->lpplord + 2), (void *)(*(int *)&pfl->lpplord + 4)), (uint)bVar1 * 0x12);
...

{
        ...
        if (vrgiflMerge[i] != -1) {
            ...
            if ((pFVar8 != 0) || (iVar10 != 0)) {
                for (j = 0; j < 0x10; j = j + 1) {
                    if (pFVar8->rgcsh[j] != 0) {
                        if (pFVar8->rgcsh[j + 0x10] != 0) {
                            lVar13 = 100;
                            uVar12 = __aFulmul((long)pFVar8->rgcsh[j], (ulong)(uint)pFVar8->rgcsh[j + 0x10] & 0xffff007f);
                            ...
                            uVar12 = __aFulmul((ulong)((uint)pFVar8->rgcsh[j + 0x10] >> 7), (long)cshT);
                            puVar2 = (uint *)(rgdp + j);
                            uVar3 = *puVar2;
    ...
    for (j = 0; j < 0x10; j = j + 1) {
        ...
        if ((rgcshDamaged[j] == 0) || (((FLEET *)lpflMerge)->rgcsh[j] == 0)) {
            ((FLEET *)lpflMerge)->rgcsh[j + 0x10] = 0;
        } else {
            ...
            ((FLEET *)lpflMerge)->rgcsh[j + 0x10] = ((FLEET *)lpflMerge)->rgcsh[j + 0x10] & 0xff80U | (uint)lVar13 & 0x7f;
            lVar13 = __aFldiv(CONCAT22(*(undefined2 *)((int)rgdp + j * 4 + 2), (int)rgdp[j]), (long)rgcshDamaged[j]);
            ((FLEET *)lpflMerge)->rgcsh[j + 0x10] = ((FLEET *)lpflMerge)->rgcsh[j + 0x10] & 0x7fU | (int)lVar13 << 7;
        }
    }
    for (j = 0; j < 5; j = j + 1) {
...

{
    ...
    while (true) {
        if (iwp <= i) {
            ...
            iVar4 = _wsprintf(sz, pcVar3, sVar2);
...

{
    ...
    for (i = 0; i < 0x10; i = i + 1) {
        if ((0 < ((FLEET *)lpfl)->rgcsh[i]) && (cDiff = cDiff + 1, csh < ((FLEET *)lpfl)->rgcsh[i])) {
            ...
            iVar1 = *(int *)(*(int *)(iVar1 + rglpshdef) + i * 0x93);
...

{
    ...
    lVar2 = __ftol((double)CONCAT26(d2._2_2_, CONCAT24((undefined2)d2, CONCAT22(unaff_SI, unaff_DI))));
    uVar3 = __aFldiv(lVar2, 100);
    uVar4 = __aFulmul(uVar3, 100);
    lVar2 = lVar2 - uVar4;
    if (dyArial8 < 0xf) {
        pcVar1 = PszGetCompressedString(idsLdLdLightYears);
        _wsprintf(szWork, pcVar1, uVar3, lVar2);
    } else {
...

{
    ...
    iVar1 = x2 - x1;
    iVar2 = y2 - y1;
    uVar4 = __aFulmul((ulong)CONCAT62(CONCAT42((long)iVar2, iVar2 >> 0xf), iVar2), (long)iVar2);
    uVar5 = __aFulmul((ulong)CONCAT62(CONCAT42((long)iVar1, iVar1 >> 0xf), iVar1), (long)iVar1);
    pdVar3 = _sqrt((double)(long)(uVar5 + uVar4));
    DOUBLE_0_0__1120_1706 = *pdVar3;
    return (double *)&DOUBLE_0_0__1120_1706;
}
...

{
                ...
                if ((long)uVar14 <= (long)uVar12) {
                    if (((uVar12 == uVar14) && ((scan.grobj & grobjPlanet) == grobjNone)) ||
                        ...
                        if (((scan.grobjFull & grobjFleet) == grobjNone) ||
                            ((((FLEET *)((FLEET **)rglpfl)[scan.ifl])->iPlayer != idPlayer && (*(int *)(iVar8 + 2) == idPlayer)))) {
                            scan.ifl = i;
    ...
    if (((grobj & grobjOther) != grobjNone) && (i = sel.fl.cord, sel.grobj == grobjFleet)) {
    LAB_1038_46f2:
        i = i + -1;
        if (-1 < i) {
            ...
            if ((long)uVar13 <= (long)uVar12) {
                ...
                uVar13 = uVar13 + uVar14;
                if ((long)uVar13 <= (long)uVar12) {
                    if (((uVar13 == uVar12) && ((scan.grobj & (grobjThing | grobjFleet | grobjPlanet)) == grobjNone)) ||
    ...
    if ((((grobj & 0x20) == grobjNone) && (scan.grobj != grobjNone)) &&
        (uVar12 = CONCAT22(&scanT, grobj) & 0xffff000f, pt_00.y = scan.pt.y, pt_00.x = scan.pt.x,
         sVar6 = FFindNearestObject(pt_00, (GrobjClass)uVar12 ^ (grobjThing | grobjOther | grobjFleet | grobjPlanet) | 0xa0, (SCAN *)(uVar12 >> 0x10)),
         sVar6 != 0)) {
        if (scanT.idpl != -1) {
...

{
    ...
    uVar12 = (undefined2)((ulong)lpshdef >> 0x10);
    pSVar10 = (SHDEF *)lpshdef;
    if ((pSVar10->wFlags & 0xff) == 7) {
        sVar7 = GetRaceGrbit((PLAYER *)rgplr + idPlayer, ibitRaceRegeneratingShields);
        bVar13 = sVar7 != 0;
    } else {
        bVar13 = false;
    }
    ...
    wt._0_2_ = (pHVar5->hul).wtEmpty;
    (pSVar10->hul).dp = (pHVar5->hul).dp;
    for (c = 0; c < (int)(uint)(pSVar10->hul).chs; c = c + 1) {
        if ((pSVar10->hul).rghs[c].wFlags_0x2 >> 8 != 0) {
            pHVar11 = (pSVar10->hul).rghs + c;
            part.hs.grhst = pHVar11->grhst;
            part.hs.wFlags_0x2 = pHVar11->wFlags_0x2;
            FLookupPart(&part);
            GetTruePartCost(idPlayer, &part, rgCosts);
            for (k = 0; k < 3; k = k + 1) {
                uVar8 = ((pSVar10->hul).rghs[c].wFlags_0x2 >> 8) * rgCosts[k];
                puVar1 = rgMin + k;
                uVar6 = *puVar1;
                *puVar1 = (uint)*puVar1 + uVar8;
                piVar2 = (int *)((int)rgMin + k * 4 + 2);
                *piVar2 = *piVar2 + (uint)CARRY2((uint)uVar6, uVar8);
            }
            resCost._0_2_ = (ushort)resCost + ((pSVar10->hul).rghs[c].wFlags_0x2 >> 8) * rgCosts[3];
            wt._0_2_ = (ushort)wt + ((pSVar10->hul).rghs[c].wFlags_0x2 >> 8) * ((ARMOR *)part.u_PART_0x0004.parmor)->cMass;
            HVar4 = ((pSVar10->hul).rghs + c)->grhst;
            if (HVar4 == hstShield) {
                if ((((pSVar10->hul).rghs[c].wFlags_0x2 & 0xff) == 3) || (((pSVar10->hul).rghs[c].wFlags_0x2 & 0xff) == 6)) {
                    puVar3 = &(pSVar10->hul).dp;
                    *puVar3 = *puVar3 + ((pSVar10->hul).rghs[c].wFlags_0x2 >> 8) * 0x41;
                }
            } else if (HVar4 == hstArmor) {
                dpT = ((pSVar10->hul).rghs[c].wFlags_0x2 >> 8) * ((ARMOR *)part.u_PART_0x0004.parmor)->dp;
                if (bVar13) {
                    dpT = dpT >> 1;
                }
                puVar3 = &(pSVar10->hul).dp;
                *puVar3 = *puVar3 + dpT;
            } else if ((HVar4 == hstSpecialM) && (((pSVar10->hul).rghs[c].wFlags_0x2 & 0xff) == 4)) {
                puVar3 = &(pSVar10->hul).dp;
                *puVar3 = *puVar3 + ((pSVar10->hul).rghs[c].wFlags_0x2 >> 8) * 0x32;
            }
        }
    }
    for (c = 0; c < 3; c = c + 1) {
        (pSVar10->hul).rgwtOreCost[c] = (ushort)rgMin[c];
    }
    (pSVar10->hul).resCost = (ushort)resCost;
    (pSVar10->hul).wtEmpty = (ushort)wt;
    *&pSVar10->u_SHDEF_0x0087 = 0xffff;
    *(undefined2 *)((int)&pSVar10->u_SHDEF_0x0087 + 2) = 0xffff;
    return;
}
...

{
    ...
    if (sVar2 == raMacintosh) {
        uVar9 = __aFulmul(CONCAT22(*(undefined2 *)((int)pPVar4->rgwtMin + 0xe), (int)pPVar4->rgwtMin[3]), 10);
        _sqrt((double)(long)uVar9);
        lVar8 = __ftol((double)CONCAT26((int)(uVar9 >> 0x10), CONCAT24((int)uVar9, CONCAT22(unaff_SI, unaff_DI))));
        sVar3 = (short)lVar8;
        sVar2 = GetRaceGrbit((PLAYER *)rgplr + idPlayer, ibitRaceNoAdvScanner);
        if (sVar2 == 0) {
            if (((pDeep != 0) && ((pPVar4->wFlags_0x4 >> 9 & 1) != 0)) &&
                (iVar5 = pPVar4->iPlayer * 4, 0x22 < *(int *)(*(int *)(iVar5 + rglpshdefSB) + (*(uint *)&pPVar4->lStarbase & 0xf) * 0x93))) {
                *pDeep = sVar3 / 2;
            }
        } else {
            lVar8 = 1000;
            uVar9 = __aFulmul((long)sVar3, 0x584);
            lVar8 = __aFldiv((long)CONCAT62(CONCAT42(lVar8, (int)(uVar9 >> 0x10)), (int)uVar9), lVar8);
            sVar3 = (short)lVar8;
            if (pDeep != 0) {
                *pDeep = 0;
            }
        ...
        uVar9 = __aFulshr(CONCAT22(*(undefined2 *)(pPVar4->rgbImp + 6), *(undefined2 *)(pPVar4->rgbImp + 4)), 0xc);
        if (((uint)uVar9 & 0x1f) == 0x1f) {
            sVar3 = 0;
        } else {
            LookupBestPlanetaryScanner(&part);
            pAVar6 = (ARMOR *)part.u_PART_0x0004.parmor;
            uVar7 = part.u_PART_0x0004._2_2_;
            if ((pDeep != 0) && (pAVar6->dp < 0)) {
                *pDeep = -pAVar6->dp >> 1;
            }
    ...
    if (((uint)gd.grBits >> 1 & 1) == 0) {
        ...
        for (i = 0; i < 0x10; i = i + 1) {
            if (0 < ((FLEET *)lpfl)->rgcsh[i]) {
                iVar2 = *(int *)(*(int *)(iVar1 * 4 + rglpshdef) + i * 0x93 + 0x8d);
                sVar3 = dRange;
                if ((iVar2 != 0x7ff) && (sVar3 = iVar2, iVar2 <= dRange)) {
                    sVar3 = dRange;
                }
                dRange = sVar3;
                if (dPlanRange < *(int *)(*(int *)(iVar1 * 4 + rglpshdef) + i * 0x93 + 0x8f)) {
                    dPlanRange = *(short *)(*(int *)(iVar1 * 4 + rglpshdef) + i * 0x93 + 0x8f);
                }
                if ((uint) * (byte *)(*(int *)(iVar1 * 4 + rglpshdef) + i * 0x93 + 0x91) < (uint)pctDetect) {
                    pctDetect = (short)*(byte *)(*(int *)(iVar1 * 4 + rglpshdef) + i * 0x93 + 0x91);
                }
                iSteal = iSteal | (uint) * (byte *)(*(int *)(iVar1 * 4 + rglpshdef) + i * 0x93 + 0x92);
            }
        }
        if (pdPlanRange != 0) {
...

{
    ...
    for (i = 0; i < 0x10; i = i + 1) {
        if (0 < ((FLEET *)lpfl)->rgcsh[i]) {
            dRangeBest =
                GetShdefScannerRange((SHDEF *)CONCAT22(*(undefined2 *)(iplr * 4 + rglpshdef_0x2), (SHDEF *)(*(int *)(iplr * 4 + rglpshdef) + i * 0x93)), iplr,
                                     &dPlanRangeBest, &pctDetect, &iSteal);
...
short GetShdefScannerRange(SHDEF *lpshdef, short iplr, short *pdPlanRange, short *ppctDetect, short *piSteal)

{
    ...
    iSteal = 0;
    cDetectors = 0;
    if ((iplr == -1) || (sVar9 = GetRaceStat((PLAYER *)rgplr + iplr, rsMajorAdv), sVar9 != raNone)) {
        bVar11 = false;
    } else {
        bVar11 = true;
    }
    lBIR4 = DOUBLE_m1_0__1120_1cca;
    lBIPR4 = DOUBLE_m1_0__1120_1cca;
    if (ppctDetect != 0) {
        *ppctDetect = 100;
    }
    if (bVar11) {
        if ((lpshdef->hul).ihuldef == ihuldefScout) {
            ...
            bVar11 = HVar1 < ihuldefFrigate;
            if (HVar1 != ihuldefFrigate)
                goto LAB_1038_5272;
        }
        __aFfcompp();
        if (bVar11) {
            if ((game.wCrap >> 3 & 1) == 0) {
                dVar4 = (double)(long)(*(char *)((int)rgplr[0].rgTech + 4 + iplr * 0xc0) * 10);
                lBIPR4 = dVar4 * dVar4 * dVar4 * dVar4;
                dVar4 = dVar4 * 2.0 * dVar4 * 2.0;
                lBIR4 = dVar4 * dVar4;
            } else {
                lBIR4 = DOUBLE_2560000_0__1120_1cd2;
                lBIPR4 = DOUBLE_160000_0__1120_1cda;
            }
        }
        lRange4 = lBIR4;
        lPlanRange4 = lBIPR4;
    ...
    do {
        ...
        if ((int)uVar6 <= j) {
            ...
            if ((!bVar11 && !bVar12) || (bVar5)) {
                pdVar8 = _sqrt(lRange4);
                _sqrt(*pdVar8);
                lVar14 = __ftol((double)CONCAT26(uVar16, CONCAT24(uVar15, CONCAT22(unaff_SI, unaff_DI))));
                dRange = (short)lVar14;
                if ((iplr != -1) && (sVar9 = GetRaceGrbit((PLAYER *)rgplr + iplr, ibitRaceNoAdvScanner), sVar9 != 0)) {
                    dRange = dRange << 1;
                }
            } else {
                dRange = -1;
        ...
        uVar15 = (undefined2)((ulong)lphs >> 0x10);
        pHVar10 = (HS *)lphs;
        if (pHVar10->wFlags_0x2 >> 8 != 0) {
            if (lphs->grhst == hstScanner) {
                bVar5 = true;
                uVar2 = pHVar10->wFlags_0x2;
                uVar7 = uVar2 & 0xff;
                pSVar13 = LpscannerFromId(uVar2 & 0xff);
                dVar4 = (double)(long)((SCANNER *)pSVar13)->dRange;
                dVar4 = dVar4 * dVar4;
                lRange4 = lRange4 + (double)(pHVar10->wFlags_0x2 >> 8) * dVar4 * dVar4;
                pSVar13 = LpscannerFromId(uVar2 & 0xff);
                iVar3 = ((SCANNER *)pSVar13)->grfAbilities;
                if (uVar7 == 6) {
                    dRangeT = 0x2d;
                } else if (uVar7 == 5) {
                    dRangeT = 0;
                ...
                if ((lphs->grhst == hstArmor) && ((pHVar10->wFlags_0x2 & 0xff) == 9)) {
                    dRangeT = 0x50;
                    dRangeT2 = 0x28;
                } else if ((lphs->grhst == hstBeam) && ((pHVar10->wFlags_0x2 & 0xff) == 0x12)) {
                    dRangeT = 0x96;
                    dRangeT2 = 0x4b;
                } else {
                    if ((lphs->grhst != hstShield) || ((pHVar10->wFlags_0x2 & 0xff) != 6)) {
                        if (((ppctDetect != 0) && (lphs->grhst == hstSpecialE)) && ((pHVar10->wFlags_0x2 & 0xff) == 0xf)) {
                            cDetectors = cDetectors + (pHVar10->wFlags_0x2 >> 8);
                        }
                        goto LAB_1038_5298;
                    }
                    dRangeT = 0x32;
                ...
                dVar4 = (double)(long)dRangeT * (double)(long)dRangeT;
                lRange4 = lRange4 + (double)(pHVar10->wFlags_0x2 >> 8) * dVar4 * dVar4;
                dRangeT = dRangeT2;
            }
            dVar4 = (double)(long)dRangeT * (double)(long)dRangeT;
            lPlanRange4 = lPlanRange4 + (double)(pHVar10->wFlags_0x2 >> 8) * dVar4 * dVar4;
        }
    LAB_1038_5298:
        j = j + 1;
        lphs = (HS *)CONCAT22(uVar15, pHVar10 + 1);
    } while (true);
}
...

{
    ...
    if (iWarp < 0xb) {
        ...
        lpshdef = (SHDEF *)CONCAT22(*(undefined2 *)(iVar5 + rglpshdef_0x2), (SHDEF *)*(undefined2 *)(iVar5 + rglpshdef));
        for (; i < 0x10; i = i + 1) {
            ...
            if (pFVar4->rgcsh[i] != 0) {
                ...
                if (iWarp < 10) {
                    if (pEVar1->rgcFuelUsed[iWarp] == 0) {
                        pctShip10._0_2_ = (pSVar6->hul).rghs[0].wFlags_0x2 >> 8;
                        pctShip10._2_2_ = 0;
                    ...
                    uVar11 = __aFulmul(CONCAT22(pctShip10._2_2_, (uint)pctShip10), (long)pFVar4->rgcsh[i]);
...

{
    ...
    while ((PLANET *)lppl < pPVar8) {
        uVar13 = (undefined2)((ulong)lppl >> 0x10);
        if (((PLANET *)lppl)->iPlayer == iPlr) {
            score.cPlanet = score.cPlanet + 1;
            lVar15 = __aFldiv(CONCAT22(*(int *)((int)((PLANET *)lppl)->rgwtMin + 0xe) + (uint)(0xfc18 < *(uint *)(((PLANET *)lppl)->rgwtMin + 3)),
                                       *(uint *)(((PLANET *)lppl)->rgwtMin + 3) + 999),
                              1000);
            if (6 < lVar15) {
                lVar15 = 6;
            }
            ...
            if ((((PLANET *)lppl)->wFlags_0x4 >> 9 & 1) != 0) {
                pHVar16 = LphuldefFromId(*(HullDef *)(*(int *)(iPlr * 4 + rglpshdefSB) + (*(uint *)&((PLANET *)lppl)->lStarbase & 0xf) * 0x93));
    ...
    for (i = 0; score.lScore = lVar15, i < 0x10; i = i + 1) {
        if ((*(uint *)(*(int *)(iPlr * 4 + rglpshdef) + i * 0x93 + 0x7b) >> 9 & 1) == 0) {
            lVar15 = LComputePower((SHDEF *)CONCAT22(*(undefined2 *)(iPlr * 4 + rglpshdef_0x2), (SHDEF *)(*(int *)(iPlr * 4 + rglpshdef) + i * 0x93)));
            if (lVar15 < 1) {
                rgType[i] = 0;
                lVar15 = score.lScore;
            } else if (lVar15 < 2000) {
        ...
        if ((*(int *)(iVar9 + 2) == iPlr) && ((*(uint *)(iVar9 + 4) >> 10 & 1) == 0)) {
            for (i = 0; i < 0x10; i = i + 1) {
                if ((0 < *(int *)(iVar9 + 0xc + i * 2)) && (rgType[i] != -1)) {
                    uVar5 = *(uint *)(iVar9 + 0xc + i * 2);
                    iVar11 = rgType[i];
                    puVar1 = (uint *)(rgcsh + iVar11);
                    uVar6 = *puVar1;
                    *puVar1 = *puVar1 + uVar5;
                    piVar2 = (int *)((int)rgcsh + iVar11 * 4 + 2);
                    *piVar2 = *piVar2 + ((int)uVar5 >> 0xf) + (uint)CARRY2(uVar6, uVar5);
                }
            }
        }
    }
    iVar9 = score.cPlanet >> 0xf;
    if ((iVar9 < rgcsh[1]._2_2_) || ((iVar9 <= rgcsh[1]._2_2_ && ((uint)score.cPlanet <= (uint)rgcsh[1])))) {
        rgcsh[1]._0_2_ = score.cPlanet;
        rgcsh[1]._2_2_ = iVar9;
    }
    lVar15 = __aFlshl(CONCAT22(rgcsh[1]._2_2_, (uint)rgcsh[1]), 1);
    iVar9 = score.cPlanet >> 0xf;
    if ((iVar9 < rgcsh[0]._2_2_) || ((iVar9 <= rgcsh[0]._2_2_ && ((uint)score.cPlanet <= (uint)rgcsh[0])))) {
        rgcsh[0]._0_2_ = score.cPlanet;
        rgcsh[0]._2_2_ = iVar9;
    }
    lVar17 = __aFldiv(CONCAT22(rgcsh[0]._2_2_, (uint)rgcsh[0]), 2);
    score.lScore = lVar17 + lVar15 + score.lScore;
    if ((-1 < rgcsh[2]._2_2_) && ((0 < rgcsh[2]._2_2_ || ((uint)rgcsh[2] != 0)))) {
        iVar10 = score.cPlanet >> 0xf;
        iVar9 = score.cPlanet + (uint)rgcsh[2];
        iVar11 = iVar10 + rgcsh[2]._2_2_ + (uint)CARRY2(score.cPlanet, (uint)rgcsh[2]);
        sVar19 = score.cPlanet;
        uVar18 = __aFlshl(CONCAT22(rgcsh[2]._2_2_, (uint)rgcsh[2]), 3);
        uVar18 = __aFulmul(uVar18, CONCAT22(iVar10, sVar19));
        lVar15 = __aFldiv(uVar18, CONCAT22(iVar11, iVar9));
        score.lScore = lVar15 + score.lScore;
    }
    for (i = 0; i < 3; i = i + 1) {
        uVar7 = WPackLong(CONCAT22(*(undefined2 *)((int)rgcsh + i * 4 + 2), (int)rgcsh[i]));
        score.rgcsh[i] = uVar7;
    }
    if (pscore != 0) {
        pSVar12 = &score;
        for (iVar9 = 10; iVar9 != 0; iVar9 = iVar9 + -1) {
            ...
            *&pSVar4->lScore = (int)pSVar3->lScore;
        }
    }
    return score.lScore;
}
...

{
    ...
    uVar1 = *(undefined2 *)(iplr * 4 + rglpshdef_0x2);
    iVar4 = *(int *)(iplr * 4 + rglpshdef) + ish * 0x93;
    if ((*(uint *)(iVar4 + 0x7b) >> 9 & 1) == 0) {
        __fstrcpy(psz, (char *)CONCAT22(uVar1, (char *)(iVar4 + 8)));
        if (iplr != idPlayer) {
            c = 0;
            iVal = 1;
            for (i = 0; i < 0x10; i = i + 1) {
                if ((((i != ish) && ((*(uint *)(*(int *)(iplr * 4 + rglpshdef) + i * 0x93 + 0x7b) >> 9 & 1) == 0)) &&
                     (sVar2 =
                          __fstrcmp(psz, (char *)CONCAT22(*(undefined2 *)(iplr * 4 + rglpshdef_0x2), (char *)(*(int *)(iplr * 4 + rglpshdef) + i * 0x93 + 8))),
                      sVar2 == 0)) &&
                    (c = c + 1, i < ish)) {
                    iVal = iVal + 1;
                }
            ...
            if (c != 0) {
                ...
                _strcat(psz, (char *)s___1120_0539);
            }
        }
    } else {
        *psz = '\0';
...

{
    ...
    for (iClr = 0; iClr < 5; iClr = iClr + 1) {
        lVar3 = __aFldiv(uVar2, CONCAT22(*(undefined2 *)((int)(long *)rgDSDivCnt + iClr * 4 + 2), (int)((long *)rgDSDivCnt)[iClr]));
        for (i = 0; i < (int)lVar3; i = i + 1) {
            ...
            SetBkColor(hdc, CONCAT22(*(undefined2 *)((int)(ulong *)rgcrDrawStars + iClr * 4 + 2), (int)((ulong *)rgcrDrawStars)[iClr]));
            ExtTextOut(hdc, 0, 0, 2, &rcOut, 0, 0, 0);
        }
    }
    for (iClr = 0; iClr < 4; iClr = iClr + 1) {
        lVar3 = __aFldiv(uVar2, CONCAT22(*(undefined2 *)((int)(long *)rgDSDivCnt2 + iClr * 4 + 2), (int)((long *)rgDSDivCnt2)[iClr]));
        for (i = 0; i < (int)lVar3 + 1; i = i + 1) {
            ...
            SetBkColor(hdc, CONCAT22(*(undefined2 *)((int)(ulong *)rgcrDrawStars2b + iClr * 4 + 2), (int)((ulong *)rgcrDrawStars2b)[iClr]));
            ExtTextOut(hdc, 0, 0, 2, &rcOut, 0, 0, 0);
            SetBkColor(hdc, CONCAT22(*(undefined2 *)((int)(ulong *)rgcrDrawStars2a + iClr * 4 + 2), (int)((ulong *)rgcrDrawStars2a)[iClr]));
...

{
    ...
    uVar3 = LongFromSerialCh(*psz);
    if ((long)uVar3 < 0x20) {
        uVar3 = uVar3 ^ 0x15;
    }
    lVar4 = LongFromSerialCh(psz[1]);
    uVar3 = __aFulmul(uVar3, 0x24);
    lVar5 = LongFromSerialCh(psz[4]);
    uVar3 = __aFulmul(uVar3 + lVar4, 0x24);
    lVar4 = LongFromSerialCh(psz[7]);
    uVar3 = __aFulmul(uVar3 + lVar5, 0x24);
    lVar5 = LongFromSerialCh(psz[3]);
    uVar3 = __aFulmul(uVar3 + lVar4, 0x24);
    uVar3 = uVar3 + lVar5;
    if (plSerial != 0) {
        *(int *)plSerial = (int)uVar3;
        *(undefined2 *)((int)plSerial + 2) = (int)(uVar3 >> 0x10);
    }
    PushRandom(0x11000b, lVar6);
    Randomize2(uVar3);
    lVar4 = __aFlshr(uVar3, 0xe);
    lVar6 = 0;
    for (i = 0; lCur._0_2_ = (uint)lVar4, i < 3; i = i + 1) {
        l._0_2_ = (uint)lCur & 0xf;
        for (l._2_2_ = 0; (0 < l._2_2_ || (-1 < l._2_2_)); l._2_2_ = l._2_2_ - (uint)bVar2) {
            Random(0x100);
            bVar2 = (uint)l == 0;
            l._0_2_ = (uint)l - 1;
        }
        sVar1 = Random(0x100);
        lVar6 = __aFlshl(lVar6, 8);
        lVar6 = lVar6 + sVar1;
        lVar4 = __aFlshr(lVar4, 4);
    }
    PopRandom();
    lVar4 = LongFromSerialCh(psz[2]);
    lVar5 = __aFlrem(lVar6, 0x24);
    if (lVar5 == lVar4) {
        lVar6 = __aFldiv(lVar6, 0x24);
        lVar4 = LongFromSerialCh(psz[5]);
        lVar5 = __aFlrem(lVar6, 0x24);
        if (lVar5 == lVar4) {
            lVar6 = __aFldiv(lVar6, 0x24);
            lVar4 = LongFromSerialCh(psz[6]);
            lVar6 = __aFlrem(lVar6, 0x24);
            if (lVar6 == lVar4) {
                sVar1 = 1;
            } else {
                sVar1 = 0;
    ...
    if (mdTarget != 3) {
        if (mdTarget == 4) {
            for (ish = 0; ish < 0x10; ish = ish + 1) {
                if (((FLEET *)lpflTarget)->rgcsh[ish] != 0) {
                    ...
                    pHVar3 = LphuldefFromId(*(HullDef *)(*(int *)(iVar2 + rglpshdef) + ish * 0x93));
        ...
        if (mdTarget != 5) {
            if (mdTarget == 6) {
                ish = 0;
                while (
                    (ish < 0x10 && ((((FLEET *)lpflTarget)->rgcsh[ish] == 0 || (iVar2 = ((FLEET *)lpflTarget)->iPlayer * 4,
                                                                                pHVar3 = LphuldefFromId(*(HullDef *)(*(int *)(iVar2 + rglpshdef) + ish * 0x93)),
            ...
            ish = 0;
            while ((ish < 0x10 && ((((FLEET *)lpflTarget)->rgcsh[ish] == 0 || (iVar2 = ((FLEET *)lpflTarget)->iPlayer * 4,
                                                                               pHVar3 = LphuldefFromId(*(HullDef *)(*(int *)(iVar2 + rglpshdef) + ish * 0x93)),
...

{
    ...
    do {
        ...
        if (((((*(uint *)&((PLORD *)pFVar2->lpplord)[2].iordMax >> 8 & 0xf) != 1) && ((*(uint *)&((PLORD *)pFVar2->lpplord)[2].iordMax & 0xf) != 1)) &&
             ((*(uint *)&((PLORD *)pFVar2->lpplord)[2].iordMax & 0xf) != 4)) &&
            (-1 < (int)pFVar2->wFlags_0x4)) {
            if (pFVar2->idPlanet == -1) {
                *(uint *)&((PLORD *)pFVar2->lpplord)[2].iordMax = *(uint *)&((PLORD *)pFVar2->lpplord)[2].iordMax & 0xf0ff | 0x400;
                ((PLORD *)pFVar2->lpplord + 2)->wFlags = 0;
            } else {
                *(uint *)&((PLORD *)pFVar2->lpplord)[2].iordMax = *(uint *)&((PLORD *)pFVar2->lpplord)[2].iordMax & 0xf0ff | 0x100;
        ...
        if ((pFVar2->wFlags_0x4 >> 10 & 1) == 0) {
            ...
            if ((1 < pFVar2->cord) || ((int)pFVar2->wFlags_0x4 < 0)) {
                ...
                lpord = (ORDER *)CONCAT22(*(undefined2 *)((int)&pFVar2->lpplord + 2), (ORDER *)(*(int *)&pFVar2->lpplord + 4 + iord * 0x12));
                for (; iord < pFVar2->cord; iord = iord + 1) {
                    ...
                    if ((pOVar10->wFlags_0x6 >> 8 & 0xf) == 8) {
                        ...
                        if (((pTVar5 == 0) && (iVar9 == 0)) ||
                            (((pTVar12->idFull >> 0xd == 2 && ((1 << ((byte)pFVar2->iPlayer & 0x1f) & *(uint *)((int)&pTVar5->u_THING_0x0006 + 2)) == 0)) &&
                              (((&pTVar5->pt)->x != (lpord->pt).x || ((pTVar5->pt).y != (pOVar10->pt).y)))))) {
                            if ((pTVar5 != 0) || (iVar9 != 0)) {
                                FSendPlrMsg(pFVar2->iPlayer, idmWormholeHeadingHasVanishedOrdersHaveChanged, lpfl->id | 0x8000, lpfl->id, 0, 0, 0, 0, 0, 0);
                            }
                    ...
                    } else if (((pOVar10->wFlags_0x6 >> 8 & 0xf) == 2) && ((pOVar10->wFlags_0x6 >> 0xd & 1) == 0)) {
                        ...
                        if (((pFVar4 == 0) && (iVar9 == 0)) ||
                            ((((&pFVar4->pt)->x != (lpord->pt).x || ((pFVar4->pt).y != (pOVar10->pt).y)) ||
                              (((*(uint *)((int)&pFVar4->dirLong + 2) >> 5 & 1) != 0 && (pFVar4->iPlayer != pFVar2->iPlayer)))))) {
                            lpflTarget = 0;
                            uVar7 = pOVar10->id & 0xfe00;
                            cFound = 0;
                            mdTarget_00 = *(uint *)(*(int *)((BTLPLAN **)rglpbtlplan + pFVar2->iPlayer) + (uint)pFVar2->iplan * 0x24 + 2) & 0xf;
                            lVar6 = 0;
                            lpflMatch._0_2_ = 0;
                            lpflMatch._2_2_ = 0;
                            for (ifl2 = 0; ifl2 < cFleet; ifl2 = ifl2 + 1) {
                                ...
                                if ((((&pFVar4->pt)->x == (lpord->pt).x) &&
                                     ((((pFVar4->pt).y == (pOVar10->pt).y && (uVar7 == (lpfl2->id & 0xfe00U))) &&
                                       (sVar8 = FMatchTarget((FLEET *)CONCAT22(iVar9, pFVar4), mdTarget_00, 1), sVar8 != 0)))) &&
                                    ((lVar14 = WtFromLpfl((FLEET *)CONCAT22(iVar9, pFVar4)),
                                      (*(uint *)((int)&pFVar4->dirLong + 2) >> 6 & 1) == 0 &&
                                          ((lVar6 < lVar14 || ((lVar6 == lVar14 && (sVar8 = Random(2), sVar8 == 0)))))))) {
                                    lpflMatch._0_2_ = pFVar4;
                                    lpflMatch._2_2_ = iVar9;
                                    lVar6 = lVar14;
                                }
                            }
                            if (((FLEET *)lpflMatch == 0) && (lpflMatch._2_2_ == 0)) {
                                for (ifl2 = 0; ifl2 < cFleet; ifl2 = ifl2 + 1) {
                                    /* WARNING: Load size is inaccurate */
                                    pFVar4 = ((FLEET **)rglpfl)[ifl2];
                                    iVar9 = *(int *)((int)((FLEET **)rglpfl + ifl2) + 2);
                                    ...
                                    if ((pFVar4 == 0) && (iVar9 == 0))
                                        break;
                                    if (((&pFVar4->pt)->x == (lpord->pt).x) && (((pFVar4->pt).y == (pOVar10->pt).y && (uVar7 == (lpfl2->id & 0xfe00U))))) {
                                        sVar8 = FMatchTarget((FLEET *)CONCAT22(iVar9, pFVar4), mdTarget_00, 1);
                                        if ((sVar8 != 0) && ((lVar14 = WtFromLpfl((FLEET *)CONCAT22(iVar9, pFVar4)),
                                                              lVar6 < lVar14 || ((lVar6 == lVar14 && (sVar8 = Random(2), sVar8 == 0)))))) {
                                            lpflMatch._0_2_ = pFVar4;
                                            lpflMatch._2_2_ = iVar9;
                                            lVar6 = lVar14;
                                        ...
                                        sVar8 = Random(cFound);
                                        if ((sVar8 == 0) &&
                                            (((cFound == 1 || ((*(uint *)((int)&pFVar4->dirLong + 2) >> 6 & 1) == 0)) || (sVar8 = Random(2), sVar8 != 0)))) {
                            ...
                            if (((FLEET *)lpflTarget != 0) || (lpflTarget._2_2_ != 0)) {
                                pOVar10->id = lpflTarget->id;
                                sVar8 = (((FLEET *)lpflTarget)->pt).y;
                                (lpord->pt).x = (&((FLEET *)lpflTarget)->pt)->x;
                                (pOVar10->pt).y = sVar8;
                                *(uint *)((int)&((FLEET *)lpflTarget)->dirLong + 2) = *(uint *)((int)&((FLEET *)lpflTarget)->dirLong + 2) & 0xffbf | 0x40;
                            }
                        } else if ((pFVar4 != 0) || (iVar9 != 0)) {
                            *(uint *)((int)&pFVar4->dirLong + 2) = *(uint *)((int)&pFVar4->dirLong + 2) & 0xffbf | 0x40;
                        }
                    }
...

{
    ...
    pPVar10 = (PLANET *)lppl;
    if ((pPVar10->iPlayer == -1) || (((int)pPVar10->rgwtMin[3] == 0 && (*(int *)((int)pPVar10->rgwtMin + 0xe) == 0)))) {
        lPopInc._0_2_ = 0;
        lPopInc._2_2_ = 0;
    } else {
        ...
        if (sVar6 < 0) {
            ...
            DeltaCur = (*(uint *)pPVar10->rgbImp & 0xff) - (int)lPopIncDelta;
            if (DeltaCur < 0) {
                lVar12 = lVar12 + 1;
            ...
            iVar8 = sVar7 * sVar6;
            uVar15 = (ulong)iVar8;
            if ((((uint)gd.grBits >> 1 & 1) != 0) && (uVar15 = (long)iVar8, (*(uint *)((int)&rgplr[0].wFlags + pPVar10->iPlayer * 0xc0) >> 2 & 1) != 0)) {
                uVar15 = __aFlshr((long)iVar8, 1);
            }
            ...
            if (lVar13 < lVar16) {
                ...
                if (lVar16 < lVar12) {
                    ...
                    if ((long)uVar15 < 1000) {
                        ...
                        uVar15 = __aFulmul(uVar15, uVar14);
                        uVar15 = __aFldiv(uVar15, CONCAT22(uVar20, uVar18));
                        uVar15 = __aFulmul(uVar15, CONCAT22(uVar19, uVar17));
                    }
                } else {
                    if (lVar16 < lVar12 + 10) {
                        lPopInc._0_2_ = 0;
                    ...
                    if ((iVar8 < 0) && ((iVar8 < -1 || (99 - (uint)lVar16 < 0xfed4)))) {
                        iVar8 = -300;
                        iVar9 = -1;
                    } else {
                        lVar16 = __aFldiv(lVar13, 10);
                        iVar8 = 99 - (uint)lVar16;
                        iVar9 = -(uint)(99 < (uint)lVar16) - (int)((ulong)lVar16 >> 0x10);
                    }
                    uVar15 = __aFlshl(CONCAT22(iVar9, iVar8), 2);
                }
            }
            ...
            if ((long)uVar14 < 10000000) {
                ...
                uVar14 = __aFldiv(uVar15, CONCAT22(uVar20, uVar18));
            }
        ...
        lPopInc._2_2_ = (int)((ulong)lVar16 >> 0x10);
        if (fUpdate != 0) {
            lVar16 = __aFlshl((ulong)(DeltaCur & 0xff), 0);
            uVar5 = *(uint *)(pPVar10->rgbImp + 2);
            *(uint *)pPVar10->rgbImp = *(uint *)pPVar10->rgbImp & 0xff00 | (uint)lVar16;
            *(uint *)(pPVar10->rgbImp + 2) = uVar5 | (uint)((ulong)lVar16 >> 0x10);
...

{
    ...
    if (((pPVar1 == 0) && (iVar7 == 0)) || (pFVar6->iPlayer != pPVar1->iPlayer)) {
        if (((pPVar1 != 0) || (iVar7 != 0)) && ((pPVar1->iPlayer == -1 && (pPVar1->turn == game.turn)))) {
            return 0;
        }
        bVar2 = true;
    } else {
    ...
    if (sVar4 != 0) {
        ...
        if ((((PLANET *)lpplSrc != 0) || (iVar7 != 0)) &&
            ((pFVar6->iPlayer == ((PLANET *)lpplSrc)->iPlayer && (isbsSrc = IStargateFromLppl(lpplSrc), -1 < isbsSrc)))) {
            if (bVar2) {
                return -1;
            }
            goto LAB_1038_77e5;
    ...
    if (sVar4 == 0) {
        if (bVar3) {
            if (((((PLANET *)lpplSrc == 0) && (lpplSrc._2_2_ == 0)) || (((PLANET *)lpplSrc)->iPlayer != -1)) || (((PLANET *)lpplSrc)->turn != game.turn)) {
                if ((((PLANET *)lpplSrc != 0) || (lpplSrc._2_2_ != 0)) && (((PLANET *)lpplSrc)->iPlayer == pFVar6->iPlayer)) {
                    return 0;
                }
                return -1;
            }
...
LAB_1038_77e5:
    ...
    do {
        ...
        if (pFVar6->rgcsh[ishdef] != 0) {
            ...
            sVar4 = MdCalcStargateDamage(isbsSrc, isbsDst, dTravel, *(short *)(*(int *)(iVar7 + rglpshdef) + ishdef * 0x93 + 0x28), &pctDmg);
...

{
    ...
    do {
        ...
        if (0 < ((FLEET *)lpfl)->rgcsh[i]) {
            ...
            lphs = (HS *)CONCAT22(*(undefined2 *)(iVar2 + rglpshdef_0x2), (HS *)(*(int *)(iVar2 + rglpshdef) + i * 0x93 + 0x3a));
            iVar2 = ((FLEET *)lpfl)->iPlayer * 4;
            uVar1 = (uint) * (byte *)(*(int *)(iVar2 + rglpshdef) + i * 0x93 + 0x7a);
            for (j = 0; j < (int)uVar1; j = j + 1) {
                uVar4 = (undefined2)((ulong)lphs >> 0x10);
                pHVar3 = (HS *)lphs;
                if (((pHVar3->wFlags_0x2 >> 8 != 0) && (lphs->grhst == hstSpecialM)) && ((pHVar3->wFlags_0x2 & 0xff) == 9))
                    break;
...

{
    ...
    while (true) {
        ...
        if (0 < ((FLEET *)lpfl)->rgcsh[i]) {
            iVar2 = ((FLEET *)lpfl)->iPlayer * 4;
            uVar3 = __aFulmul((long)((FLEET *)lpfl)->rgcsh[i], (ulong) * (uint *)(*(int *)(iVar2 + rglpshdef) + i * 0x93 + 0x28));
            lVar1 = uVar3 + lVar1;
        }
        i = i + 1;
    }
    for (i = 0; i < 4; i = i + 1) {
        lVar1 = lVar1 + CONCAT22(*(undefined2 *)((int)(((FLEET *)lpfl)->rgwtMin + i) + 2), (int)((FLEET *)lpfl)->rgwtMin[i]);
    }
    return lVar1;
}
...

{
    ...
    if (sVar2 == 1) {
        ...
        while (true) {
            ...
            if ((int)(uint)(pSVar3->hul).chs <= j)
                break;
            if ((pSVar3->hul).rghs[j].wFlags_0x2 >> 8 != 0) {
...

{
    ...
    lpshdefDest = (SHDEF *)CONCAT22(*(undefined2 *)(iPlrDst * 4 + rglpshdef_0x2), (SHDEF *)*(undefined2 *)(iPlrDst * 4 + rglpshdef));
    i = 0;
    do {
        if (0xf < i) {
            return -1;
        ...
        if ((((pSVar1->wFlags >> 9 & 1) == 0) && ((int)pSVar1->wFlags < 0)) && ((lpshdefDest->hul).ihuldef == lphul->ihuldef)) {
            uVar4 = (undefined2)((ulong)lphul >> 0x10);
            pHVar2 = (HUL *)lphul;
            if ((pSVar1->hul).chs == pHVar2->chs) {
                j = 0;
                while (((j < (int)(uint)pHVar2->chs && (pHVar2->rghs[j].wFlags_0x2 >> 8 == (pSVar1->hul).rghs[j].wFlags_0x2 >> 8)) &&
                        ((pHVar2->rghs[j].wFlags_0x2 >> 8 == 0 || (((pHVar2->rghs[j].wFlags_0x2 & 0xff) == ((pSVar1->hul).rghs[j].wFlags_0x2 & 0xff) &&
...

{
    ...
    _strcat(szFile, (char *)*(undefined2 *)(dt * 2 + mpdtsz));
    _remove(szFile);
    return;
}
...

{
    ...
    _wsprintf(szFile, "%s.%s", (char *)szBase, 0x1120, *(undefined2 *)(dt * 2 + mpdtsz), 0x1120);
...

{
    ...
    if ((int)ini.wFlags < 0) {
        ...
        pcVar2 = PszFormatIds(ids, 0);
        _wsprintf(szTemp, pcVar2, iVar1);
        OutputSz(6, szTemp);
    }
    return;
}
