...

{
    ...
    vlpbdVCR = (BTLDATA *)CONCAT22(rglphb[0xb]._2_2_, &((HB *)rglphb[0xb])[1].cbBlock);
    while (true) {
        while (true) {
            if (vlpbdVCR->id == iBattle) {
                vlpbdVCRNext._0_2_ = (BTLDATA *)((int)&((BTLDATA *)vlpbdVCR)->id + ((BTLDATA *)vlpbdVCR)->cbData);
                vlpbdVCRNext._2_2_ = vlpbdVCR._2_2_;
                penvMem = &env;
                gd.grBits._0_2_ = (uint)gd.grBits & 0xdfff;
                sVar4 = __setjmp(env);
                if (sVar4 == 0) {
                    vrgtok = LpAlloc((uint)((BTLDATA *)vlpbdVCR)->ctok * 0x1d, htMisc);
                    ...
                    DialogBox(0, IDD_VCR, hwndFrame, lpDlgProc);
                } else {
                    sVar4 = 0x10;
                    penvMem = pasVar3;
            ...
            if (vlpbdVCR->id == 0xffff)
                break;
            vlpbdVCR = (BTLDATA *)CONCAT22(vlpbdVCR._2_2_, (BTLDATA *)((int)&((BTLDATA *)vlpbdVCR)->id + ((BTLDATA *)vlpbdVCR)->cbData));
        }
    ...
    do {
        ...
        if ((uVar3 != 0) && (((grbitBU & 4) != 0 || (*(byte *)((int)pBVar4 + iVar2 + 0x12) < 0x10)))) {
            if (((grbitBU & 0xf8) != 0xf8) && (*(byte *)((int)pBVar4 + iVar2 + 0x12) < 0x10)) {
                ...
                pHVar8 = LphuldefFromId(*(HullDef *)(*(int *)(iVar5 + rglpshdef) + (uint) * (byte *)((int)pBVar4 + iVar2 + 0x12) * 0x93));
...

{
    ...
    lpbr = (BTLREC *)CONCAT22(lpbd._2_2_, (BTLREC *)((int)(BTLDATA *)lpbd + (uint)((BTLDATA *)lpbd)->ctok * 0x1d + 0xe));
    cKilled._0_2_ = 0;
    cKilled._2_2_ = 0;
    while ((BTLREC *)lpbr < (BTLREC *)((int)&((BTLDATA *)lpbd)->id + ((BTLDATA *)lpbd)->cbData)) {
        ...
        for (i = 0; i < ((BTLREC *)lpbr)->ctok; i = i + 1) {
            if (*(int *)((int)(BTLREC *)lpbr + i * 8 + 8) != 0) {
                if ((uint) * (byte *)((int)(BTLDATA *)lpbd + (uint) * (byte *)((int)(BTLREC *)lpbr + i * 8 + 6) * 0x1d + 0x10) == idPlayer) {
                    if (fOurDead != 0) {
        ...
        lpbr = (BTLREC *)CONCAT22(uVar2, (BTLREC *)((int)(BTLREC *)lpbr + ((BTLREC *)lpbr)->ctok * 8 + 6));
    }
...

{
    ...
    pSVar2 = LpshdefFromTok((TOK *)CONCAT22(vrgtok._2_2_, (TOK *)vrgtok + itok));
        ...
        if ((iStep < viStepVCRCur) || (viStepVCRCur == -1)) {
            ...
            while (true) {
                ...
                *&pTVar6->id = (char)*puVar7;
                lVar11 = LdpFromItokDv(i, (DV *)CONCAT22(vrgtok._2_2_, &((TOK *)vrgtok)[i].dv));
            ...
            vlpbrVCR = (BTLREC *)CONCAT22(uVar9, (BTLREC *)((int)pBVar4 + (uint)pBVar4->ctok * 0x1d + 0xe));
        }
        while ((viStepVCRCur < iStep && ((BTLREC *)vlpbrVCR < (BTLDATA *)vlpbdVCRNext))) {
            if (-1 < viStepVCRCur) {
                i = 0;
                while (true) {
                    ...
                    ((TOK *)vrgtok)[itok_00].csh = ((TOK *)vrgtok)[itok_00].csh - *(int *)((int)pBVar5 + i * 8 + 8);
                    (&pTVar6[itok_00].dv)->dp = *(ushort *)((int)(BTLREC *)vlpbrVCR + i * 8 + 0xc);
                    lVar11 = LdpFromItokDv(itok_00, (DV *)CONCAT22(vlpbrVCR._2_2_, (DV *)((int)(BTLREC *)vlpbrVCR + i * 8 + 0xc)));
...

{
    ...
    if (message == WM_SETCURSOR) {
        ...
        if ((((8 < (int)local_1c._6_2_) && ((int)local_1c._6_2_ < (dxyVCRSquare + 3) * 10 + 8)) && (7 < local_14)) &&
            (local_14 < (dxyVCRSquare + 3) * 10 + 8)) {
            SetCursor(hcurHand);
            return 1;
        }
        return 0;
    ...
    if (message == WM_INITDIALOG) {
        ...
        SetWindowPos(hwnd, 0, 0, 0, dxyVCRBoard + 0xfa, local_14 + 0x18 + dxyVCRBoard + (rc.bottom - rc.top), 6);
        for (i = 0; i < 7; i = i + 1) {
            if (i < 5) {
                ibtn = i + 0xa1;
            } else if (i == 5) {
            ...
            OffsetRect((RECT *)CONCAT13(uVar15, CONCAT12(uVar14, &rc)), (short)local_1e, (dxyVCRBoard + 0x10) - rc.top);
            HVar4 = GetDlgItem(hwnd, ibtn);
    ...
    if (message == WM_COMMAND) {
        ...
        if (i == 2) {
            ...
            *(undefined2 *)(puVar11 + -0xe) = 0x1759;
            UVar9 = SetTimer(*(HWND *)(puVar11 + -4), *(UINT *)(puVar11 + -6), *(UINT *)(puVar11 + -8), *(undefined2 *)(puVar11 + -10));
        ...
        if (message != WM_TIMER) {
            ...
            if ((BVar5 != 0) || (PVar2.y = local_1c._6_2_, PVar2.x = local_1c._4_2_, BVar5 = PtInRect(rgrcBuildSpin + 1, PVar2), BVar5 != 0)) {
                ...
                while (true) {
                    ...
                    if (((local_20 == -1) && (0 < local_22)) || ((local_20 == 1 && (local_22 < 4)))) {
                        ...
                        TextOut(HVar7, ptSpeedVCR.x, ptSpeedVCR.y, szWork, local_1c._0_2_);
                    }
                }
                viSpeedVCR = local_22;
            ...
            if ((((9 < (int)local_1c._4_2_) && (1 < (int)local_1c._6_2_)) && ((int)local_1c._6_2_ < 10)) && (-1 < viVCRFocus)) {
                GlobalPD.grPopup = 0xb;
                if (*&((TOK *)vrgtok)[viVCRFocus].u_TOK_0x0003 == '\x01') {
                    local_1c._2_2_ = (*(byte *)((int)&((TOK *)vrgtok)[viVCRFocus].u_TOK_0x0003 + 1) - 0x10) * 0x93;
                    iVar10 = (uint)((TOK *)vrgtok)[viVCRFocus].iplr * 4;
                    GlobalPD.u_POPUPDATA_0x0002.part.hs.wFlags_0x2 = *(ushort *)(iVar10 + rglpshdefSB_0x2);
                    GlobalPD.u_POPUPDATA_0x0002.lpfl._0_2_ = (FLEET *)(*(int *)(iVar10 + rglpshdefSB) + local_1c._2_2_);
                } else {
                    local_1c._2_2_ = (uint) * (byte *)((int)&((TOK *)vrgtok)[viVCRFocus].u_TOK_0x0003 + 1) * 0x93;
                    iVar10 = (uint)((TOK *)vrgtok)[viVCRFocus].iplr * 4;
                    GlobalPD.u_POPUPDATA_0x0002.part.hs.wFlags_0x2 = *(ushort *)(iVar10 + rglpshdef_0x2);
                    GlobalPD.u_POPUPDATA_0x0002.lpfl._0_2_ = (FLEET *)(*(int *)(iVar10 + rglpshdef) + local_1c._2_2_);
                }
...

{
    ...
    if (dv.dp == 0xffff) {
        ...
        pSVar8 = LpshdefFromTok((TOK *)CONCAT22(vrgtok._2_2_, (TOK *)vrgtok + itok));
    ...
    if (cshT < 1) {
        cshT = 0;
        lVar11 = 0;
        uVar12 = __aFulmul((ulong)((TOK *)vrgtok)[itok].dpShield, (ulong)((TOK *)vrgtok)[itok].csh);
    }
...

{
    ...
    if (iStart == -2) {
        PatBlt(hdc, dxyVCRBoard + 10, 0, (rc.right - dxyVCRBoard) + -10, dxyVCRBoard + 8, 0xf00021);
        iStart = -1;
    }
    ...
    if (iStart == -1) {
        ...
        if (-1 < viStepVCRCur) {
            ...
            if (*&((TOK *)vrgtok)[vlpbrVCR->itok].u_TOK_0x0003 == '\x01') {
                local_1a0 = (*(byte *)((int)&((TOK *)vrgtok)[vlpbrVCR->itok].u_TOK_0x0003 + 1) - 0x10) * 0x93;
                ...
                local_1a0 = (uint) * (byte *)((int)&((TOK *)vrgtok)[vlpbrVCR->itok].u_TOK_0x0003 + 1) * 0x93;
                iVar2 = (uint)((TOK *)vrgtok)[vlpbrVCR->itok].iplr * 4;
            ...
            if ((int)uVar8 < 2) {
                __fstrcpy(szWork, (char *)CONCAT22(lpshdef._2_2_, (((SHDEF *)lpshdef)->hul).szClass));
            ...
            if (0 < ((BTLREC *)vlpbrVCR)->ctok) {
                ...
                if (*&((TOK *)vrgtok)[pBVar11->wFlags_0x4 >> 8].u_TOK_0x0003 == '\x01') {
                    local_1a2.dp = (*(byte *)((int)&((TOK *)vrgtok)[pBVar11->wFlags_0x4 >> 8].u_TOK_0x0003 + 1) - 0x10) * 0x93;
                    ...
                    local_1a2.dp = (uint) * (byte *)((int)&((TOK *)vrgtok)[pBVar11->wFlags_0x4 >> 8].u_TOK_0x0003 + 1) * 0x93;
                    local_1a0 = pBVar11->wFlags_0x4;
                    iVar2 = (uint)((TOK *)vrgtok)[local_1a0 >> 8].iplr * 4;
                    lpshdef._2_2_ = *(undefined2 *)(iVar2 + rglpshdef_0x2);
                ...
                for (i = ((BTLREC *)vlpbrVCR)->ctok; 0 < i; i = i + -1) {
                    ...
                    if (rgfSeen[itokT] == 0) {
                        ...
                        dpArmor._2_2_ =
                            dpArmor._2_2_ + ((*(uint *)((int)((long *)vrgdpVCR + itokT) + 2) - dpT._2_2_) - (uint)(uVar10 < (uint)dpT)) + (uint)bVar13;
                ...
                if (((((fJam & 0x40U) != 0) && ((uint)dpShields == 0)) && (dpShields._2_2_ == 0)) && (((uint)dpArmor == 0 && (dpArmor._2_2_ == 0)))) {
        ...
        if (vbrcVCRFocus != 0xff) {
            ...
            if (-1 < viVCRFocus) {
                ...
                if (*&((TOK *)vrgtok)[viVCRFocus].u_TOK_0x0003 == '\x01') {
                    ...
                    lpshdef._2_2_ = *(undefined2 *)(iVar2 + rglpshdefSB_0x2);
                    lpshdef._0_2_ = (SHDEF *)(*(int *)(iVar2 + rglpshdefSB) + (*(byte *)((int)&((TOK *)vrgtok)[viVCRFocus].u_TOK_0x0003 + 1) - 0x10) * 0x93);
                } else {
                    iVar2 = (uint)((TOK *)vrgtok)[viVCRFocus].iplr * 4;
                    lpshdef._2_2_ = *(undefined2 *)(iVar2 + rglpshdef_0x2);
                    lpshdef._0_2_ = (SHDEF *)(*(int *)(iVar2 + rglpshdef) + (uint) * (byte *)((int)&((TOK *)vrgtok)[viVCRFocus].u_TOK_0x0003 + 1) * 0x93);
                }
                ...
                if ((int)uVar10 < 1) {
                    ...
                    SetTextColor(hdc, CONCAT22(crButtonText._2_2_, (undefined2)crButtonText));
                    iVar12 = iVar12 + dyArial8;
                    uVar16 = __aFulmul((ulong)((TOK *)vrgtok)[viVCRFocus].dpShield, (long)(int)uVar10);
                    ...
                    if (i != 0x19e) {
                        ...
                        pcVar5 = PszGetCompressedString((((TOK *)vrgtok)[viVCRFocus].wFlags_0x17 & 0xf) + idsNoneDisengage);
                        sVar6 = _wsprintf(szWork, szT, pcVar5, 0x1120);
                        TextOut(hdc, x, y, szWork, sVar6);
                        iVar12 = y + dyArial8;
                        CchGetString(idsSecondaryTargetS, szT);
                        pcVar5 = PszGetCompressedString((((TOK *)vrgtok)[viVCRFocus].wFlags_0x17 >> 4 & 0xf) + idsNoneDisengage);
                        sVar6 = _wsprintf(szWork, szT, pcVar5, 0x1120);
                        TextOut(hdc, x, iVar12, szWork, sVar6);
                        y = iVar12 + dyArial8;
                    }
    ...
    for (i = iStart; i <= iEnd; i = i + 1) {
        x = i % 10;
        uVar10 = i / 10;
        PatBlt(hdc, (dxyVCRSquare + 3) * x + 10, (dxyVCRSquare + 3) * uVar10 + 10, dxyVCRSquare + 2, 1, 0x42);
            ...
            if ((local_1a0 == ((uVar10 & 0xf) << 4 | x & 0xfU)) && (((TOK *)vrgtok)[j].csh != 0)) {
                ...
                if ((ibmp == -1) || (j == viVCRFocus)) {
                    if (*&((TOK *)vrgtok)[j].u_TOK_0x0003 == '\x01') {
                        local_1a0 = (*(byte *)((int)&((TOK *)vrgtok)[j].u_TOK_0x0003 + 1) - 0x10) * 0x93;
                    ...
                    ibmpRace = *(uint *)((int)&rgplr[0].wMdPlr + (uint)((TOK *)vrgtok)[j].iplr * 0xc0) >> 3 & 0x1f;
                }
            }
        }
        ...
        if (ctok < 1) {
            PatBlt(hdc, (dxyVCRSquare + 3) * x + 10, (dxyVCRSquare + 3) * uVar10 + 10, dxyVCRSquare + 2, dxyVCRSquare + 2, 0x42);
        } else {
            PatBlt(hdc, (dxyVCRSquare + 3) * x + 10, (dxyVCRSquare + 3) * uVar10 + 10, dxyVCRSquare + 2, 1, 0x42);
            PatBlt(hdc, (dxyVCRSquare + 3) * x + 10, (dxyVCRSquare + 3) * uVar10 + 10, 1, dxyVCRSquare + 2, 0x42);
            PatBlt(hdc, (dxyVCRSquare + 3) * x + dxyVCRSquare + 0xb, (dxyVCRSquare + 3) * uVar10 + 10, 1, dxyVCRSquare + 2, 0x42);
        ...
        if (((local_1a0 == ((uVar10 & 0xf) << 4 | x & 0xfU)) && (viVCRFocus == -1)) ||
            ((-1 < viVCRFocus && ((local_1a0 = (uint)((TOK *)vrgtok)[viVCRFocus].brc,
                                   local_1a0 == ((uVar10 & 0xf) << 4 | x & 0xfU) && (((TOK *)vrgtok)[viVCRFocus].csh != 0)))))) {
            local_1a0 = SelectObject(hdc, hbrBlue);
            PatBlt(hdc, (dxyVCRSquare + 3) * x + 10, (dxyVCRSquare + 3) * uVar10 + 10, dxyVCRSquare + 1, 2, 0xf00021);
            PatBlt(hdc, (dxyVCRSquare + 3) * x + 10, (dxyVCRSquare + 3) * uVar10 + 10, 2, dxyVCRSquare + 1, 0xf00021);
            PatBlt(hdc, (dxyVCRSquare + 3) * x + 10, (dxyVCRSquare + 3) * uVar10 + 10 + dxyVCRSquare, dxyVCRSquare + 1, 2, 0xf00021);
            PatBlt(hdc, (dxyVCRSquare + 3) * x + 10 + dxyVCRSquare, (dxyVCRSquare + 3) * uVar10 + 10, 2, dxyVCRSquare + 1, 0xf00021);
...

{
    ...
    while (true) {
        ...
        *(undefined2 *)((int)ppTVar4 + -8) = 0x3a75;
        ...
        if ((ti.dwmsSinceStart._2_2_ <= uVar2) && ((uint)ti.dwmsSinceStart < uVar1))
            break;
        uVar3 = (ctick >> 0xf) + uVar2 + (uint)CARRY2(ctick, uVar1);
        ppTVar4 = (TIMERINFO **)((int)ppTVar4 + -4);
        if ((uVar3 <= ti.dwmsSinceStart._2_2_) && ((uVar3 < ti.dwmsSinceStart._2_2_ || (ppTVar4 = puVar5, ctick + uVar1 <= (uint)ti.dwmsSinceStart)))) {
            return;
        }
    }
    return;
...

{
    ...
    if (-1 < viStepVCRCur) {
        bVar1 = vlpbrVCR->itok;
        iVar7 = (dxyVCRSquare + 3) * (((TOK *)vrgtok)[bVar1].brc & 0xf) + dxyVCRSquare / 2 + 0xb;
        iVar8 = (dxyVCRSquare + 3) * ((int)(uint)((TOK *)vrgtok)[bVar1].brc >> 4) + dxyVCRSquare / 2 + 0xb;
        ...
        do {
            ...
            iFrame = iHit;
            while ((iFrame = iFrame + 1, sVar4 = iFrame,
                    iFrame < ((BTLREC *)vlpbrVCR)->ctok &&
                        (*(char *)((int)(BTLREC *)vlpbrVCR + iFrame * 8 + 6) == *(char *)((int)(BTLREC *)vlpbrVCR + iHit * 8 + 6)))) {
            ...
            if ((iVar13 != 0) || (iVar14 != 0)) {
                ...
                if ((grfWeapon & 3) != 0) {
                    ...
                    *(undefined2 *)(puVar28 + -0xc) = 0x413f;
                    DrawIcon(*(HDC *)(puVar28 + -2), *(short *)(puVar28 + -4), *(short *)(puVar28 + -6), *(HICON *)(puVar28 + -8));
                }
                if ((grfWeapon & 4) != 0) {
                    if (fAnimate == 0) {
                    LAB_10e8_43b4:
                        ...
                        *(undefined2 *)(puVar28 + -6) = 0x415f;
                        ...
                        if (HVar20 != 0) {
                            ...
                            *(undefined2 *)(puVar28 + -10) = 0x417e;
                            HVar21 = CreateCompatibleBitmap(*(HDC *)(puVar28 + -2), *(short *)(puVar28 + -4), *(short *)(puVar28 + -6));
                            if (HVar21 != 0) {
                                ...
                                *(undefined2 *)(puVar28 + -8) = 0x4237;
                                ...
                                for (iFrame = 0; iFrame < iVar13; iFrame = iFrame + 1) {
                                    ...
                                    *(undefined2 *)(puVar28 + -0x18) = 0x427c;
                                    BitBlt(*(HDC *)(puVar28 + -2), *(short *)(puVar28 + -4), *(short *)(puVar28 + -6), *(short *)(puVar28 + -8),
                                           *(short *)(puVar28 + -10), *(HDC *)(puVar28 + -0xc), *(short *)(puVar28 + -0xe), *(short *)(puVar28 + -0x10),
                                           *(DWORD *)(puVar28 + -0x14));
                                    *(HDC *)(puVar28 + -2) = hdc;
                                    ...
                                    do {
                                        ...
                                        *(undefined2 *)(puVar29 + -8) = 0x42ad;
                                        ...
                                        if ((ti.dwmsSinceStart._2_2_ < dwTickLast._2_2_) ||
                                            ((ti.dwmsSinceStart._2_2_ <= dwTickLast._2_2_ && ((uint)ti.dwmsSinceStart < (uint)dwTickLast))))
                                            break;
                                        uVar11 = ((dwTickLast._2_2_ + (0xffdc < (uint)dwTickLast)) - (viSpeedVCR * 10 >> 0xf)) -
                                                 (uint)((uint)dwTickLast + 0x23 < (uint)(viSpeedVCR * 10));
                                        puVar6 = puVar29 + -4;
                                    } while ((ti.dwmsSinceStart._2_2_ < uVar11) ||
                                             ((ti.dwmsSinceStart._2_2_ <= uVar11 &&
                                               (puVar6 = puVar29 + -4, (uint)ti.dwmsSinceStart < (uint)dwTickLast + 0x23 + viSpeedVCR * -10))));
                                    dwTickLast._0_2_ = (uint)ti.dwmsSinceStart;
                                    dwTickLast._2_2_ = ti.dwmsSinceStart._2_2_;
                                    *(HDC *)(puVar29 + -6) = hdc;
                                    ...
                                    *(undefined2 *)(puVar29 + -0x1c) = 0x433e;
                                    BitBlt(*(HDC *)(puVar29 + -6), *(short *)(puVar29 + -8), *(short *)(puVar29 + -10), *(short *)(puVar29 + -0xc),
                                           *(short *)(puVar29 + -0xe), *(HDC *)(puVar29 + -0x10), *(short *)(puVar29 + -0x12), *(short *)(puVar29 + -0x14),
                                           *(DWORD *)(puVar29 + -0x18));
        ...
        while (true) {
            ...
            *(HDC *)(puVar28 + -2) = hdc;
            *(uint *)(puVar28 + -4) = (bVar2 & 0xf) * (dxyVCRSquare + 3) + dxyVCRSquare / 2 + -5;
            *(int *)(puVar28 + -6) = ((int)(uint)bVar1 >> 4) * (dxyVCRSquare + 3) + dxyVCRSquare / 2 + -5;
            if (iVar7 == 0) {
                iVar7 = 0;
            } else {
                iVar7 = 2;
    ...
    for (i = 0; i < (int)(uint)((BTLDATA *)vlpbdVCR)->ctok; i = i + 1) {
        if ((((TOK *)vrgtok)[i].brc == brc) && (((TOK *)vrgtok)[i].csh != 0)) {
            ...
            if (*&((TOK *)vrgtok)[i].u_TOK_0x0003 == '\x01') {
                ...
                lpshdef._0_2_ = (SHDEF *)(*(int *)(iVar4 + rglpshdefSB) + (*(byte *)((int)&((TOK *)vrgtok)[i].u_TOK_0x0003 + 1) - 0x10) * 0x93);
            } else {
                iVar4 = (uint)((TOK *)vrgtok)[i].iplr * 4;
            ...
            if ((rgch + 0x5ff <= psz + cch + 1) || (0x27 < c))
                break;
            rgsz[c] = psz;
            rgid[c] = i;
