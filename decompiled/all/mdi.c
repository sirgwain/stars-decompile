...

{
    ...
    wc.lpszMenuName._0_2_ = (char *)"StarsMenu";
...

{
    ...
    if (idPlayer == -1) {
        ...
        pcVar7 = PszPlayerName(idPlayer, 0, 1, 0, 0, 0);
        _wsprintf(szData, "Stars! -- %s -- %s -- %s", 0x90, 0x1120, pcVar7, 0x1120);
    }
    SetWindowText(hwndFrame, szData);
    if (idPlayer != -1) {
        if (hwndScanner == 0) {
            uVar6 = 0x14f8;
            hwndScanner = CreateWindow(szScan, 0, 0x50000000, -200, -200, 10, 10, hwndFrame, 0, hInst, 0);
            puVar2 = &stack0xff7c;
        } else {
...

{
    ...
    MDI_Default_5:
        *(HWND *)(puVar9 + -2) = hwnd;
        *(WMType *)(puVar9 + -4) = msg;
        *(ushort *)(puVar9 + -6) = wParam;
        *(undefined2 *)(puVar9 + -8) = lParam._2_2_;
        *(int *)(puVar9 + -10) = (int)lParam;
        *(undefined2 *)(puVar9 + -0xc) = uVar10;
        *(undefined2 *)(puVar9 + -0xe) = 0x1d6a;
        LVar13 = DefWindowProc(*(HWND *)(puVar9 + -2), *(UINT *)(puVar9 + -4), *(WPARAM *)(puVar9 + -6), *(LPARAM *)(puVar9 + -10));
        return LVar13;
    }
    if (msg == WM_ACTIVATE) {
        return 0;
    ...
    if (msg == WM_PAINT) {
        ...
        if (BVar6 == 0) {
            ...
            local_2e = SelectObject(hdc, hbrButtonShadow);
    ...
    if (msg == WM_SETCURSOR) {
        ...
        if (BVar6 == 0) {
            ...
            uVar10 = 0x14f8;
            PVar12.y = local_12._4_2_;
            PVar12.x = local_12._2_2_;
            BVar6 = PtInRect(local_1a + 2, PVar12);
            if (BVar6 != 0) {
                uVar10 = 0x1020;
                pt.y = local_12._4_2_;
                pt.x = local_12._2_2_;
                local_12._6_2_ = HcrsFromFrameWindowPt(pt, 0);
                if (local_12._6_2_ != 0) {
    ...
    if (msg == WM_SYSCOMMAND) {
        if (((wParam & 0xfff0) == 0xf030) || ((wParam & 0xfff0) == 0xf120)) {
            ...
            if (idPlayer != -1) {
                ...
                if (sVar4 != 0) {
                    if (local_12._2_2_ == 0) {
                        pcVar14 = (char *)"M6102: MATH\r\n- floating-point error: denormal\r\n" + 1;
                        pcVar3 = PszFormatIds(idsNewTurnAvailableWouldLikeLoad, 0);
                        local_12._4_2_ = AlertSz(pcVar3, (short)pcVar14);
                    } else {
                        sVar4 = 0x40;
                        pcVar3 = PszFormatIds(idsNewTurnAvailable, 0);
                    ...
                    if (local_12._4_2_ == 6) {
                        ...
                        if (sVar4 == 0) {
                            sVar4 = 0x10;
                            pcVar3 = PszFormatIds(idsUnableOpenNewTurnFile, 0);
                            AlertSz(pcVar3, sVar4);
                        } else {
                            CreateChildWindows();
                        }
            ...
            if (local_12._2_2_ != 0) {
                ...
                if (uTimerType == 0xe) {
                    pcVar14 = (char *)"M6102: MATH\r\n- floating-point error: denormal\r\n" + 1;
                    pcVar3 = PszFormatIds(idsTurnHasSubmittedChangesMadeAfterTurn, 0);
                    local_12._4_2_ = AlertSz(pcVar3, (short)pcVar14);
                    if ((local_12._4_2_ == 6) && (sVar4 = FMarkFile(dtLog, idPlayer, 2, 0), sVar4 == 0)) {
                        sVar4 = 0x10;
                        pcVar3 = PszFormatIds(idsNewTurnCurrentlyGeneratedHostNewTurn, 0);
                        AlertSz(pcVar3, sVar4);
                        _wsprintf((char *)(local_16 + 2), MPCTD);
                        DestroyCurGame();
                        sVar4 = FLoadGame((char *)szBase, local_16 + 2);
    ...
    if (msg == WM_LBUTTONDOWN) {
        ...
        uVar11 = __aFulshr(lParam, 0x10);
        local_12._0_2_ = (char *)uVar11;
        pt_01.y = (short)(char *)local_12;
        pt_01.x = local_16._2_2_;
        uVar7 = HcrsFromFrameWindowPt(pt_01, (short *)((int)&local_12 + 2));
        if (uVar7 == 0) {
            return 0;
        }
        hdc = GetDC(hwnd);
        ...
        local_1a._0_2_ = 0;
        local_1c = 0;
        InvertPaneBorder(hdc, local_12._2_2_, (POINT)0x0, 0);
        ...
        while (true) {
            ...
            if ((local_16._2_2_ != local_12._4_2_) || ((char *)local_12 != (char *)local_12._6_2_)) {
                ...
                dpt.x = local_1c;
                PVar12 = InvertPaneBorder(hdc, local_12._2_2_, dpt, local_2a + 4);
                local_12._4_2_ = local_16._2_2_;
                local_12._6_2_ = (ushort)(char *)local_12;
                unique0x10001a50 = PVar12;
            }
        }
        dpt_00.y = local_1a._0_2_;
        dpt_00.x = local_1c;
        InvertPaneBorder(hdc, local_12._2_2_, dpt_00, 0);
        ReleaseCapture();
    ...
    MDI_MapIt_2:
        if (hwndTitle != 0) {
            LVar13 = SendMessage(hwndTitle, msg, wParam, lParam);
            return LVar13;
        }
        hdc = GetDC(hwnd);
    ...
    if (msg != WM_STARS_STARTUP) {
        ...
        if (msg == WM_STARS_CONTINUE) {
            ...
            sVar4 = FLoadGame((char *)szBase, (char *)s_m1_1120_03c8);
            if (sVar4 != 0) {
    ...
    if ((ini.wFlags >> 1 & 1) != 0) {
        ...
        if ((ini.wFlags >> 0xe & 1) != 0) {
            ...
            ini.wFlags = uVar1;
            ClearFile(7);
            sVar4 = FLoadGame((char *)szBase, (char *)"hst");
            if (sVar4 != 0) {
                VerifyTurns();
                DestroyCurGame();
                EnsureAis();
                _wsprintf(local_62, "\"%s\" Year: %d");
                OutputSz(7, local_62);
                for (i = 0; i < game.cPlayer; i = i + 1) {
                    if (((short *)rgOut)[i] + 1 < 4) {
                        local_12._6_2_ = _wsprintf(local_62, "%d: ");
                    } else {
                        local_12._6_2_ = _wsprintf(local_62, "Error: %d: ");
                    }
                    if ((gd.grBits2._2_2_ >> 6 & 1) == 0) {
                        PszPlayerName(i, 1, 1, 1, 0, 0);
                        sVar4 = _wsprintf(local_62 + local_12._6_2_, "\"%s\" ");
                        local_12._6_2_ = local_12._6_2_ + sVar4;
                    }
                    pcVar3 = PszGetCompressedString(((short *)rgOut)[i] + idsTurned);
                    _strcat(local_62, pcVar3);
                    if ((*(uint *)((int)&rgplr[0].wFlags + i * 0xc0) >> 4 & 1) != 0) {
                        _strcat(local_62, (char *)" - HACKER");
                    }
                    OutputSz(7, local_62);
                }
            }
    ...
    if (hwndTitle == 0) {
        ...
        hwndTitle = CreateWindow(szTitle, "Stars!", 0x90000000, 0, 0, local_12._2_2_, local_12._4_2_, hwndFrame, 0, hInst, 0);
        fFreeingTitle = 0;
    }
...
MDI_LNop:
    ...
    if (local_1a._2_2_ == 0) {
        ...
        if (sVar4 == 0) {
            if (((int)vSerialNumber == 0) && (puVar8 = &stack0xff9a, vSerialNumber._2_2_ == 0)) {
                _memcpy((byte *)vrgbMachineConfig, (byte_0_ *)&vrgbEnvCur, 0xb);
                uVar10 = 0x14f8;
                PostQuitMessage(vretExitValue);
                puVar8 = &stack0xff98;
    ...
    *(undefined2 *)(puVar8 + -2) = uVar10;
    *(undefined2 *)(puVar8 + -4) = 0xeae;
    WriteIniSettings();
    return 0;
}
...

{
    ...
    if ((pdptPrev != 0) && (grSel != 1)) {
        ...
        InvertPaneBorder(hdc, grSel, dpt_00, 0);
    }
    if ((iWindowLayout == 0) || ((iWindowLayout != 1 && (iWindowLayout != 2)))) {
        dxScanMin = 100;
        dyPlanMin = 0x32;
    ...
    default:
        ...
        if ((pdptPrev == 0) || (sVar3 = _abs(dptPrev.x), 5 < sVar3)) {
            if (pdptPrev != 0) {
...

{
    ...
    if (((ini.idPlayer == idPlayer) && ((int)ini.lid == (int)game.lid)) && (ini.lid._2_2_ == game.lid._2_2_)) {
        if ((ini.wFlags >> 5 & 0xf) == 2) {
            ...
            if ((((PLANET *)pPVar5 == 0) && (iVar1 == 0)) || (((PLANET *)pPVar5)->iPlayer != idPlayer)) {
                ini.iObjSel = *(short *)((int)&rgplr[0].idPlanetHome + idPlayer * 0xc0);
            } else {
                uVar3 = 0x1048;
...

{
    ...
    bVar1 = false;
    PushRandom(0x11000b, CONCAT22(unaff_SI, unaff_DI));
    Randomize(lSerial);
    ...
    for (i = 0; i < 0xb; i = i + 1) {
        ...
        if (bVar1) {
            uVar4 = Random(0x10);
            rgbRaw[iRaw] = rgbRaw[iRaw] | (byte)((uVar4 & 0xf) << 4);
            iRaw = iRaw + 1;
        } else {
            sVar3 = Random(0x10);
            rgbRaw[iRaw] = (byte)sVar3;
        }
    ...
    while (true) {
        ...
        if (0x1b < i)
            break;
        if (cBits < 6) {
            uVar4 = (uint)rgbRaw2[iRaw] << ((byte)cBits & 0x1f);
            lVar5 = CONCAT22(lTank._2_2_ | (int)uVar4 >> 0xf, (uint)lTank | uVar4);
            cBits = cBits + 8;
            iRaw = iRaw + 1;
        }
        bVar2 = (byte)lVar5 & 0x3f;
        lVar5 = __aFlshr(lVar5, 6);
        cBits = cBits + -6;
        if (bVar2 < 0x1a) {
            *pszOut = bVar2 + 0x41;
        } else if (bVar2 < 0x34) {
    ...
    *(undefined2 *)((int)plSerial + 2) = 0;
    ...
    for (i = 0; i < 0x15; i = i + 1) {
        while (true) {
            ...
            uVar3 = (uint)b64 << ((byte)cBits & 0x1f);
            lVar5 = CONCAT22(lTank._2_2_ | (int)uVar3 >> 0xf, (uint)lTank | uVar3);
            cBits = cBits + 6;
            pszIn = pszIn + 1;
        }
        rgbRaw2[iRaw] = (byte)lVar5;
        cBits = cBits + -8;
        lVar5 = __aFlshr(lVar5, 8);
        iRaw = iRaw + 1;
    }
    for (i = 0; i < 0x15; i = i + 1) {
        rgbRaw[((byte *)vrgbShuffleSerial)[i]] = rgbRaw2[i];
    }
    sVar4 = FValidSerialLong(CONCAT22(rgbRaw._2_2_, rgbRaw._0_2_));
    if (sVar4 == 0) {
        fSuccess = 0;
    } else {
        fSuccess = 1;
...

{
    ...
    if ((((PLANET *)lppl == 0) && (iVar3 == 0)) || (((PLANET *)lppl)->iPlayer != idPlayer)) {
...

{
    ...
    if (wParam == IDM_FILE_HOST_GAME) {
        if ((game.wCrap >> 2 & 1) == 0) {
            pcVar29 = (char *)"M6102: MATH\r\n- floating-point error: denormal\r\n" + 2;
            pcVar9 = PszFormatIds(idsGameAlreadyHostedAnotherInstanceStarsWould, 0);
    ...
    LAB_1020_3f6e:
        ...
        if (((game.wCrap >> 2 & 1) != 0) && (iPassCnt != 0)) {
            ...
            HVar14 = GetFocus();
            sVar7 = MessageBox(HVar14, szWork, "Stars!", MB_TASKMODAL | MB_ICONEXCLAMATION | MB_YESNO);
            if (sVar7 != 6) {
                return;
            }
        }
        ...
        if (((uint)gd.grBits >> 0xb & 1) != 0) {
            ...
            if (((uint)tutor.wFlags >> 3 & 1) == 0) {
                sVar7 = 0x10;
                pcVar9 = PszFormatIds(idsTutorialTurnWillGeneratedHaveYetCompleted, 0);
            ...
            if (game.turn < 36) {
                ...
                if (sVar7 == 0) {
                    sVar7 = 0x10;
                    pcVar9 = PszFormatIds(idsFileError, 0);
                    AlertSz(pcVar9, sVar7);
                    return;
                }
        ...
        if (wParam != WMX_UNKNOWN_006C) {
            ...
            if (wParam != WMX_UNKNOWN_006F) {
                if (wParam == IDM_FILE_RETURN_TO_TITLE) {
                    ...
                    hwndTitle = CreateWindow(szTitle, "Stars!", 0x90000000, 0, 0, (short)local_24, (short)local_22, hwndFrame, 0, hInst, 0);
                    fFreeingTitle = 0;
                ...
                if (wParam == IDC_UNKNOWN_00D5) {
                    ...
                    if (iVar15 == 0) {
                        sVar7 = 0x10;
                        pcVar9 = PszFormatIds(idsUnablePrintGameMapPrinterMayOff, 0);
                        AlertSz(pcVar9, sVar7);
                        return;
                    }
                    ...
                    for (local_6a = 0; local_6a < (int)local_22; local_6a = local_6a + 1) {
                        for (local_90 = 0; local_90 < (int)local_68; local_90 = local_90 + 1) {
                            ...
                            Escape(local_5a, 10, local_92, szWork, 0);
                            ...
                            pcVar9 = PszPlayerName(idPlayer, 1, 1, 1, 0, 0);
                            ...
                            if ((grbitScan & 0xf) != 5) {
                                ...
                                for (local_30 = 0; (int)local_30 < 5; local_30 = (PLANET *)((int)&local_30->id + 1)) {
                                ...
                                CtrTextOut(local_5a, local_80 + local_a4, ((local_86 * 3) / 2 + local_74) - local_a8._2_2_, (char *)s___1120_03d4, 1);
                                local_a8._2_2_ = local_70 / 2;
                                CtrTextOut(local_5a, local_80 + local_a4, ((local_86 * 5) / 2 + local_74) - local_a8._2_2_, (char *)s___1120_03d6, 1);
                                CtrTextOut(local_5a, local_80 + local_a4, ((local_86 * 9) / 2 + local_74 + 8) - local_70, (char *)s_2_1120_03d8, 1);
                                if (local_7c != 0) {
                                    ...
                                    if (pPStack_2e->iPlayer == idPlayer) {
                                        if ((pPStack_2e->wFlags_0x4 >> 9 & 1) != 0) {
                                            ...
                                            if (*(int *)(*(int *)(iVar15 + rglpshdefSB) + (*(uint *)&pPStack_2e->lStarbase & 0xf) * 0x93) == 0x20) {
                                                pcVar9 = (char *)s___1120_03da;
                                            } else {
                                                pcVar9 = (char *)s___1120_03dc;
                                            }
                            ...
                            for (local_30 = 0; (int)local_30 < game.cPlanMax; local_30 = (PLANET *)((int)&local_30->id + 1)) {
                            ...
                            Escape(local_5a, 1, 0, 0, 0);
                        }
                    }
                    Escape(local_5a, 0xb, 0, 0, 0);
                    if (local_7c != 0) {
                ...
                if (wParam == IDC_UNKNOWN_0428) {
                    ...
                    LAB_1020_44cc:
                        ...
                        if (wParam == IDM_REPORT_FLEET) {
                            ...
                            for (local_2a = 0; (int)local_2a < cFleet; local_2a = (PLANET *)((int)&local_2a->id + 1)) {
                                pPStack_2e = *(PLANET **)((FLEET **)rglpfl + (int)local_2a);
                                pPStack_2c = (PLANET *)*(int *)((int)((FLEET **)rglpfl + (int)local_2a) + 2);
                                if ((pPStack_2e == 0) && (pPStack_2c == 0))
                                    break;
                                if (pPStack_2e->iPlayer == idPlayer) {
                        ...
                        hwndReportDlg = CreateWindow(szReport, szWork, 0x80cf0000, 0, 0, 100, 100, hwndFrame, 0, hInst, 0);
                    ...
                    if (wParam == IDM_UNKNOWN_098D) {
                        ...
                        InvalidateRect(hwndScanner, 0, 0);
                        return;
                    }
                    ...
                    if ((wParam != IDM_TURN_END_A) && (wParam != IDM_TURN_END_B)) {
                        ...
                        if (((((wParam == IDM_SCAN_ZOOM_0) || (wParam == IDM_SCAN_ZOOM_1)) || (wParam == IDM_SCAN_ZOOM_2)) ||
                            ...
                            sVar7 = 0x10;
                            pcVar9 = PszFormatIds(idsCantChangeZoomFactorUntilGameOpen, 0);
                            AlertSz(pcVar9, sVar7);
                            return;
                        }
                        ...
                        if ((((((wParam == IDM_FILE_MRU1) || (wParam == IDM_FILE_MRU2)) || (wParam == IDM_FILE_MRU3)) ||
                            ...
                            if (((char *)vrgszMRU == 0) && (vrgszMRU._2_2_ == 0)) {
                                return;
                            }
                            ...
                            if ((local_24 == 0) || (sVar7 = __access(local_124, 0), sVar7 == -1)) {
                                _strcpy((char *)szWork, local_124);
                                sVar7 = 0x10;
                                pcVar9 = PszFormatIds(idsCantOpenFile, 0);
                                AlertSz(pcVar9, sVar7);
                                return;
                            }
                            ini.wFlags = ini.wFlags & 0xfffe | 1;
            ...
            if (hwndScanner == 0) {
                sVar7 = 0x10;
                pcVar9 = PszFormatIds(idsGameCurrentlyLoaded, 0);
                AlertSz(pcVar9, sVar7);
                return;
            }
            if (idPlayer == -1) {
...
MDI_LWaitForTurn:
    if (((PLANET *)lpPlanets == 0) && (lpPlanets._2_2_ == 0)) {
        return;
    }
    if (idPlayer == -1) {
        return;
...
MDI_LNewTurnAvail:
    ...
    if (game.fDirty == 0) {
        sVar7 = 0x40;
        pcVar9 = PszFormatIds(idsNewTurnAvailable, 0);
        AlertSz(pcVar9, sVar7);
    } else {
        sVar7 = 0x31;
        pcVar9 = PszFormatIds(idsSorryTurnHasAlreadyGeneratedAnyChanges, 0);
    ...
    if (sVar7 == 0) {
        sVar7 = 0x10;
        pcVar9 = PszFormatIds(idsUnableOpenNewTurnFile, 0);
        AlertSz(pcVar9, sVar7);
    } else {
        CreateChildWindows();
        SendMessage(hwndFrame, WM_COMMAND, IDM_FRAME_POST_OPEN, 0);
...

{
    ...
    if (((uint)gd.grBits >> 10 & 1) == 0) {
        ...
        if (((uint)gd.grBits >> 3 & 1) == 0) {
            DestroyCurGame();
            FLoadGame((char *)szBase, (char *)"hst");
        }
        ...
        for (iPlayer = 0; iPlayer < game.cPlayer; iPlayer = iPlayer + 1) {
            ...
            if (((rgmdplr + iPlayer)->wFlags >> 9 & 1) != 0) {
                ...
                sVar5 = FOpenFile(dtLog, iPlayer, mdRead);
...

{
    ...
    for (i = 0; i < game.cPlayer; i = i + 1) {
        ...
        if ((gd.grBits2._2_2_ >> 6 & 1) == 0) {
            pcVar2 = szStat;
            pcVar4 = PszPlayerName(i, 1, 1, 1, 0, 0);
            uVar14 = 0x1120;
        ...
        if ((*(uint *)((int)&rgplr[0].wFlags + i * 0xc0) >> 4 & 1) != 0) {
            _strcat((char *)szWork, (char *)" - HACKER");
            cch = cch + 9;
        }
...

{
    ...
    do {
        ...
        LAB_1020_678e:
            ctickLast = uVar4;
            if ((*(uint *)((int)&rgplr[0].wMdPlr + i * 0xc0) >> 9 & 1) == 0) {
                _wsprintf(szWork, "%s.x%d", (char *)szBase, 0x1120, i + 1);
                idPlayer = i;
...

{
    ...
    LAB_1020_6db6:
        ...
        if ((((5 < local_18.x) && (local_18.x < dyArial8 + 7)) && (0x2f < local_18.y)) &&
            ...
            TrackPopupMenu(local_24, local_1a | 4, local_18.x, local_18.y, 0, hwnd, 0);
            ...
            if (((wParam == 0x407) || (wParam == 2)) || (wParam == 0x408)) {
                if (wParam == 0x407) {
                    ...
                    if (iPassCnt == 0) {
                        ...
                        if (sVar4 != 0) {
                            sVar4 = 0x1024;
                            pcVar5 = PszFormatIds(idsSureWishGenerateOptionDoesGuaranteePlayers, 0);
                            uVar8 = 0x1040;
                        ...
                        HVar2 = GetFocus();
                        uVar8 = 0x14f8;
                        sVar4 = MessageBox(HVar2, szWork, "Stars!", MB_TASKMODAL | MB_ICONEXCLAMATION | MB_YESNO);
                        puVar7 = &stack0xffbc;
                        if (sVar4 != 6) {
                            iPassCnt = 0;
                            return 1;
...

{
    ...
    _wsprintf(szWork, "%lx", (undefined2)game.lid, game.lid._2_2_);
    WritePrivateProfileString(szSection, szEntry, szWork, szIniFile);
    ...
    if (idPlayer != -1) {
        ...
        _wsprintf(szWork, "%s.m%d", (char *)szBase, 0x1120, idPlayer + 1);
        WritePrivateProfileString(szSection, szEntry, szWork, szIniFile);
    }
...

{
    ...
    if (msg == WM_CREATE) {
        ...
        if (msg == WM_PAINT) {
            ...
            if (BVar5 == 0) {
                ...
                if ((vcScreenColors < 8) || (SetTextColor(HVar7, 0x2ff7fff), vhdibTitle == 0)) {
                    ...
                    if (HVar8 != 0) {
                        ...
                        RcCtrTextOut(HVar7, &rcT, (char *)"Stars!", 6);
            ...
            if (wParam == 0) {
                NewGameWizard(hwnd, 0);
                if ((((PLANET *)lpPlanets == 0) && (lpPlanets._2_2_ == 0)) && (((int)game.lid == 0 && (game.lid._2_2_ == 0)))) {
                    SetFocus(hwnd);
                } else {
                    if (fFreeingTitle == 0) {
                        fFreeingTitle = 1;
