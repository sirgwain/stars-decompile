    ...
    if (msg == WM_CREATE) {
        ...
        for (i = 0; i < 0x1d; i = i + 1) {
            ...
            if ((iVar2 < -2) && (iVar2 == -3)) {
                ...
                pWVar9[-0x10] = 0x1068;
                pWVar9[-0x11] = 0xba;
                hwndTBRadar = CreateWindow(*(LPCSTR *)(pWVar9 + -2), *(LPCSTR *)(pWVar9 + -4), *(undefined4 *)(pWVar9 + -6), pWVar9[-7], pWVar9[-8], pWVar9[-9],
...

{
    ...
    DibBlt(hdc, pt.x + 2 + fDown, pt.y + 2 + fDown, dx_00, 0x17, hdibToolbar, ibtn * 0x18, 0, dx_00, 0x17, 0xcc0020);
    if (1 < fDown) {
...

{
    ...
    case 8:
        ...
        for (local_26 = idsMineFields; iVar2 = local_24, (int)local_26 < 0x500; local_26 = local_26 + idsPlayerLogFileAppearsCorruptUnableLoad) {
            ...
            CchGetString(local_26, (char *)szWork + 0xa0 + (local_26 - idsMineFields) * 0x1e);
        ...
        for (local_26 = 0; local_24 = local_24 + 1, iVar2 = local_24, (int)local_26 < 4; local_26 = local_26 + 1) {
            local_58[local_24 * 2] = (uint)((1 << ((byte)local_26 & 0x1f) & grbitScanMines) != 0);
            local_58[iVar2 * 2 + 1] = 0;
    ...
    case 0xd:
        local_3a = 0;
        for (local_38 = idsDesigns; iVar2 = local_3a, (int)local_38 < 0x4fe; local_38 = local_38 + idsPlayerLogFileAppearsCorruptUnableLoad) {
        ...
        uVar7 = 0x10c0;
        sVar3 = PopupMenu(hwndTb, local_c._0_2_, local_c._2_2_, local_3a, local_8a, local_34, -2, 0);
        puVar6 = &stack0xff6c;
        if (sVar3 == -1) {
            return;
        }
        if (sVar3 < 4) {
            ...
            if ((grbitScan & 0x200) == 0)
                goto joined_r0x10681246;
        } else {
            iSel = sVar3 + -4;
            local_36 = 0;
            while ((local_36 < 0x10 && (((*(uint *)((int)&rgshdef[0].wFlags + local_36 * 0x93) >> 9 & 1) != 0 || (iSel = iSel + -1, -1 < iSel))))) {
                local_36 = local_36 + 1;
            }
    ...
    case 0xf:
        local_28 = 1;
        local_24 = 0;
        for (local_26 = idsDesigns; iVar2 = local_24, (int)local_26 < 0x4fe; local_26 = local_26 + idsPlayerLogFileAppearsCorruptUnableLoad) {
            local_58[local_24 * 2] = 0;
            local_58[iVar2 * 2 + 1] = 0;
            CchGetString(local_26, (char *)szWork + 200 + (local_26 - idsDesigns) * 0x19);
        ...
        for (local_26 = 0; local_24 = local_24 + 1, iVar2 = local_24, (int)local_26 < 8; local_26 = local_26 + 1) {
            local_58[local_24 * 2] = (uint)((1 << ((byte)local_26 & 0x1f) & grbitScanEShip) != 0);
            local_58[iVar2 * 2 + 1] = 0;
...

{
    ...
    if (((int)ids < 0) || (prc == (RECT *)0x0)) {
        ...
        *(undefined2 *)(puVar9 + -8) = 0x18ef;
        ...
        if (hwndTooltip == 0) {
            ...
            *(undefined2 *)(puVar9 + -0x22) = 0x193f;
            CreateWindow(*(LPCSTR *)(puVar9 + -4), *(LPCSTR *)(puVar9 + -8), *(DWORD *)(puVar9 + -0xc), *(short *)(puVar9 + -0xe), *(short *)(puVar9 + -0x10),
                         *(short *)(puVar9 + -0x12), *(short *)(puVar9 + -0x14), *(HWND *)(puVar9 + -0x16), *(HMENU *)(puVar9 + -0x18),
        ...
        *(undefined2 *)(puVar10 + -0xe) = 0x19dd;
        TooltipWndProc(*(HWND *)(puVar10 + -2), *(WMType *)(puVar10 + -4), *(ushort *)(puVar10 + -6), *(long *)(puVar10 + -10));
        DVar12 = CONCAT22(vtickTooltipLast._2_2_, (uint)vtickTooltipLast);
    }
LAB_1068_19dd:
    ...
    if (msg == WM_CREATE) {
        ...
        if (wParam == 0x39e) {
            if (msg == WM_TIMER) {
                ...
                uVar1 = CONCAT22(vtickTooltip1stVis._2_2_, (uint)vtickTooltip1stVis);
                puVar8 = &stack0xffc0;
                vtickTooltip1stVis = CONCAT22(vtickTooltip1stVis._2_2_, (uint)vtickTooltip1stVis);
                if ((BVar3 == 0) ||
                    (puVar8 = &stack0xffc0, vtickTooltip1stVis = CONCAT22(vtickTooltip1stVis._2_2_, (uint)vtickTooltip1stVis),
                     CONCAT22(vtickTooltip1stVis._2_2_ + (uint)(0xd8ef < (uint)vtickTooltip1stVis), (uint)vtickTooltip1stVis + 10000) < vtickTooltipLast))
                    goto TB_LKillTip;
            } else {
            LAB_1068_1abb:
                ...
                *(undefined2 *)(puVar7 + -0x10) = 0x1ae5;
                ...
                if (BVar3 != 0) {
                    ...
                    *(undefined2 *)(puVar7 + -0x16) = 0x1b59;
                    SetWindowPos(*(HWND *)(puVar7 + -6), *(HWND *)(puVar7 + -8), *(short *)(puVar7 + -10), *(short *)(puVar7 + -0xc), *(short *)(puVar7 + -0xe),
                    ...
                    *(undefined2 *)(puVar7 + -0x12) = 0x1b8f;
                    UVar5 = SetTimer(*(HWND *)(puVar7 + -8), *(UINT *)(puVar7 + -10), *(UINT *)(puVar7 + -0xc), *(undefined2 *)(puVar7 + -0xe));
                    if (UVar5 == 0) {
                        vidTimerTooltip = -1;
                    } else {
                        vidTimerTooltip = 0x39e;
