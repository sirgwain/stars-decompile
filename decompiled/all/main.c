                    ...
                    while (*lpT != '\0') {
                        ...
                        if ((*lpT == '-') || (*lpT == '/')) {
                            ...
                            while ((*lpT != '\0' && (*lpT != ' '))) {
                                ...
                                case 'C':
                                case 'c':
                                    ini.wFlags = ini.wFlags & 0xfffd | (uint)(szBase[0] != '\0') << 1;
                                    break;
                                case 'D':
                                case 'd':
                                    lpT = (char *)lpT + 1;
                                ...
                                case 'p':
                                    ...
                                    pch = (char *)szPassLast;
                                    while (true) {
                                        if (((*lpT == '\0') || (*lpT == ' ')) || ((char *)szPassLast + 0xe < pch))
                                            break;
                                        *pch = *lpT;
                                        pch = pch + 1;
                                        lpT = (char *)lpT + 1;
...

{
    ...
    sVar1 = FValidSerialLong(CONCAT22(*(undefined2 *)((int)&((TURNSERIAL *)vrgts)[iplr].lSerialNumber + 2), (int)((TURNSERIAL *)vrgts + iplr)->lSerialNumber));
    if (sVar1 != 0) {
        for (i = 0; i < game.cPlayer; i = i + 1) {
            if ((i != iplr) && ((*(uint *)((int)&rgplr[0].wFlags + i * 0xc0) >> 2 & 1) != 0)) {
                if (((int)((TURNSERIAL *)vrgts + iplr)->lSerialNumber == (int)((TURNSERIAL *)vrgts + i)->lSerialNumber) &&
                    ((*(int *)((int)&((TURNSERIAL *)vrgts)[iplr].lSerialNumber + 2) == *(int *)((int)&((TURNSERIAL *)vrgts)[i].lSerialNumber + 2) &&
                      (sVar1 = __fmemcmp((byte *)CONCAT22(vrgts._2_2_, ((TURNSERIAL *)vrgts)[iplr].rgbConfig),
                                         (byte *)CONCAT22(vrgts._2_2_, ((TURNSERIAL *)vrgts)[i].rgbConfig), 0xb),
                       sVar1 != 0)))) {
                    return i;
                }
            }
...

{
    ...
    FreeProcInstance((fn_lpfnFakeComboProc *)CONCAT22(lpfnFakeComboProc._2_2_, (fn_lpfnFakeComboProc *)lpfnFakeComboProc));
    FreeProcInstance((fn_lpfnFakeCEProc *)CONCAT22(lpfnFakeCEProc._2_2_, (fn_lpfnFakeCEProc *)lpfnFakeCEProc));
    FreeProcInstance((fn_lpfnFakeEditProc *)CONCAT22(lpfnFakeEditProc._2_2_, (fn_lpfnFakeEditProc *)lpfnFakeEditProc));
    ...
    for (i = 0; i < 0xc; i = i + 1) {
        FreeHb((HB *)CONCAT22(*(undefined2 *)(i * 4 + rglphb_0x2), (HB *)*(undefined2 *)(i * 4 + rglphb)));
    }
    return;
}
        ...
        if (message == WM_CTLCOLOR) {
            ...
            if (message == WM_COMMAND) {
                ...
                if (wParam == 0x76) {
                    ...
                    DialogBox(0, IDD_ORDER_INFO, hwnd, lpDlgProc);
                ...
                for (local_10 = iAbout1st; local_10 < iAbout1st + 10; local_10 = local_10 + 1) {
...

{
    ...
    if (((((hwndScanner == 0) || ((ch != 0x2b && (ch != 0x2d)))) && (ch != 0x76)) && (ch != 0x56)) ||
...
LAB_1018_175f:
    ...
    if ((((((iKey != 8) && (iKey != 0x2e)) && (iKey != 0x28)) && ((iKey != 0x26 && (iKey != 0x24)))) && (iKey != 0x23)) &&
        (((iKey < 0x30 || (0x39 < iKey)) && ((iKey != 0xbc && (((iKey != 0xbe && (iKey != 0xdb)) && (iKey != 0xdd)))))))) {
        return 0;
    }
    ...
    if (iKey != 8) {
        ...
        if (iKey != 0x2e) {
            if ((iKey == 0xbc) || (iKey == 0xbe)) {
                if ((sel.grobj == grobjFleet) && ((0 < sel.iwpAct || (1 < sel.fl.cord)))) {
                    local_a.x = sel.iwpAct;
                    if (sel.iwpAct < 1) {
                        local_a.x = 1;
                    }
                    uVar4 = *(uint *)((int)(PLORD *)sel.fl.lpplord + local_a.x * 0x12 + 10) >> 4 & 0xf;
                    if (iKey == 0xbc) {
                        local_a.y = uVar4 - 1;
                    } else {
                        local_a.y = uVar4 + 1;
                    ...
                    if ((-1 < local_a.y) && (local_a.y < 0xc)) {
                        *(uint *)((int)(PLORD *)sel.fl.lpplord + local_a.x * 0x12 + 10) =
                            *(uint *)((int)(PLORD *)sel.fl.lpplord + local_a.x * 0x12 + 10) & 0xff0f | (local_a.y & 0xfU) << 4;
            ...
            *(undefined2 *)(puVar6 + -0xe) = 0x1bd1;
            ExecuteReportClick(*(puVar6 + -10), *(short *)(puVar6 + -6), *(short *)(puVar6 + -4), *(short *)(puVar6 + -2));
            return 1;
        }
    }
