...

{
    ...
    (ppart->hs).wFlags_0x2 = (ppart->hs).wFlags_0x2 & 0xff00 | iItem & 0xff;
    (ppart->hs).wFlags_0x2 = (ppart->hs).wFlags_0x2 & 0xff;
...

{
    ...
    if (HVar1 == hstEngine) {
        ...
        *(undefined2 *)((int)&ppart->u_PART_0x0004 + 2) = 0x10e0;
        if (idPlayer != -1) {
            ...
            if ((((10 < (uVar2 & 0xff)) && ((uVar2 & 0xff) < 0x10)) || ((uVar2 & 0xff) == 10)) &&
                (sVar3 = GetRaceGrbit((PLAYER *)rgplr + idPlayer, ibitRaceNoRamscoops), sVar3 != 0)) {
                return -1;
            }
            if ((((uVar2 & 0xff) == 0xf) || ((uVar2 & 0xff) == 2)) && (sVar3 = GetRaceGrbit((PLAYER *)rgplr + idPlayer, ibitRaceIFE), sVar3 == 0)) {
                return -1;
            }
            if (((uVar2 & 0xff) == 7) && (sVar3 = GetRaceGrbit((PLAYER *)rgplr + idPlayer, ibitRaceNoRamscoops), sVar3 == 0)) {
                return -1;
            }
        ...
        *(undefined2 *)((int)&ppart->u_PART_0x0004 + 2) = 0x10e0;
        if (idPlayer != -1) {
            if (((((uVar2 & 0xff) == 7) || ((uVar2 & 0xff) == 8)) || ((uVar2 & 0xff) == 0xc)) &&
                (sVar4 = GetRaceGrbit((PLAYER *)rgplr + idPlayer, ibitRaceNoAdvScanner), sVar4 != 0)) {
                return -1;
            }
            if (((((uVar2 & 0xff) == 6) || ((uVar2 & 0xff) == 5)) || ((uVar2 & 0xff) == 0xe)) && (sVar3 != raStealth)) {
                return -1;
            }
        }
        ...
        *(undefined2 *)((int)&ppart->u_PART_0x0004 + 2) = 0x10e0;
        if (idPlayer != -1) {
            if ((((((uVar2 & 0xff) == 2) || ((uVar2 & 0xff) == 3)) || ((uVar2 & 0xff) == 4)) || (((uVar2 & 0xff) == 0 || ((uVar2 & 0xff) == 5)))) &&
                (sVar4 = GetRaceGrbit((PLAYER *)rgplr + idPlayer, ibitRaceOBRM), sVar4 != 0)) {
                return -1;
            }
            if ((((uVar2 & 0xff) == 0) || ((uVar2 & 0xff) == 5)) && (sVar4 = GetRaceGrbit((PLAYER *)rgplr + idPlayer, ibitRaceARM), sVar4 == 0)) {
                return -1;
            }
        ...
        *(undefined2 *)((int)&ppart->u_PART_0x0004 + 2) = 0x10e0;
        if (idPlayer != -1) {
            if (((((uVar2 & 0xff) == 0) || ((uVar2 & 0xff) == 2)) ||
                 (((uVar2 & 0xff) == 3 ||
                   (((((uVar2 & 0xff) == 4 || ((uVar2 & 0xff) == 5)) || ((uVar2 & 0xff) == 6)) || (((uVar2 & 0xff) == 8 || ((uVar2 & 0xff) == 9)))))))) &&
                (sVar3 != raMines)) {
                return -1;
            }
        ...
        *(undefined2 *)((int)&ppart->u_PART_0x0004 + 2) = 0x10e0;
        if (idPlayer != -1) {
            if ((((uVar2 & 0xff) == 1) || ((uVar2 & 0xff) == 3)) && (sVar4 = GetRaceGrbit((PLAYER *)rgplr + idPlayer, ibitRaceISB), sVar4 == 0)) {
                return -1;
            }
        ...
        *(undefined2 *)((int)&ppart->u_PART_0x0004 + 2) = 0x10e0;
        if (((idPlayer != -1) && ((uVar2 & 0xff) < 8)) && (sVar3 = GetRaceGrbit((PLAYER *)rgplr + idPlayer, ibitRaceTT), sVar3 == 0)) {
            return -1;
        }
        ...
        *(undefined2 *)((int)&ppart->u_PART_0x0004 + 2) = 0x10e0;
        if (idPlayer != -1) {
            ...
            if (((((uVar2 & 0xff) == 0x16) || ((uVar2 & 0xff) == 0x17)) || (((uVar2 & 0xff) == 0x14 || ((uVar2 & 0xff) == 0x18)))) &&
                (sVar4 = GetRaceGrbit((PLAYER *)rgplr + idPlayer, ibitRaceOBRM), sVar4 != 0)) {
                return -1;
            }
            if (((((uVar2 & 0xff) == 0x14) || ((uVar2 & 0xff) == 0x16)) || ((uVar2 & 0xff) == 0x18)) &&
                (sVar4 = GetRaceGrbit((PLAYER *)rgplr + idPlayer, ibitRaceARM), sVar4 == 0)) {
                return -1;
            }
    ...
    sVar3 = TechStatus((char *)CONCAT22(*(undefined2 *)((int)&ppart->u_PART_0x0004 + 2), (char *)(*&(&ppart->u_PART_0x0004)->parmor + 2)));
    return sVar3;
}
...

{
    ...
    (ppart->hs).wFlags_0x2 = (ppart->hs).wFlags_0x2 & 0xff00 | 8;
    (ppart->hs).grhst = hstPlanetary;
    while ((sVar3 = FLookupPart(ppart), sVar3 != 1 && (((ppart->hs).wFlags_0x2 & 0xff) != 0))) {
        uVar2 = (ppart->hs).wFlags_0x2;
        puVar1 = &(ppart->hs).wFlags_0x2;
        *puVar1 = *puVar1 & 0xff00;
        puVar1 = &(ppart->hs).wFlags_0x2;
        *puVar1 = *puVar1 | uVar2 - 1 & 0xff;
    }
    return;
}
...

{
    ...
    while (true) {
        ...
        if ((*(char *)(idPlayer * 0xc0 + 0x59bc + i) < ((char *)rgTech)[i]) &&
            (cMiss = cMiss + 1, i == ((int)*(char *)((int)&rgplr[0].iTechCur + idPlayer * 0xc0) & 0xfU))) {
    ...
    if (cMiss == 0) {
        ...
        sVar2 = ((int)((char *)rgTech)[fInAWhile + -1] - (int)*(char *)(idPlayer * 0xc0 + fInAWhile + 0x59bb)) + 1;
    } else {
        sVar2 = 99;
    }
    return sVar2;
