...

{
    ...
    if (((HB *)*(int *)(iVar4 + rglphb) == (HB *)lphb) && (*(int *)(iVar4 + rglphb_0x2) == lphb._2_2_)) {
        iVar4 = (uint)pHVar2->ht * 4;
        *(int *)(iVar4 + rglphb) = (int)pHVar2;
        *(undefined2 *)(iVar4 + rglphb_0x2) = uVar3;
    } else {
        iVar4 = (uint)pHVar2->ht * 4;
        lphbT = (HB *)CONCAT22(*(undefined2 *)(iVar4 + rglphb_0x2), (HB *)*(undefined2 *)(iVar4 + rglphb));
        while (true) {
            /* WARNING: Load size is inaccurate */
            if ((((HB *)lphbT == 0) && (lphbT._2_2_ == 0)) ||
                ((((HB *)lphbT)->lphbNext == (HB *)lphb && (*(int *)((int)&((HB *)lphbT)->lphbNext + 2) == lphb._2_2_))))
                break;
            /* WARNING: Load size is inaccurate */
            lphbT = (HB *)CONCAT22(*(undefined2 *)((int)&((HB *)lphbT)->lphbNext + 2), ((HB *)lphbT)->lphbNext);
        }
...

{
    ...
    lphb = (HB *)CONCAT22(*(undefined2 *)(ht * 4 + rglphb_0x2), (HB *)*(undefined2 *)(ht * 4 + rglphb));
    while (true) {
        if (((HB *)lphb == 0) && (lphb._2_2_ == 0))
            break;
        ((HB *)lphb)->ibTop = 0x10;
...

{
    ...
    cb_00 = cb + 3 & 0xfffe;
    do {
        if ((((HB *)lphb == 0) && (lphb._2_2_ == 0)) || (cb_00 <= lphb->cbFree)) {
            if (((HB *)lphb == 0) && (lphb._2_2_ == 0)) {
            ...
            while (pbVar2 = lpb, pbVar1 = (byte *)lpb, (byte *)lpb < pbVar3) {
                ...
                if ((uVar4 & 1) != 0) {
                    for (; (((byte *)lpb < pbVar3 && ((*lpb & 1) != 0)) && ((uint)((int)(byte *)lpb - (int)pbVar1) < cb_00));
                         lpb = (byte *)CONCAT22(lpb._2_2_, (byte *)lpb + (*lpb & 0xfffe) + 2)) {
                    }
...

{
    ...
    if (((int)ht < 0) || (0xb < (int)ht)) {
        ...
        lphb = (HB *)CONCAT22(*(undefined2 *)(ht * 4 + rglphb_0x2), (HB *)*(undefined2 *)(ht * 4 + rglphb));
        while (true) {
            if ((lphb == 0) || ((lphb < lp && (lp < (void *)CONCAT22(lphb._2_2_, (void *)((int)&((HB *)lphb)->cbFree + ((HB *)lphb)->cbBlock))))))
                break;
            /* WARNING: Load size is inaccurate */
            lphb = (HB *)CONCAT22(*(undefined2 *)((int)&((HB *)lphb)->lphbNext + 2), ((HB *)lphb)->lphbNext);
        }
...

{
    ...
    if (uVar1 < cb_00) {
        ...
        while (true) {
            ...
            pHVar3 = (HB *)lphb_00;
            if ((((int)&pHVar3->cbFree + pHVar3->ibTop == (int)(void *)lp + uVar1) && (iVar4 == lp._2_2_)) && (uVar2 <= pHVar3->cbSlop)) {
