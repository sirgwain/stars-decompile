...

{
    if ((THING *)lpth < (THING *)lpThings + cThing + -1) {
        __fmemmove(lpth, (THING *)lpth + 1, ((cThing - ((int)(THING *)lpth - (int)(THING *)lpThings) / 0x12) + -1) * 0x12);
    }
    cThing = cThing + -1;
    return;
}
...

{
    ...
    _sqrt((double)r2);
    lVar5 = __ftol((double)CONCAT26(in_stack_0000ffe4, CONCAT24(in_stack_0000ffe2, CONCAT22(unaff_SI, unaff_DI))));
    iVar1 = (int)lVar5;
    cPl = 0;
    pPVar4 = (POINT *)rgptPlan + game.cPlanMax;
    uVar8 = CONCAT62(CONCAT42((long)(((POINT *)rgptPlan + game.cPlanMax + -1)->x - rgptPlan[0].x), game.cPlanMax >> 0xf), game.cPlanMax);
    ...
    for (ppt = (POINT *)rgptPlan + i; (pt.x - iVar1 <= ppt->x && ((POINT *)((int)&rgptPlan[0].x + 1U) <= ppt)); ppt = ppt + -1) {
    }
    for (; (ppt->x <= pt.x + iVar1 && (ppt < pPVar4)); ppt = ppt + 1) {
        if (((pt.x - iVar1 <= ppt->x) && (pt.y - iVar1 <= ppt->y)) && (ppt->y <= pt.y + iVar1)) {
            iVar2 = ppt->x - pt.x;
            iVar3 = ppt->y - pt.y;
            uVar6 = __aFulmul((ulong)CONCAT62(CONCAT42((long)iVar3, iVar3 >> 0xf), iVar3), (long)iVar3);
            uVar7 = __aFulmul((ulong)CONCAT62(CONCAT42((long)iVar2, iVar2 >> 0xf), iVar2), (long)iVar2);
...

{
    ...
    if ((iVar1 < 1000) || (iVar2 < 1000)) {
        ...
        while ((THING *)lpth < (THING *)lpThings + cThing) {
            ...
            if (((iVar1 == (&((THING *)lpth)->pt)->x) && (iVar2 == (((THING *)lpth)->pt).y)) && (lpthWorm != lpth)) {
                return 0xf;
            }
            lpth = (THING *)CONCAT22(uVar10, (THING *)lpth + 1);
        }
        for (i = 0; i < game.cPlanMax; i = i + 1) {
            if ((iVar1 == ((POINT *)rgptPlan + i)->x) && (iVar2 == *(int *)((int)&rgptPlan[0].y + i * 4))) {
                return 0xf;
            }
        }
...

{
    ...
    pct = (((&((THING *)lpth)->u_THING_0x0006)->thp).wFlags >> 2 & 0x3ff) / 5 - (2 - (((&((THING *)lpth)->u_THING_0x0006)->thp).wFlags & 3));
    if (pct < 0) {
        pct = 0;
    } else if (6 < pct) {
        pct = 6;
            ...
            if (lpth->idFull >> 0xd == 3) {
                ...
                for (ifl = 0; ifl < cFleet; ifl = ifl + 1) {
                    ...
                    if (((pFVar9->wFlags_0x4 >> 10 & 1) == 0) && (((&pFVar9->pt)->x == iVar7 && ((pFVar9->pt).y == iVar8)))) {
                        ...
                        for (i = 0; i < 3; i = i + 1) {
                            ...
                            bVar25 = CARRY2((uint)(char *)wtMin, uVar11);
                        ...
                        if ((wtMin._2_2_ < 1) && ((wtMin._2_2_ < 0 || ((char *)wtMin <= (char *)"Stars!" + 2)))) {
                            ...
                            if ((*(uint *)((int)&rgplr[0].wFlags + pFVar9->iPlayer * 0xc0) >> 1 & 1) == 0) {
                            ...
                            fMaxTech = (short)(i == 6);
                            uVar11 = *(uint *)((int)&rgplr[0].grbitTrader + pFVar9->iPlayer * 0xc0);
                            sVar13 = pFVar9->iPlayer;
                            bVar14 = (byte)sVar13;
                            uVar23 = (undefined2)((ulong)lpth >> 0x10);
                            if ((1 << (bVar14 & 0x1f) & *(uint *)((int)&((THING *)lpth)->u_THING_0x0006 + 6)) == 0) {
                                puVar3 = (uint *)((int)&((THING *)lpth)->u_THING_0x0006 + 6);
                                *puVar3 = *puVar3 | 1 << (bVar14 & 0x1f);
                                FRemovePlayerMessage(sVar13, idmHasCompletedAssignedOrders, lpfl->id | 0x8000);
                                ...
                                if ((*(int *)((int)&((THING *)lpth)->u_THING_0x0006 + 8) == 0) ||
                                    ((*(uint *)((int)&((THING *)lpth)->u_THING_0x0006 + 8) & uVar11) != 0)) {
                                    if (fMaxTech == 0) {
                                        local_52 = 0;
                                        lVar26 = __aFldiv(
                                            ...
                                            if (local_52 < 0x60) {
                                                if (local_52 < 0x54) {
                                                    if (local_52 < 0x48) {
                                                        ...
                                                        pPVar28 = (PLANET *)CONCAT22(local_4e._2_2_ - ((PLANET *)local_4e < (PLANET *)0x2),
                                                                                     (PLANET *)((int)&((PLANET *)local_4e)[-1].lpplprod + 2));
                                                    }
                                                } else {
                                                    pPVar28 = (PLANET *)CONCAT22(local_4e._2_2_ - ((PLANET *)local_4e < (PLANET *)0x3),
                                        ...
                                        FSendPlrMsg((uint)lpfl->id >> 9 & 0xf, idm, -1, uVar10, (short)pPVar30, sVar31, p4, p5, p6, p7);
                                        pPVar28 = local_4e;
                                        while (true) {
                                            local_4e._2_2_ = (uint)((ulong)pPVar28 >> 0x10);
                                            local_4e._0_2_ = (PLANET *)pPVar28;
                                            ...
                                            if (sVar31 < 3) {
                                                local_50 = Random(6);
                                                lVar26 = local_5a;
                                                if (cPlrTrueMaxTech <= *(char *)(sVar13 * 0xc0 + 0x59bc + local_50))
                                                    goto LAB_1110_1010;
                                            } else {
                                            LAB_1110_1010:
                                                ...
                                                while (true) {
                                                    ...
                                                    if (5 < i)
                                                        break;
                                                    local_5a._2_2_ = (int)*(char *)(sVar13 * 0xc0 + 0x59bc + i);
                                                    if (local_5a._2_2_ < *(char *)(sVar13 * 0xc0 + 0x59bc + local_50)) {
                                                        local_50 = i;
                                                    }
                                                    i = i + 1;
                                                }
                                            ...
                                            local_5a = lVar26;
                                            _memcpy(rgTech, (void *)((int)rgplr[0].rgTech + sVar13 * 0xc0), 6);
                                            sVar31 = idPlayer;
                                            rgTech[local_50] = rgTech[local_50] + 1;
                                            idPlayer = sVar13;
                                            lVar26 = CostOfDevelopingItem((char *)rgTech);
                                            puVar18 = (undefined2 *)(sVar13 * 0xc0 + 0x59c2 + local_50 * 4);
                                        ...
                                        sVar31 = Random(5);
                                        if (sVar31 != 0)
                                            goto THING_LGivePart;
                                        idm = 0x10e;
                                        sVar13 = 0;
                                        uVar10 = WFromLpfl(lpfl);
                                        FSendPlrMsg2((uint)lpfl->id >> 9 & 0xf, idm, -1, uVar10, sVar13);
                                    }
                                } else {
                                THING_LGivePart:
                                    local_50 = 0x19;
                                    ...
                                    while ((((uint)(PLANET *)local_4e & uVar11) != 0 &&
                                            (iVar15 = local_50 + -1, bVar25 = 0 < local_50, local_50 = iVar15, bVar25))) {
                                        sVar31 = Random(0xd);
                                        local_4e._0_2_ = (PLANET *)(1 << ((byte)sVar31 & 0x1f));
                                    }
                                    if (local_50 < 1) {
                                    ...
                                    *puVar3 = *puVar3 | 1 << (bVar14 & 0x1f);
                                    if ((PLANET *)local_4e == (PLANET *)0x1000) {
                                        if ((*(uint *)((int)&rgplr[0].wMdPlr + sVar13 * 0xc0) >> 9 & 1) == 0) {
                                            ...
                                            pSVar16 = (SHDEF *)pSVar27 + local_52 + 0x13;
                                            pHVar21 = &local_e8;
                                            for (iVar15 = 0x49; iVar15 != 0; iVar15 = iVar15 + -1) {
                                                ...
                                                pHVar6->ihuldef = (pSVar27->hul).ihuldef;
                                            }
                                            *&pHVar21->ihuldef = (char)(pSVar16->hul).ihuldef;
                                            uVar11 = IshFindSimilarDesign(&local_e8, sVar13);
                                            local_56._2_2_ = uVar11;
                                            if ((int)uVar11 < 0) {
                                                do {
                                                    local_56._2_2_ = local_56._2_2_ + 1;
                                                    if (0xf < (int)local_56._2_2_)
                                                        break;
                                                } while ((*(uint *)(*(int *)(sVar13 * 4 + rglpshdef) + local_56._2_2_ * 0x93 + 0x7b) >> 9 & 1) == 0);
                                            }
                                            if (((int)local_56._2_2_ < 0x10) &&
                                                ((*(uint *)((int)&rgplr[0].wFlags_0x4 + ((uint)lpfl->id >> 9 & 0xf) * 0xc0) & 0xfff) < 0x200)) {
                                                sVar31 = Random(3);
                                                if (sVar31 == 0) {
                                                    cGive = 2;
                                                } else {
                                                ...
                                                if ((pFVar9 != 0) || (iVar15 != 0)) {
                                                    ...
                                                    pFVar19 = (FLEET *)lpfl;
                                                    sVar31 = (pFVar19->pt).y;
                                                    (&pFVar9->pt)->x = (&pFVar19->pt)->x;
                                                    (pFVar9->pt).y = sVar31;
                                                    sVar31 = (pFVar19->pt).y;
                                                    uVar24 = (undefined2)((ulong)pFVar9->lpplord >> 0x10);
                                                    pPVar20 = (PLORD *)pFVar9->lpplord;
                                                    (pPVar20 + 1)->wFlags = (&pFVar19->pt)->x;
                                                    *(short *)&pPVar20[1].iordMax = sVar31;
                                                    pFVar9->wFlags_0x4 = pFVar9->wFlags_0x4 & 0xdfff | 0x2000;
                                                    uVar23 = *(undefined2 *)(sVar13 * 4 + rglpshdef_0x2);
                                                    pSVar16 = (SHDEF *)(*(int *)(sVar13 * 4 + rglpshdef) + local_56._2_2_ * 0x93);
                                                    if ((pSVar16->wFlags >> 9 & 1) != 0) {
                                                        pHVar21 = &local_e8;
                                                        pSVar22 = pSVar16;
                                                        for (iVar17 = 0x49; iVar17 != 0; iVar17 = iVar17 + -1) {
                                                            ...
                                                            pHVar6 = pHVar21;
                                                            pHVar21 = pHVar21->rgTech;
                                                            (pSVar27->hul).ihuldef = pHVar6->ihuldef;
                                                        }
                                                        *&(pSVar22->hul).ihuldef = (char)pHVar21->ihuldef;
                                                        pSVar16->wFlags = pSVar16->wFlags & 0x83ff | (local_56._2_2_ & 0x1f) << 10;
                                                        pSVar16->wFlags = pSVar16->wFlags & 0x7fff | 0x8000;
                                                        *(undefined2 *)&pSVar16->cBuilt = 0;
                                                        *(undefined2 *)((int)&pSVar16->cBuilt + 2) = 0;
                                                        *(undefined2 *)&pSVar16->cExist = 0;
                                                        *(undefined2 *)((int)&pSVar16->cExist + 2) = 0;
                                                        pcVar4 = (char *)((int)&rgplr[0].cShDef + sVar13 * 0xc0);
                                                        *pcVar4 = *pcVar4 + '\x01';
                                                        idPlayer = (uint)lpfl->id >> 9 & 0xf;
                                                        UpdateShdefCost((SHDEF *)CONCAT22(uVar23, pSVar16));
                                                        idPlayer = -1;
                                                    }
                                                    puVar1 = &pSVar16->cBuilt;
                                                    uVar29 = *puVar1;
                                                    *puVar1 = (uint)*puVar1 + cGive;
                                                    piVar2 = (int *)((int)&pSVar16->cBuilt + 2);
                                                    *piVar2 = *piVar2 + (cGive >> 0xf) + (uint)CARRY2((uint)uVar29, cGive);
                                                    puVar1 = &pSVar16->cExist;
                                                    uVar29 = *puVar1;
                                                    *puVar1 = (uint)*puVar1 + cGive;
                                                    piVar2 = (int *)((int)&pSVar16->cExist + 2);
                                                    *piVar2 = *piVar2 + (cGive >> 0xf) + (uint)CARRY2((uint)uVar29, cGive);
                                                    pFVar9->rgcsh[local_56._2_2_] = cGive;
                                                    lVar26 = LGetFleetStat(lpfl_00, grStatFuel);
                                                    *(int *)(pFVar9->rgwtMin + 4) = (int)lVar26;
                                                    *(undefined2 *)((int)pFVar9->rgwtMin + 0x12) = (int)((ulong)lVar26 >> 0x10);
                                                    goto LAB_1110_15e6;
                                                }
                                            }
                                            sVar13 = 0;
                                            uVar10 = WFromLpfl(lpfl);
                                            FSendPlrMsg2((uint)lpfl->id >> 9 & 0xf, idmHasAbsorbedMysteryTraderReturnTraderTried, -1, uVar10, sVar13);
                                        }
                                    LAB_1110_15e6:
                                    } else {
                                        idm = IdmGiveTraderPart((ushort)(PLANET *)local_4e, sVar13, (ushort *)((int)&local_4e + 2));
                                        sVar13 = 0;
                                        uVar10 = WFromLpfl(lpfl);
                                        FSendPlrMsg2((uint)lpfl->id >> 9 & 0xf, idm, local_4e._2_2_, uVar10, sVar13);
                                    }
                                }
                            } else {
                                FSendPlrMsg2((uint)lpfl->id >> 9 & 0xf, idmMysteryTraderEyesCaptainSuspiciouslySuggestsHe, lpfl->id | 0x8000, lpfl->id, 0);
                            }
                        }
                    }
                }
                ...
                while ((PLANET *)lppl < (PLANET *)lpplMac) {
                    ...
                    if ((((((PLANET *)lppl)->iPlayer != -1) && ((((PLANET *)lppl)->wFlags_0x4 >> 9 & 1) != 0)) &&
                         ((*(uint *)((int)&rgplr[0].wMdPlr + ((PLANET *)lppl)->iPlayer * 0xc0) >> 9 & 1) != 0)) &&
                        ((1 < (*(uint *)((int)&rgplr[0].wMdPlr + ((PLANET *)lppl)->iPlayer * 0xc0) >> 10 & 7) &&
                          ((1 << ((byte)((PLANET *)lppl)->iPlayer & 0x1f) & *(uint *)((int)&((THING *)lpth)->u_THING_0x0006 + 6)) == 0)))) {
                        dx._0_2_ = ((POINT *)rgptPlan + lppl->id)->x - iVar7;
                        dx._2_2_ = (int)(uint)dx >> 0xf;
                        if ((-1 < dx._2_2_) && ((0 < dx._2_2_ || (100 < (uint)dx))))
                            break;
                        ...
                        if (l < 0x2711) {
                            ...
                            while (true) {
                                if (2 < i)
                                    break;
                                uVar11 = *(uint *)(((PLANET *)lppl)->rgwtMin + i);
                                bVar25 = CARRY2((uint)(char *)wtNext, uVar11);
                                wtNext._0_2_ = (char *)wtNext + uVar11;
                                wtNext._2_2_ = wtNext._2_2_ + *(uint *)((int)(((PLANET *)lppl)->rgwtMin + i) + 2) + (uint)bVar25;
                                i = i + 1;
                            }
                            iVar15 = ((PLANET *)lppl)->iPlayer;
                            ...
                            if ((0 < wtNext._2_2_) || ((-1 < wtNext._2_2_ && (pcVar12 <= (char *)wtNext)))) {
                                ...
                                THING_LAutoTech:
                                    local_4e._2_2_ = 0;
                                    for (i = 0; i < 6; i = i + 1) {
                                        local_4e._2_2_ = local_4e._2_2_ + (int)*(char *)(iVar15 * 0xc0 + 0x59bc + i);
                                    }
                                    if ((*(uint *)((int)&rgplr[0].wFlags + ((FLEET *)lpfl)->iPlayer * 0xc0) >> 1 & 1) == 0) {
                                        cPlrTrueMaxTech = 0x1a;
                                    } else {
                                        cPlrTrueMaxTech = 10;
                                    }
                                    ...
                                    for (local_4e._0_2_ = 0; (int)(PLANET *)local_4e < 6; local_4e._0_2_ = (PLANET *)((int)&((PLANET *)local_4e)->id + 1)) {
                                        ...
                                        for (i = 1; i < 6; i = i + 1) {
                                            ...
                                            if (local_50 < *(char *)(iVar15 * 0xc0 + 0x59bc + local_4e._2_2_)) {
                                                local_4e._2_2_ = i;
                                            }
                                        }
                                        pcVar4 = (char *)(iVar15 * 0xc0 + 0x59bc + local_4e._2_2_);
                                        *pcVar4 = *pcVar4 + '\x01';
                                    }
                                    wtNext._2_2_ = 0;
                                    wtNext._0_2_ = pcVar12;
                                } else {
                                    local_4e._0_2_ = (PLANET *)(rgcrPlrHistory + 1);
                                    local_4e._2_2_ = *(uint *)((int)&((THING *)lpth)->u_THING_0x0006 + 8);
                                    while (((local_4e._2_2_ & *(uint *)((int)&rgplr[0].grbitTrader + iVar15 * 0xc0)) != 0 &&
                                            (pPVar30 = (PLANET *)((int)&((PLANET *)local_4e)[-1].lpplprod + 3), bVar25 = 0 < (int)(PLANET *)local_4e,
                                             local_4e._0_2_ = pPVar30, bVar25))) {
                                        sVar13 = Random(0xd);
                                        local_4e._2_2_ = 1 << ((byte)sVar13 & 0x1f);
                                    }
                                    if ((int)(PLANET *)local_4e < 1)
                                        goto THING_LAutoTech;
                                    puVar3 = (uint *)((int)&rgplr[0].grbitTrader + iVar15 * 0xc0);
                                ...
                                for (i = 2; (-1 < wtNext._2_2_ && (((0 < wtNext._2_2_ || ((char *)wtNext != 0)) && (-1 < i)))); i = i + -1) {
                                    ...
                                    if (((int)uVar11 < wtNext._2_2_) ||
                                        ((pcVar12 = (char *)wtNext, iVar15 = wtNext._2_2_,
                                          (int)uVar11 <= wtNext._2_2_ && (*(char **)(((PLANET *)lppl)->rgwtMin + i) <= (char *)wtNext)))) {
                                        pcVar12 = *(char **)(((PLANET *)lppl)->rgwtMin + i);
                                        iVar15 = *(int *)((int)(((PLANET *)lppl)->rgwtMin + i) + 2);
                                    }
                                    puVar3 = (uint *)(((PLANET *)lppl)->rgwtMin + i);
                                    pcVar5 = (char *)*puVar3;
                                    *puVar3 = *puVar3 - (int)pcVar12;
                                    puVar3 = (uint *)((int)(((PLANET *)lppl)->rgwtMin + i) + 2);
                                    *puVar3 = (*puVar3 - iVar15) - (uint)(pcVar5 < pcVar12);
                                    bVar25 = (char *)wtNext < pcVar12;
                                    wtNext._0_2_ = (char *)wtNext + -(int)pcVar12;
                                    wtNext._2_2_ = (wtNext._2_2_ - iVar15) - (uint)bVar25;
                                }
                            }
                        }
                    }
