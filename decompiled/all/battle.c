...

{
    ...
    if (message == WM_DESTROY) {
        ...
        if (message == WM_PAINT) {
            ...
            HVar2 = GetDlgItem(hwnd, IDC_U16_0x07D5);
            GetWindowRect(HVar2, &rcGBox);
            ScreenToClient(hwnd, (POINT *)&rcGBox);
            HVar2 = GetDlgItem(hwnd, IDC_U16_0x07D6);
            ...
            TextOut(hdc, rcGBox.left + 8, rcGBox.top - (dyArial8 >> 1), szWork, sVar3);
        ...
        if (message == WM_CTLCOLOR) {
            ...
            if (message == WM_INITDIALOG) {
                ...
                CheckRadioButton(hwnd, 0x7d4, 0x7d6, *(char *)(idPlayer * 0xc0 + 0x5a12 + (uint)(idPlayer == 0)) + 0x7d4);
                ...
                HVar2 = GetDlgItem(hwnd, IDC_U16_0x07D3);
                SendMessage(HVar2, CB_GETCURSEL, 0, 0);
                fDirtyPlan = 0;
                goto LAB_10f0_0177;
            }
            if (message == WM_COMMAND) {
                if (wParam == 2) {
                    ...
                    HVar2 = GetDlgItem(hwnd, IDC_U16_0x07D3);
                    LVar4 = SendMessage(HVar2, CB_GETLBTEXTLEN, 0, 0);
                    i = (short)LVar4;
                    if (idPlayer <= i) {
                        i = i + 1;
                    }
...

{
    ...
    if (message == WM_CTLCOLOR) {
        ...
        if (message == WM_INITDIALOG) {
            SetWindowPos(hwnd, 0, ptStickyBattlePlansDlg.x + 0x46, ptStickyBattlePlansDlg.y + 0x46, 0, 0, 0x15);
...

{
    ...
    if (message == WM_INITDIALOG) {
        ...
        puVar11 = (ushort *)(*(int *)((BTLPLAN **)rglpbtlplan + idPlayer) + iPlanSelDlg * 0x24);
        ...
        for (i = 0; i < (int)(uint)((byte *)rgcbtlplan)[idPlayer]; i = i + 1) {
            ...
            SendMessage(
                HVar6, CB_ADDSTRING, 0,
                CONCAT22(*(undefined2 *)((int)(BTLPLAN **)rglpbtlplan + idPlayer * 4 + 2), *(int *)((BTLPLAN **)rglpbtlplan + idPlayer) + i * 0x24 + 4));
        }
        HVar6 = GetDlgItem(hwnd, IDC_U16_0x041E);
        SendMessage(HVar6, CB_SETCURSEL, iPlanSelDlg, 0);
        ...
        HVar6 = GetDlgItem(hwnd, IDC_U16_0x0421);
        SendMessage(HVar6, CB_SETCURSEL, btlplan.wFlags >> 8 & 0xf, 0);
        ...
        HVar6 = GetDlgItem(hwnd, IDC_U16_0x041F);
        SendMessage(HVar6, CB_SETCURSEL, btlplan.wFlags_0x2 & 0xf, 0);
        if ((game.wCrap >> 2 & 1) == 0) {
            ...
            HVar6 = GetDlgItem(hwnd, IDC_U16_0x0422);
            SendMessage(HVar6, CB_SETCURSEL, i, 0);
        } else {
            HVar6 = GetDlgItem(hwnd, IDC_U16_0x0422);
            WVar16 = CB_ADDSTRING;
            WVar15 = 0;
            ...
            SendMessage(HVar6, WVar16, WVar15, (LPARAM)pcVar5);
            HVar6 = GetDlgItem(hwnd, IDC_U16_0x0422);
            SendMessage(HVar6, CB_SETCURSEL, 0, 0);
            HVar6 = GetDlgItem(hwnd, IDC_U16_0x0422);
        ...
        HVar6 = GetDlgItem(hwnd, IDC_U16_0x0420);
        SendMessage(HVar6, CB_SETCURSEL, btlplan.wFlags_0x2 >> 4 & 0xf, 0);
        HVar6 = GetDlgItem(hwnd, IDC_U16_0x041D);
        SendMessage(HVar6, CB_LIMITTEXT, btlplan.wFlags >> 0xf, 0);
        fDirtyPlan = 0;
    ...
    if (wParam == 0x817) {
        ...
        LogChangeBtlplan((BTLPLAN *)&btlplan);
        HVar6 = GetDlgItem(hwnd, IDC_U16_0x041E);
        SendMessage(HVar6, CB_SETCURSEL, iPlanSelDlg - 1, 0);
        HVar6 = GetDlgItem(hwnd, IDC_U16_0x041E);
        SendMessage(HVar6, CB_RESETCONTENT, 0, 0);
        for (i = 0; i < (int)(uint)((byte *)rgcbtlplan)[idPlayer]; i = i + 1) {
            HVar6 = GetDlgItem(hwnd, IDC_U16_0x041E);
            SendMessage(
                HVar6, CB_ADDSTRING, 0,
    ...
    BATTLE_LSelectName:
        HVar6 = GetDlgItem(hwnd, IDC_U16_0x041E);
        LVar14 = SendMessage(HVar6, CB_GETCURSEL, 0, 0);
        iVar9 = (int)LVar14;
        if (iVar9 != iPlanSelDlg) {
            ...
            uVar4 = *(undefined2 *)((int)(BTLPLAN **)rglpbtlplan + idPlayer * 4 + 2);
            puVar11 = (ushort *)(*(int *)((BTLPLAN **)rglpbtlplan + idPlayer) + iVar9 * 0x24);
            pBVar12 = (BTLPLAN *)&btlplan;
            iPlanSelDlg = iVar9;
            for (iVar10 = 0x12; iVar10 != 0; iVar10 = iVar10 + -1) {
                pBVar3 = pBVar12;
        ...
        if (wParam == 0x420) {
            ...
            LVar14 = SendMessage(HVar6, CB_GETCURSEL, 0, 0);
            fDirtyPlan = 1;
            btlplan.wFlags_0x2 = btlplan.wFlags_0x2 & 0xff0f | ((uint)LVar14 & 0xf) << 4;
            return 0;
        }
        if (wParam == 0x422) {
            HVar6 = GetDlgItem(hwnd, IDC_U16_0x0422);
        ...
        sVar7 = DialogBox(0, IDD_RENAME, hwndFrame, lpDlgProc);
    ...
    do {
        ...
        if ((fWarn == 0) || (!bVar6)) {
            ...
            for (i = iplan; i < (int)(uint)((byte *)rgcbtlplan)[idPlayer]; i = i + 1) {
                uVar4 = *(undefined2 *)((int)(BTLPLAN **)rglpbtlplan + idPlayer * 4 + 2);
                puVar8 = (undefined2 *)(*(int *)((BTLPLAN **)rglpbtlplan + idPlayer) + (i + 1) * 0x24);
                uVar5 = *(undefined2 *)((int)(BTLPLAN **)rglpbtlplan + idPlayer * 4 + 2);
                puVar9 = (undefined2 *)(*(int *)((BTLPLAN **)rglpbtlplan + idPlayer) + i * 0x24);
                ...
                *(uint *)(*(int *)((BTLPLAN **)rglpbtlplan + idPlayer) + i * 0x24) =
                    *(uint *)(*(int *)((BTLPLAN **)rglpbtlplan + idPlayer) + i * 0x24) & 0xff0f | (i & 0xfU) << 4;
            }
            return 1;
        }
        fWarn = 0;
        ...
        for (ifl = 0; ifl < cFleet; ifl = ifl + 1) {
            ...
            if (((pFVar2->wFlags_0x4 >> 10 & 1) == 0) && (rgfCheater[pFVar2->iPlayer] != '\0')) {
                ...
                if (sVar7 == 0) {
                    ...
                    FSendPlrMsg2(pFVar2->iPlayer, idmHasDefectedRanksDueInabilityProjectLegitimate, -5, lpfl->id, 0);
                } else {
                    bVar5 = false;
                    for (i = 0; i < 3; i = i + 1) {
                        ...
                        if ((-1 < iVar3) && ((0 < iVar3 || ((int)pFVar2->rgwtMin[i] != 0)))) {
                            ...
                            lVar13 = 100;
                            uVar12 = __aFulmul(CONCAT22(*(undefined2 *)((int)(pFVar2->rgwtMin + i) + 2), (int)pFVar2->rgwtMin[i]),
                    ...
                    if (bVar5) {
                        FSendPlrMsg2(pFVar2->iPlayer, idmCrewHasSoldOffCargoBlackMarket, -5, lpfl->id, (int)pctSell);
                    }
                }
            }
        }
            ...
            if ((((PLANET *)lppl)->iPlayer != -1) && (rgfCheater[((PLANET *)lppl)->iPlayer] != '\0')) {
                ...
                if (((uVar12 & 0xfff) == 0) || (sVar7 = Random(8), sVar7 != 0)) {
                    ...
                    if (sVar7 == 0) {
                        ...
                        sVar8 = Random(0x29);
                        lVar13 = 100;
                        uVar12 = __aFulmul(CONCAT22(*(undefined2 *)((int)(((PLANET *)lppl)->rgwtMin + sVar7) + 2), (int)((PLANET *)lppl)->rgwtMin[sVar7]),
                                           (long)(sVar8 + 5));
                        lVar13 = __aFldiv(uVar12, lVar13);
                        if (0 < lVar13) {
                            if (30000 < lVar13) {
                            ...
                            *puVar1 = (*puVar1 - lSell._2_2_) - (uint)(uVar6 < (uint)lSell);
                            FSendPlrMsg(((PLANET *)lppl)->iPlayer, idmFreedomFightersHaveStolenKtStockpilesPress, -5, lppl->id, (uint)lSell, sVar7 + 1, 0, 0, 0,
                                        0);
                        }
                    }
                } else {
                    ...
                    *(uint *)(((PLANET *)lppl)->rgbImp + 2) = *(uint *)(((PLANET *)lppl)->rgbImp + 2) | iVar4 - (uint)(uVar6 < (uint)lSell * 0x100) & 0xf;
                    FSendPlrMsg2(((PLANET *)lppl)->iPlayer, idmFreedomFightersHaveAttackedDestroyedMinesPress, -5, lppl->id, (uint)lSell);
                }
            }
...

{
    ...
    while (true) {
        ...
        if (((lphs->grhst == hstBeam) && ((((HS *)lphs)->wFlags_0x2 & 0xff) == 0x12)) && (((HS *)lphs)->wFlags_0x2 >> 8 != 0)) {
            return 1;
        }
        if (((lphs->grhst == hstSpecialM) && ((((HS *)lphs)->wFlags_0x2 & 0xff) == 1)) && (((HS *)lphs)->wFlags_0x2 >> 8 != 0))
            break;
        ihs = ihs + 1;
        lphs = (HS *)lphs + 1;
    }
    ...
    while (true) {
        ...
        if (((((FLEET *)lpfl)->rgcsh[ishdef] != 0) &&
             (iVar2 = ((uint)lpfl->id >> 9 & 0xf) * 4,
              sVar1 = FHullHasTeeth((HUL *)CONCAT22(*(undefined2 *)(iVar2 + rglpshdef_0x2), (HUL *)(*(int *)(iVar2 + rglpshdef) + ishdef * 0x93))),
              sVar1 != 0)) &&
            (iVar2 = ((uint)lpfl->id >> 9 & 0xf) * 4, (*(uint *)(*(int *)(iVar2 + rglpshdef) + ishdef * 0x93 + 0x7b) & 0xff) == 7))
            break;
        ishdef = ishdef + 1;
    }
    return 1;
...

{
    ...
    pBVar5 = (BTLPLAN *)(*(int *)((BTLPLAN **)rglpbtlplan + uVar2) + (uint)((FLEET *)lpfl)->iplan * 0x24);
...

{
    ...
    i = 0;
    while (true) {
        if (((2 < i) || ((int)((FLEET *)lpfl)->rgwtMin[i] != 0)) || (*(int *)((int)(((FLEET *)lpfl)->rgwtMin + i) + 2) != 0))
            break;
        i = i + 1;
    }
    if (i < 3) {
        uVar6 = (uint)lpfl->id >> 9 & 0xf;
        if (*(int *)(*(int *)((BTLPLAN **)rglpbtlplan + uVar6) + (uint)((FLEET *)lpfl)->iplan * 0x24) < 0) {
            if (((FLEET *)lpfl)->idPlanet == -1) {
                pt.x = (&((FLEET *)lpfl)->pt)->x;
                pt.y = (((FLEET *)lpfl)->pt).y;
                DropSalvage((THING **)&lpthBattle, (long *)CONCAT22(lpfl._2_2_, ((FLEET *)lpfl)->rgwtMin), (uint)lpfl->id >> 9 & 0xf, &pt);
            } else {
...

{
    ...
    for (i = 0; i < game.cPlanMax; i = i + 1) {
        if ((ppt->x == ((POINT *)rgptPlan + i)->x) && (ppt->y == *(int *)((int)&rgptPlan[0].y + i * 4))) {
            return;
        }
    }
    i = 0;
    ...
    if ((pTVar7 == (THING *)0x0) && (pTVar2 == (THING *)0x0)) {
        ...
        (&pTVar7->pt)->x = ppt->x;
        (pTVar7->pt).y = sVar4;
        ((&pTVar7->u_THING_0x0006)->thp).wFlags = ((&pTVar7->u_THING_0x0006)->thp).wFlags & 0xfc00 | 0x3ff;
    } else {
        for (i = 0; i < 3; i = i + 1) {
        ...
        *(uint *)((int)&pTVar7->u_THING_0x0006 + 8) = *(uint *)((int)&pTVar7->u_THING_0x0006 + 8) & 0xc000;
    }
    ...
    do {
        ...
        for (i = 0; i < 3; i = i + 1) {
            ...
            puVar1 = (uint *)((long *)rgwtMinerals + i);
            iVar6 = (int)(uVar10 >> 0x10) + *(uint *)((int)((long *)rgwtMinerals + i) + 2) + (uint)CARRY2((uint)uVar10, *puVar1);
            if ((iVar6 < 0) || ((iVar6 < 1 && ((uint)uVar10 + *puVar1 < 0x7531)))) {
                uVar5 = *(uint *)((long *)rgwtMinerals + i);
                lVar11 = __aFldiv(CONCAT22(*(uint *)((int)((long *)rgwtMinerals + i) + 2) + (uint)(0xfff6 < uVar5), uVar5 + 9), 10);
                ...
                *(int *)((pTVar7->u_THING_0x0006).rgb + i * 2 + 2) = *(int *)((pTVar7->u_THING_0x0006).rgb + i * 2 + 2) + (int)((long *)rgwtMinerals)[i];
                uVar5 = *(uint *)((long *)rgwtMinerals + i);
                wtTotal._2_2_ = (wtTotal._2_2_ - *(uint *)((int)((long *)rgwtMinerals + i) + 2)) - (uint)((uint)wtTotal < uVar5);
                ...
                *(uint *)((int)&pTVar7->u_THING_0x0006 + 8) = *(uint *)((int)&pTVar7->u_THING_0x0006 + 8) & 0xc000 | 3000;
                *(uint *)((pTVar7->u_THING_0x0006).rgb + i * 2 + 2) = *(int *)((pTVar7->u_THING_0x0006).rgb + i * 2 + 2) + uVar5;
                puVar1 = (uint *)((long *)rgwtMinerals + i);
                uVar3 = *puVar1;
                *puVar1 = *puVar1 - uVar5;
                puVar1 = (uint *)((int)((long *)rgwtMinerals + i) + 2);
    ...
    *pgrfSpectator = 0;
    ...
    if (((FLEET *)lpfl)->idPlanet != -1) {
        ...
        if ((pPVar6->wFlags_0x4 >> 9 & 1) == 0) {
            ...
            uVar11 = ((BTLPLAN *)((BTLPLAN **)rglpbtlplan)[iplrStarbase])->wFlags_0x2 >> 8 & 0x1f;
            sVar8 = FHullHasTeeth((HUL *)CONCAT22(*(undefined2 *)(iplrStarbase * 4 + rglpshdefSB_0x2),
                                                  (HUL *)(*(int *)(iplrStarbase * 4 + rglpshdefSB) + (*(uint *)&pPVar6->lStarbase & 0xf) * 0x93)));
            if ((sVar8 != 0) && (uVar11 != 0)) {
                if ((uVar11 == 1) || (uVar11 == 2)) {
                    for (i = 0; i < game.cPlayer; i = i + 1) {
                        if ((i != iplrStarbase) &&
                            ((cVar3 = *(char *)(iplrStarbase * 0xc0 + 0x5a12 + i), cVar3 == '\x02' || ((cVar3 == '\0' && (uVar11 == 2)))))) {
    ...
    do {
        ...
        if ((pFVar10->wFlags_0x4 >> 10 & 1) == 0) {
            ...
            if ((((*(uint *)(*(int *)((BTLPLAN **)rglpbtlplan + uVar11) + (uint)pFVar10->iplan * 0x24 + 2) & 0xf) != 0) &&
                 (uVar11 = (uint)lpflCur->id >> 9 & 0xf,
                  (*(uint *)(*(int *)((BTLPLAN **)rglpbtlplan + uVar11) + (uint)pFVar10->iplan * 0x24 + 2) >> 8 & 0x1f) != 0)) &&
                (sVar8 = FFleetHasTeeth(lpflCur), sVar8 != 0)) {
                bVar7 = true;
                iplrAttack = *(uint *)(*(int *)((BTLPLAN **)rglpbtlplan + iVar4) + (uint)pFVar10->iplan * 0x24 + 2) >> 8 & 0x1f;
                uVar11 = (uint)lpflCur->id >> 9 & 0xf;
                if ((*(uint *)(*(int *)((BTLPLAN **)rglpbtlplan + uVar11) + (uint)pFVar10->iplan * 0x24 + 2) & 0xf) == 0) {
                    iplrAttack = 0;
                }
                if (iplrAttack != 0) {
                    if ((iplrAttack == 1) || (iplrAttack == 2)) {
                        for (i = 0; i < game.cPlayer; i = i + 1) {
                            if ((i != iVar4) && ((cVar3 = *(char *)(iVar4 * 0xc0 + 0x5a12 + i), cVar3 == '\x02' || ((cVar3 == '\0' && (iplrAttack == 2)))))) {
        ...
        if (iplrAttack == 0) {
            ...
            do {
                ...
                if (((grfPlayer & uVar11) != 0) && ((iplrAttack & uVar11) == 0)) {
                    rggrfAttack[iVar4] = 0;
                    for (i = 0; i < game.cPlayer; i = i + 1) {
                        if (((i != iVar4) && (*(char *)(iVar4 * 0xc0 + 0x5a12 + i) == '\x01')) && ((1 << ((byte)i & 0x1f) & iplrAttack) != 0)) {
                ...
                /* WARNING: Load size is inaccurate */
                lpflCur = (FLEET *)CONCAT22(*(undefined2 *)((int)&((FLEET *)lpflCur)->lpflNext + 2), ((FLEET *)lpflCur)->lpflNext);
                    ...
                    *pgrfSpectator = *pgrfSpectator | uVar11;
                    ...
                    for (ishdef = 0; ishdef < 0x10; ishdef = ishdef + 1) {
                        if (pFVar10->rgcsh[ishdef] != 0) {
                            pHVar14 = LphuldefFromId(*(HullDef *)(*(int *)(iVar4 * 4 + rglpshdef) + ishdef * 0x93));
                ...
                do {
                    ...
                    if ((pFVar10->wFlags_0x4 >> 8 & 1) != 0) {
                        ...
                        if ((int)(0xff / (long)cplr) < (int)((uint)rgctok[pFVar10->iPlayer] + ctokFleet)) {
                            ...
                            *(uint *)((int)&pFVar10->dirLong + 2) = *(uint *)((int)&pFVar10->dirLong + 2) & 0xff7f | 0x80;
                        } else {
                    ...
                    do {
                        ...
                        if ((*(uint *)((int)&pFVar10->dirLong + 2) >> 7 & 1) != 0) {
                            ...
                            if (ctokNew + ctokFleet < 0x100) {
                                ...
                                *(uint *)((int)&pFVar10->dirLong + 2) = *(uint *)((int)&pFVar10->dirLong + 2) & 0xff7f;
...

{
    ...
    if ((iEngine == -1) || (cEngineT == 0)) {
        ...
        if ((((iEngine == 7) || (iEngine == 8)) || (iEngine == 9)) || ((iEngine == 0xe || (iEngine == 0xf)))) {
            iWarp = 10;
        } else {
            for (iWarp = 9; (0 < iWarp && (0x78 < ((ENGINE *)pEVar13)->rgcFuelUsed[iWarp])); iWarp = iWarp + -1) {
            }
        }
        ...
        if (lpfl != (FLEET *)0x0) {
            ...
            if (uVar2 == 0) {
                ...
                uVar15 = __aFulmul(CONCAT22(*(int *)((int)pFVar6->rgwtMin + 2) + *(int *)((int)pFVar6->rgwtMin + 6) +
                                                (uint)CARRY2(*(uint *)pFVar6->rgwtMin, *(uint *)(pFVar6->rgwtMin + 1)) + *(int *)((int)pFVar6->rgwtMin + 10) +
                                                (uint)CARRY2(uVar4, *(uint *)(pFVar6->rgwtMin + 2)) + *(int *)((int)pFVar6->rgwtMin + 0xe) +
                                                (uint)CARRY2(uVar5, *(uint *)(pFVar6->rgwtMin + 3)),
                                            uVar5 + *(uint *)(pFVar6->rgwtMin + 3)),
                                   (ulong)uVar2);
...

{
    ...
    if (*(byte *)((int)&pTVar3->u_TOK_0x0003 + 1) < 0x10) {
        ...
        pSVar1 = (SHDEF *)(*(int *)(iVar4 + rglpshdef) + (uint) * (byte *)((int)&pTVar3->u_TOK_0x0003 + 1) * 0x93);
    } else {
        iVar4 = (uint)pTVar3->iplr * 4;
        uVar2 = *(undefined2 *)(iVar4 + rglpshdefSB_0x2);
        pSVar1 = (SHDEF *)(*(int *)(iVar4 + rglpshdefSB) + (*(byte *)((int)&pTVar3->u_TOK_0x0003 + 1) - 0x10) * 0x93);
    }
...

{
    ...
    if (((int)uVar4 < (int)uVar2) || (((int)uVar4 <= (int)uVar2 && (uVar3 <= uVar1)))) {
        if (((uVar2 & 0x7fff) < (uVar4 & 0x7fff)) || (((uVar2 & 0x7fff) <= (uVar4 & 0x7fff) && ((uVar1 & 0xf000) <= (uVar3 & 0xf000))))) {
            ...
            if (part.hs.grhst == hstShield) {
                ...
                case 0xd:
                    ...
                    for (i = part.hs.wFlags_0x2 >> 8; 0 < i; i = i + -1) {
                        ...
                        uVar9 = __aFulmul(uVar9, CONCAT22(((int)uVar2 >> 0xf) + (uint)(0xff9b < uVar2), uVar2 + 100));
                ...
                for (i = part.hs.wFlags_0x2 >> 8; 0 < i; i = i + -1) {
                    ...
                    uVar7 = 100;
                    uVar2 = ((ARMOR *)part.u_PART_0x0004.parmor)->dp;
                    uVar10 = __aFulmul(uVar10, CONCAT22(-(uint)(100 < uVar2) - ((int)uVar2 >> 0xf), 100 - uVar2));
...
void InitializeBoard(FLEET *lpfl, short ibrc, ushort grfPlayer, byte *pinit, short *pinitMin, short *pinitMac)

{
    ...
    if (((FLEET *)lpfl)->idPlanet != -1) {
        ...
        pPVar3 = (PLANET *)lppl;
        iplr = pPVar3->iPlayer;
        if (((iplr != -1) && ((pPVar3->wFlags_0x4 >> 9 & 1) != 0)) && ((1 << ((byte)iplr & 0x1f) & grfPlayer) != 0)) {
            uVar11 = (undefined2)((ulong)ptok >> 0x10);
            pTVar8 = (TOK *)ptok;
            *&pTVar8->u_TOK_0x0003 = 1;
            *(uint *)((int)&pPVar3->lStarbase + 2) = *(uint *)((int)&pPVar3->lStarbase + 2) & 0xbfff | 0x4000;
            ...
            *(char *)((int)&pTVar8->u_TOK_0x0003 + 1) = ((byte)(int)pPVar3->lStarbase & 0xf) + 0x10;
            ...
            (&pTVar8->dv)->dp = (&pTVar8->dv)->dp & 0x7f | (*(uint *)&((PLANET *)lppl)->lStarbase >> 4) << 7;
...
BATTLE_LTooManyTokens:
    ...
    while (true) {
        ...
        if ((((TOK *)ptokT)->dpShield == 0) || (sVar4 = GetRaceGrbit((PLAYER *)rgplr + ((TOK *)ptokT)->iplr, ibitRaceRegeneratingShields), sVar4 == 0)) {
            iVar5 = 0;
        } else {
            iVar5 = 1;
        }
        ...
        *(byte *)puVar9 = (byte)pTVar8->id;
        ...
        if ((((TOK *)ptokT)->initMin != 0xff) && ((initMin == -1 || ((int)(uint)((TOK *)ptokT)->initMin < initMin)))) {
            initMin = (short)((TOK *)ptokT)->initMin;
        }
        if ((((TOK *)ptokT)->initMac != 0xff) && ((initMac == -1 || (initMac < (int)(uint)((TOK *)ptokT)->initMac)))) {
    ...
    if ((fProximity == 0) && ((int)(((TOK *)ptok)->wFlags_0x19 & 0xf) < (int)uVar3)) {
        ...
        while (true) {
            ...
            if (((((pSVar7->hul).rghs + ihs)->grhst & (hstTorp | hstBeam)) !=
                ...
                FLookupPart(&part);
                idPlayer = -1;
                uVar4 = (uint)(*&((TOK *)ptok)->u_TOK_0x0003 == '\x01') + ((BEAM *)part.u_PART_0x0004.pbeam)->dRangeMax;
                iVar6 = (int)uVar4 >> 0xf;
                ...
                if ((!bVar2) || (fProximity != 0)) {
                    uVar13 = __aFulmul((long)((BEAM *)part.u_PART_0x0004.pbeam)->dp, (ulong)(part.hs.wFlags_0x2 >> 8));
                    if (part.hs.grhst == hstBeam) {
                        ...
                        if (((((BEAM *)part.u_PART_0x0004.pbeam)->grfAbilities & 1U) != 0) &&
                            (uVar14 = __aFulmul((ulong)((TOK *)ptokTarget)->dpShield, (ulong)((TOK *)ptok)->csh), (long)uVar14 < (long)uVar13)) {
                            uVar13 = uVar14;
                        }
                        if (bVar2) {
                            uVar5 = uVar3 + 10;
                            uVar13 = __aFldiv(uVar13, CONCAT22((((int)uVar5 >> 0xf) - iVar6) - (uint)(uVar5 < uVar4), uVar5 - uVar4));
                            if (((long)uVar13 < 0x10000) && (((long)uVar13 < 0 || ((uint)uVar13 < part.hs.wFlags_0x2 >> 8)))) {
                        ...
                        uVar12 = CTorpHit(uVar14, ptokTarget, ((BEAM *)part.u_PART_0x0004.pbeam)->grfAbilities, (uint)((TOK *)ptok)->pctBC);
                        lVar11 = 200;
                        uVar13 = __aFulmul((long)((BEAM *)part.u_PART_0x0004.pbeam)->dp, uVar12);
                        uVar13 = __aFldiv(uVar13, lVar11);
                        if (((TOK *)ptokTarget)->dpShield != 0) {
                            lVar11 = 0x640;
                            uVar14 = __aFulmul(uVar14 - uVar12, (long)((BEAM *)part.u_PART_0x0004.pbeam)->dp);
                            lVar11 = __aFldiv(uVar14, lVar11);
        ...
        uVar13 =
            __aFulmul((ulong)CONCAT12(CARRY2(((TOK *)ptokTarget)->dpShield, uVar3), ((TOK *)ptokTarget)->dpShield + uVar3), (ulong)((TOK *)ptokTarget)->csh);
        iVar6 = (int)uVar13;
        if (((&((TOK *)ptokTarget)->dv)->dp != 0) && (0 < (long)uVar13)) {
            ...
            if (((int)((ulong)lVar11 >> 0x10) < 1) && ((lVar11 < 0 || (uVar13 = uVar14, iVar6 == (int)lVar15)))) {
                uVar13 = 1;
            }
        }
        uVar14 = uVar1;
    ...
    *pbrc = 0xff;
    if ((pTVar4->wFlags_0x19 & 0xf) == 3) {
        ...
        while (true) {
            ...
            if ((int)(uint)(pSVar5->hul).chs <= ihs)
                break;
            if ((((pSVar5->hul).rghs + ihs)->grhst == hstBeam) && ((pSVar5->hul).rghs[ihs].wFlags_0x2 >> 8 != 0)) {
    ...
    do {
        ...
        if ((((pTVar8->iplr != bVar1) && ((1 << (pTVar8->iplr & 0x1f) & grfAttack) != 0)) && ((pTVar8->wFlags & 1) != 0)) &&
            ...
            if (((uint)dz <= (uint)dzMax) &&
                (((pTVar8->dpShield != 0 || (dzNonSapper == (pTVar4->wFlags_0x19 & 0xf))) || ((uint)dz <= dzNonSapper + (pTVar4->wFlags >> 0xe))))) {
                *pbrc = 0xff;
...

{
    ...
    if (uVar4 != 0) {
        for (itokLook = 0; itokLook < vctok; itokLook = itokLook + 1) {
            if ((((TOK *)vrgtok)[itokLook].iplr != bVar3) && ((1 << (((TOK *)vrgtok)[itokLook].iplr & 0x1f) & grfAttack) != 0)) {
...

{
    ...
    case 4:
        ...
        break;
    case 5:
        if (((pTVar2->wFlags_0x17 >> 0xc == 5) || (pTVar2->wFlags_0x17 >> 0xc == 7)) || (pTVar2->wFlags_0x17 >> 0xc == 6)) {
            uVar1 = 1;
        } else {
            uVar1 = 0;
        }
...

{
    ...
    for (itok = 0; itok < vctok; itok = itok + 1) {
        ...
        pTVar11 = (TOK *)ptok;
        if ((((pTVar11->wFlags & 1) != 0) && (bVar1 != pTVar11->iplr)) && ((1 << (pTVar11->iplr & 0x1f) & grfAttack) != 0)) {
            ...
            for (i = dMin; i <= dMax; i = i + 1) {
                ...
                dpGive_00 = DpFromPtokBrcToBrc(ptok, 0, (byte)((i & 0xfU) << 4), ptokSrc, (uint)((pTVar10->wFlags_0x17 >> 8 & 0xf) == 0));
...

{
    ...
    if ((*&pTVar7->u_TOK_0x0003 == '\x01') || (spdMove == 0))
        goto BATTLE_LReturnDxy;
    lVar4 = 30000000;
        ...
        for (y = yMin; y <= yMax; y = y + 1) {
            ...
            if (mdTactic == 0) {
                ...
                while (true) {
                    ...
                    if (vctok <= i)
                        break;
                    if ((((TOK *)vrgtok)[i].brc == brc_00) && (((TOK *)vrgtok)[i].iplr == bVar1)) {
                        lVar10 = lVar10 + 2;
                    }
                    i = i + 1;
                }
    ...
    if (1 < dzAway) {
        ...
        if (local_66[4] == sVar5) {
            ...
            for (i = 0; i < 3; i = i + 1) {
                ...
                if (((int)uVar2 <= local_66[4]) && (((int)uVar2 < local_66[4] || (*(uint *)(rgscoreNear[i] + dy) <= (uint)local_66[3])))) {
                    uVar2 = *(uint *)((int)(rgscoreNear[i] + dy) + 2);
                    if ((local_66[4] < (int)uVar2) || ((local_66[4] <= (int)uVar2 && ((uint)local_66[3] <= *(uint *)(rgscoreNear[i] + dy))))) {
            ...
            x = Random(local_66[2]);
            i = 0;
            while ((sVar5 = x, i < 3 && (((*(uint *)(rgscoreNear[i] + dy) != local_66[3] || (*(int *)((int)(rgscoreNear[i] + dy) + 2) != local_66[4])) ||
                                          (x = x + -1, sVar5 != 0))))) {
                i = i + 1;
            }
            xCur = xCur + i + -1;
            ...
            for (i = 0; i < 3; i = i + 1) {
                ...
                if (((int)uVar2 <= local_66[4]) && (((int)uVar2 < local_66[4] || (*(uint *)(rgscoreNear[dx] + i) <= (uint)local_66[3])))) {
                    uVar2 = *(uint *)((int)(rgscoreNear[dx] + i) + 2);
                    if ((local_66[4] < (int)uVar2) || ((local_66[4] <= (int)uVar2 && ((uint)local_66[3] <= *(uint *)(rgscoreNear[dx] + i))))) {
                        local_66[2] = local_66[2] + 1;
                    } else {
            ...
            x = Random(local_66[2]);
            i = 0;
            while ((sVar5 = x, i < 3 && (((*(uint *)(rgscoreNear[dx] + i) != local_66[3] || (*(int *)((int)(rgscoreNear[dx] + i) + 2) != local_66[4])) ||
                                          (x = x + -1, sVar5 != 0))))) {
                i = i + 1;
            }
            yCur = yCur + i + -1;
            ...
            if (((int)uVar3 < (int)uVar2) ||
                (((int)uVar3 <= (int)uVar2 && (*(uint *)(rgscoreNear[dx] + dy) < *(uint *)(rgscoreNear[local_66[2]] + local_66[3]))))) {
            LAB_10f0_66d1:
                i = 0;
            } else {
                if (((int)rgscoreNear[dx][dy] == (int)rgscoreNear[local_66[2]][local_66[3]]) &&
                    (*(int *)((int)(rgscoreNear[dx] + dy) + 2) == *(int *)((int)(rgscoreNear[local_66[2]] + local_66[3]) + 2))) {
                    sVar5 = Random(2);
                    if (sVar5 == 0)
                        goto LAB_10f0_66d1;
                }
    ...
    if ((cTorpBase == 0) || (pctBase == 0)) {
        ...
        if (pctBC == 0) {
            if (((uint)pctJam == 0) && (pctJam._2_2_ == 0)) {
                ...
                lVar4 = 100;
                uVar3 = __aFulmul((long)pctBase, CONCAT22(-(uint)(100 < (uint)pctJam) - pctJam._2_2_, 100 - (uint)pctJam));
                uVar3 = __aFldiv(uVar3, lVar4);
            }
        } else {
            lVar4 = 100;
            uVar3 = __aFulmul(CONCAT22(-(uint)(100 < (uint)pctBase) - (pctBase >> 0xf), 100 - pctBase), (long)(100 - pctBC));
...

{
    ...
    lphul = &LpshdefFromTok((TOK *)CONCAT13((char)((uint)vrgtok._2_2_ >> 8), CONCAT12((char)vrgtok._2_2_, (TOK *)vrgtok + itokAttacker)))->hul;
                ...
                if ((part.hs.grhst == hstBeam) && ((pBVar10->grfAbilities & 2U) != 0)) {
                    ...
                    for (itok = 0; itok < vctok; itok = itok + 1) {
                        ...
                        if ((pTVar9->wFlags & 1) != 0) {
                            ...
                            if ((pTVar9->iplr != ((TOK *)ptok)->iplr) && ((1 << (pTVar9->iplr & 0x1f) & grfAttack) != 0)) {
                                dp = uVar18;
                                cTorpsLeft = uVar15;
                                dpMain = uVar19;
                                score = lVar17;
                                    ...
                                    if ((pTVar9->iplr != ((TOK *)ptok)->iplr) && ((1 << (pTVar9->iplr & 0x1f) & grfAttack) != 0)) {
                                        ...
                                        if (sVar3 <= dxRangeCur) {
                                            ...
                                            if (sVar3 != 0) {
                                                ...
                                                uVar18 = __aFulmul((ulong)CONCAT12(CARRY2(uVar1, uVar4), uVar1 + uVar4), (ulong)pTVar9->csh);
                                                ...
                                                dpShieldLeft = uVar18;
                                                uVar18 = __aFulmul(CONCAT22(dpSingle._2_2_, (ushort)dpSingle), (ulong)pTVar9->csh);
                                                if ((&pTVar9->dv)->dp != 0) {
                                                    uVar30 = 0;
                                                    uVar31 = 0;
                                                    uVar28 = 0xf4;
                                                    ...
                                                    uVar14 = 10;
                                                    dpArmorLeft = uVar18;
                                                    uVar18 = __aFulmul(CONCAT22(dpSingle._2_2_, (ushort)dpSingle), (ulong)((&pTVar9->dv)->dp >> 7));
                                                ...
                                                if ((part.hs.grhst == hstBeam) || (part.hs.grhst != hstTorp)) {
                                                    ...
                                                    if ((((BEAM *)part.u_PART_0x0004.pbeam)->grfAbilities & 1U) == 0) {
                                                        ...
                                                        uVar18 = __aFulmul(lValue, 100);
                                                        lVar17 =
                                                            __aFldiv(uVar18 + dpShieldLeft + -1, CONCAT13(uVar31, CONCAT12(uVar30, CONCAT11(uVar29, uVar28))));
                                                        uVar15 = cTorpsLeft;
                                                        uVar19 = dpMain;
                                                    }
                                                } else {
                                                    ...
                                                    if (pTVar11->pctBC < pTVar9->pctJam) {
                                                        ...
                                                        uVar28 = 100;
                                                        uVar29 = 0;
                                                        uVar18 = __aFulmul((long)(int)(uint)pctHit, (long)(int)((uint)pTVar9->pctJam - (uint)pTVar11->pctBC));
                                                        lVar17 = __aFldiv(uVar18, CONCAT13(uVar31, CONCAT12(uVar30, CONCAT11(uVar29, uVar28))));
                                                        pctHit = CONCAT22((pctHit._2_2_ - (int)((ulong)lVar17 >> 0x10)) - (uint)((uint)pctHit < (uint)lVar17),
                                                        ...
                                                        uVar28 = 100;
                                                        uVar29 = 0;
                                                        uVar18 = __aFulmul(CONCAT22(-(uint)(100 < (uint)pctHit) - pctHit._2_2_, 100 - (uint)pctHit),
                                                                           (long)(int)((uint)pTVar11->pctBC - (uint)pTVar9->pctJam));
                                                        lVar17 = __aFldiv(uVar18, CONCAT13(uVar31, CONCAT12(uVar30, CONCAT11(uVar29, uVar28))));
                                                    ...
                                                    if (pctHit < 1) {
                                                        ...
                                                        if (dpArmorLeft < 100000) {
                                                            ...
                                                            lVar17 = __aFlshl(CONCAT13(uVar31, CONCAT12(uVar30, CONCAT11(uVar29, uVar28))), unaff_DI);
                                                            uVar18 = __aFldiv(lVar17, CONCAT13(uVar31, CONCAT12(uVar30, CONCAT11(uVar29, uVar28))));
                                                            lVar17 = pctHit;
                                                        } else {
                                                            uVar30 = 0;
                                                            uVar31 = 0;
                                                        ...
                                                        if (dpShieldLeft < 100000) {
                                                            ...
                                                            uVar19 = __aFldiv(uVar19, CONCAT13(uVar31, CONCAT12(uVar30, CONCAT11(uVar29, uVar28))));
                                                        } else {
                                                            uVar30 = 0;
                                                            uVar31 = 0;
                                                            uVar28 = 100;
                                                            ...
                                                            uVar19 = __aFulmul(uVar19, CONCAT13(uVar31, CONCAT12(uVar30, CONCAT11(uVar29, uVar28))));
                                                        }
                                                        ...
                                                        lVar17 = __aFldiv(uVar15, CONCAT13(uVar31, CONCAT12(uVar30, CONCAT11(uVar29, uVar28))));
                        ...
                        if (part.hs.grhst == hstBeam) {
                            ...
                            if (0 < dz) {
                                if (0 < ((ARMOR *)part.u_PART_0x0004.parmor)->dp) {
                                    ...
                                    uVar18 = __aFulmul(dp, CONCAT22(-(uint)(100 < (uint)lVar17) - (int)((ulong)lVar17 >> 0x10), 100 - (uint)lVar17));
                                    uVar18 = __aFldiv(uVar18, CONCAT13(uVar31, CONCAT12(uVar30, CONCAT11(uVar29, uVar28))));
                                    dp = uVar18;
                                }
                            }
                            ...
                            if ((dp < 1) || (dpT < 1)) {
                                ...
                                if ((((dpMain < 0x20000) && (dpMain < 0x10000)) && (dp < 0x20000)) && (dp < 0x10000)) {
                                    ...
                                    uVar19 = __aFldiv(uVar18, CONCAT13(uVar31, CONCAT12(uVar30, CONCAT11(uVar29, uVar28))));
                                } else {
                                    uVar19 = __ftol((double)CONCAT26((int)((ulong)lVar16 >> 0x10), CONCAT24((int)lVar16, CONCAT22(unaff_SI, unaff_DI))));
                                }
                                lValue = uVar19;
                                uVar15 = cTorpsLeft;
                                lVar17 = score;
                            ...
                            if ((part.hs.grhst == hstTorp) && (0 < cTorpsLeft)) {
                                ...
                                lVar17 = CTorpHit(cTorpsLeft, ptokTarget, ((BEAM *)part.u_PART_0x0004.pbeam)->grfAbilities, (uint)pTVar9->pctBC);
                                cTorpHit = lVar17;
                                lpshdefE = LpshdefFromTok(ptokTarget);
                                dpSingle._0_2_ = (((SHDEF *)lpshdefE)->hul).dp;
                                dpSingle._2_2_ = 0;
                                uVar12 = (undefined2)((ulong)ptokTarget >> 0x10);
                                uVar18 = __aFulmul((ulong)((TOK *)ptokTarget)->dpShield, (ulong)((TOK *)ptokTarget)->csh);
                                dpShieldLeft = uVar18;
                                uVar18 = __aFulmul(CONCAT22(dpSingle._2_2_, (ushort)dpSingle), (ulong)((TOK *)ptokTarget)->csh);
                                uVar12 = (undefined2)((ulong)ptokTarget >> 0x10);
                                ...
                                if (i < cTorpBase) {
                                    ...
                                    for (; i <= cTorpBase; i = i + 1) {
                                        ...
                                        lVar17 = __aFldiv(uVar18 + cTorpBase + -1, CONCAT13(uVar31, CONCAT12(uVar30, CONCAT11(uVar29, uVar28))));
                                        cTorpMiss._0_2_ = i - (uint)lVar17;
                                        cTorpMiss._2_2_ = ((i >> 0xf) - (int)((ulong)lVar17 >> 0x10)) - (uint)((uint)i < (uint)lVar17);
                                        uVar30 = 0;
                                        uVar31 = 0;
                                        uVar28 = 8;
                                        uVar29 = 0;
                                        ...
                                        lVar20 = __aFldiv(uVar18, CONCAT13(uVar31, CONCAT12(uVar30, CONCAT11(uVar29, uVar28))));
                                        iVar2 = (local_7c - (int)((ulong)lVar20 >> 0x10)) - (uint)(local_7e < (uint)lVar20);
                                        uVar30 = 0;
                                        uVar31 = 0;
                                        uVar28 = 2;
                                        uVar29 = 0;
                                        uVar18 = __aFulmul(cTorpFire, dp);
                                        lVar21 = __aFldiv(uVar18, CONCAT13(uVar31, CONCAT12(uVar30, CONCAT11(uVar29, uVar28))));
                                        if ((iVar2 < 1) && (iVar2 < 0)) {
                                            lVar21 = lVar21 - (lVar17 - lVar20);
                                        }
                                        if (dpArmorLeft <= lVar21)
                                            break;
                                    }
                                } else {
                                LAB_10f0_79f6:
...

{
    ...
    if (cshKill != 0) {
        ...
        if (uVar3 == 0) {
            ...
            if ((ishdef == 0x10) && (((FLEET *)lpfl)->wFlags_0x4 = ((FLEET *)lpfl)->wFlags_0x4 & 0xfbff | 0x400, fFallout != 0)) {
                for (i = 0; i < 3; i = i + 1) {
    ...
    while (true) {
        ...
        *(undefined2 *)((int)rgwtMinerals + i * 4 + 2) = 0;
        for (j = 0; j < 0x10; j = j + 1) {
            if (0 < pfl->rgcsh[j]) {
                ...
                lVar15 = 3;
                uVar14 = __aFulmul((long)pfl->rgcsh[j], (ulong)(((SHDEF *)lpshdefT)->hul).rgwtOreCost[i]);
        ...
        *piVar2 = *piVar2 + uVar7 + (uint)CARRY2(uVar9, uVar6);
        if (((PLANET *)lppl != (PLANET *)0x0) || (lppl._2_2_ != 0)) {
            ...
            uVar14 = __aFulmul(CONCAT22(*(undefined2 *)((int)rgwtMinerals + i * 4 + 2), (int)rgwtMinerals[i]), (ulong)uVar9);
            lVar15 = __aFldiv(uVar14, lVar15);
...
short FDamageTok(TOK *ptok, short itok, long *pdpBeam, long dpTorp, ushort grfWeapon, short fShieldsOnly, long *pcTorp)
        ...
        *(int *)((int)pdpBeam + 2) = dp._2_2_;
        ...
        if (*&pTVar9->u_TOK_0x0003 == '\x01') {
            ...
            if (((long)uVar16 < 0) || (((long)uVar16 < 0x10000 && ((uint)dp < uVar8)))) {
                ...
                *(uint *)((byte *)lpbBattleCur + 6) = *(uint *)((byte *)lpbBattleCur + 6) & 0x7f | (*(uint *)&pPVar2->lStarbase >> 4) << 7;
                fStarbaseDamaged = 1;
            } else {
                uVar21 = (undefined2)((ulong)lpbBattleCur >> 0x10);
                *(uint *)((byte *)lpbBattleCur + 6) = *(uint *)((byte *)lpbBattleCur + 6) & 0x7f | 64000;
            ...
            *puVar7 = *puVar7 | 0x8000;
            ...
            if (cshOrigDamaged != 0) {
                ...
                while (((lVar17 <= (long)uVar14 && (csh != 0)) && (((int)cKillMax != 0 || (cKillMax._2_2_ != 0))))) {
            ...
            while ((((long)uVar3 <= (long)uVar14 && (csh != 0)) && (((int)cKillMax != 0 || (cKillMax._2_2_ != 0))))) {
                uVar14 = uVar14 - uVar3;
                csh = csh + -1;
                bVar12 = (int)cKillMax == 0;
                cKillMax._0_2_ = (int)cKillMax + -1;
...
short FDoCoolBattle(FLEET *lpfl, short cplr, ushort *rggrfAttack, ushort grfPlayer, ushort grfSpectator)

{
    ...
    if (((FLEET *)lpfl)->idPlanet != -1) {
        ...
        if (((pPVar9->wFlags_0x4 >> 9 & 1) != 0) && ((1 << ((byte)pPVar9->iPlayer & 0x1f) & grfPlayer) != 0)) {
            cShdefsInvolved = cShdefsInvolved + 1;
            cShipsInvolved = cShipsInvolved + 1;
            *(uint *)((int)&pPVar9->lStarbase + 2) = *(uint *)((int)&pPVar9->lStarbase + 2) & 0xbfff | 0x4000;
        }
    }
    ...
    for (iRound = 0; iRound < 0x10; iRound = iRound + 1) {
        ...
        for (itok = 0; itok < vctok; itok = itok + 1) {
            if ((((TOK *)vrgtok)[itok].wFlags & 1) != 0) {
                ...
                local_27c = (PLANET *)(CONCAT22(((TOK *)vrgtok)[itok].wFlags_0x19, (PLANET *)local_27c) & 0xfffffff);
                ((TOK *)vrgtok)[itok].wFlags_0x19 = local_27c._2_2_;
                if (((0 < iRound) && (((TOK *)vrgtok)[itok].dpShield != 0)) && ((((TOK *)vrgtok)[itok].wFlags & 1) != 0)) {
                    sVar7 = GetRaceGrbit((PLAYER *)rgplr + ((TOK *)vrgtok)[itok].iplr, ibitRaceRegeneratingShields);
                    if (sVar7 != 0) {
                        ...
                        if (wtT == wt) {
                            ...
                            if (j <= (int)(pTVar11->wFlags >> 0xe)) {
                                ...
                                *(uint *)(pbVar5 + 4) = *(uint *)(pbVar5 + 4) & 0xff0f | (uVar8 & 0xf) << 4;
                                ...
                                pTVar11->wFlags = pTVar11->wFlags & 0x3fff;
                                pTVar11->wFlags = pTVar11->wFlags | local_27e;
                                if ((*&pTVar11->u_TOK_0x0003 == '\x01') || ((brcOrig == pTVar11->brc && (pTVar11->initMin != 0xff)))) {
                                    lpbBattleCur._0_2_ = (byte *)lpbBattleCur + -6;
                                } else {
        ...
        for (init = initMac; initMin <= init; init = init + -1) {
            iVar1 = vctok;
            if (rgfInit[init] != 0) {
                while (uVar16 = vrgtok._2_2_, uVar12 = lpbBattleCur._2_2_, pbVar5 = (byte *)lpbBattleCur, itok = iVar1 + -1, -1 < itok) {
                    iVar1 = itok;
                    if (((int)(uint)((TOK *)vrgtok)[itok].initMin <= init) && (init <= (int)(uint)((TOK *)vrgtok)[itok].initMac)) {
                        grplrLeft = 0;
                        for (i = 0; i < vctok; i = i + 1) {
                            if ((((TOK *)vrgtok)[i].wFlags & 1) != 0) {
                                grplrLeft = grplrLeft | 1 << (((TOK *)vrgtok)[i].iplr & 0x1f);
    ...
    *(int *)(pbVar4 + 6) = (int)(byte *)lpbBattleCur - (int)pbVar4;
    SendBattleMessages(lpfl, cplr, *pbVar13, rgPlrLosses, grfPlayer, cShipsInvolved, cShdefsInvolved, grfSpectator);
...

{
    ...
    if (((*(uint *)((int)&rgplr[0].wFlags + iplr * 0xc0) >> 3 & 1) == 0) && (sVar3 = Random(100), 0x31 < sVar3)) {
        for (i = 0; i < 0xd; i = i + 1) {
            sVar3 = Random(0xd);
            if (((((byte *)rgTechTrader)[sVar3] != 0) && ((1 << ((byte)sVar3 & 0x1f) & *(uint *)((int)&rgplr[0].grbitTrader + iplr * 0xc0)) == 0)) &&
        ...
        for (i = 0; i < 6; i = i + 1) {
            sVar3 = Random(6);
            if ((int)*(char *)(iplr * 0xc0 + 0x59bc + sVar3) < (int)(uint)((byte *)rgTechBattle)[sVar3]) {
...
void SendBattleMessages(FLEET *lpflBtl, short cplr, short idBtl, ushort *rgPlrLosses, short grfPlayer, short cShipsInvolved, short cShdefsInvolved,
                        ushort grfSpectator)

{
    ...
    if (pFVar6->idPlanet == -1) {
        ...
        if (iThem != -1) {
            ...
            if ((fStarbaseDied != 0) && (sVar4 = GetRaceStat((PLAYER *)rgplr + pPVar2->iPlayer, rsMajorAdv), sVar4 == raMacintosh)) {
    ...
    do {
        ...
        LAB_10f0_ad23:
            ...
            if ((fStarbaseDied == 0) || (sVar4 = GetRaceStat((PLAYER *)rgplr + iplrStarbase, rsMajorAdv), sVar4 != raMacintosh)) {
                ...
                FSendPlrMsg(iplr, idm, idBtl | 0x4000, x, y, j, (uint)lpopStarbase, (short)uVar8, (short)uVar9, (short)((ulong)uVar9 >> 0x10));
            }
        }
        iplr = iplr + 1;
    } while (true);
...

{
    ...
    uVar2 = *(uint *)(*(int *)((BTLPLAN **)rglpbtlplan + iVar1) + (uint)((FLEET *)lpfl)->iplan * 0x24 + 2) >> 8 & 0x1f;
    if (uVar2 == 0) {
        uVar2 = 0;
    } else if (uVar2 == 1) {
        ...
        if ((((pFVar3->wFlags_0x4 >> 10 & 1) == 0) && (pFVar3->idPlanet != -1)) && ((pFVar3->wFlags_0x4 >> 0xc & 1) == 0)) {
            ...
            if ((pPVar12->iPlayer != pFVar3->iPlayer) && (pPVar12->iPlayer != -1)) {
                ...
                if ((sVar6 != 0) && ((((PLANET *)lppl)->wFlags_0x4 >> 9 & 1) == 0)) {
                    sVar6 = FCalcFleetBombDamage(lpfl, &dmgBombPeople, &dmgBombFloor, &dmgPeopleSmart, &dmgBombBldg, &pctTerra, &fMulti);
                    if (sVar6 != 0) {
                        ...
                        if (bVar16) {
                            lVar20 = dmgBombFloor;
                            if (0 < dmgBombPeople) {
                                lVar20 = __ftol((double)CONCAT26(in_stack_0000ffa6, CONCAT24(in_stack_0000ffa4, CONCAT22(unaff_SI, unaff_DI))));
                            ...
                            if (0 < lVar17) {
                                ...
                                lVar17 = __ftol((double)CONCAT26(in_stack_0000ffa6, CONCAT24(in_stack_0000ffa4, CONCAT22(unaff_SI, unaff_DI))));
                                lVar20 = dmgBombFloor;
                            }
                            dmgPeopleSmart = lVar17;
                            dmgBombFloor = lVar20;
                        ...
                        cPPE._2_2_ = in_stack_0000ffa6 + (uint)CARRY2(uVar7, in_stack_0000ffa4) + (uint)CARRY2(uVar8, uVar9);
                        ...
                        cKillFact._2_2_ = 0;
                        cKillFact = 0;
                        if (((0 < dmgBombBldg) && (cKillFact = 0, cKillDefenses = 0, uVar18 = 0, -1 < cPPE._2_2_)) &&
                            ...
                            cKillFact = lVar20;
                            uVar18 = __aFulshr(CONCAT22(unaff_SI, unaff_DI), in_stack_0000ffa4);
                            if ((-1 < cKillFact) && ((0xffff < cKillFact || (((uint)uVar18 & 0xfff) < (uint)cKillFact)))) {
                                uVar18 = __aFulshr(CONCAT22(unaff_SI, unaff_DI), in_stack_0000ffa4);
                                cKillFact = (long)((uint)uVar18 & 0xfff);
                            }
                            cKillDefenses = __aFulmul((ulong)(*(uint *)(((PLANET *)lppl)->rgbImp + 4) & 0xfff), dmgBombBldg);
                            ...
                            if ((-1 < (long)uVar18) && ((0xffff < (long)uVar18 || ((*(uint *)(((PLANET *)lppl)->rgbImp + 4) & 0xfff) < (uint)cKillDefenses)))) {
                            ...
                            uVar18 = cKillMine;
                            if ((-1 < cKillMine) && ((0xffff < cKillMine || (((uint)uVar19 & 0xfff) < (uint)cKillMine)))) {
                                uVar18 = __aFulshr(CONCAT22(unaff_SI, unaff_DI), in_stack_0000ffa4);
                                uVar18 = (ulong)((uint)uVar18 & 0xfff);
                            }
                        }
                        if (((0 < dmgBombPeople) || (0 < dmgBombFloor)) || (lVar20 = CONCAT22(cKillPeople._2_2_, (uint)cKillPeople), 0 < dmgPeopleSmart)) {
                            uVar15 = (undefined2)((ulong)lppl >> 0x10);
                            pPVar12 = (PLANET *)lppl;
                            iVar4 = *(int *)((int)pPVar12->rgwtMin + 0xe);
                            lVar20 = CONCAT22(cKillPeople._2_2_, (uint)cKillPeople);
                            if ((-1 < iVar4) && ((0 < iVar4 || (lVar20 = CONCAT22(cKillPeople._2_2_, (uint)cKillPeople), (int)pPVar12->rgwtMin[3] != 0)))) {
                                uVar23 = 0;
                                uVar21 = 1000;
                                cKillMine = uVar18;
                                uVar18 = __aFulmul(CONCAT22(*(undefined2 *)((int)pPVar12->rgwtMin + 0xe), (int)pPVar12->rgwtMin[3]), dmgPeopleSmart);
                                lVar20 = __aFldiv(uVar18, CONCAT22(uVar23, uVar21));
                                uVar15 = (undefined2)((ulong)lppl >> 0x10);
                                pPVar12 = (PLANET *)lppl;
                                if (CONCAT22(*(undefined2 *)((int)pPVar12->rgwtMin + 0xe), (int)pPVar12->rgwtMin[3]) <= lVar20) {
                                    iVar4 = (int)pPVar12->rgwtMin[3];
                                    lVar20 = CONCAT22(*(int *)((int)pPVar12->rgwtMin + 0xe) + -1 + (uint)(iVar4 != 0), iVar4 + -1);
                                }
                                ...
                                uVar15 = (undefined2)((ulong)lppl >> 0x10);
                                pPVar12 = (PLANET *)lppl;
                                if (CONCAT22(*(undefined2 *)((int)pPVar12->rgwtMin + 0xe), *(uint *)(pPVar12->rgwtMin + 3)) < lVar20) {
                                    lVar20 = CONCAT22(*(undefined2 *)((int)pPVar12->rgwtMin + 0xe), (int)pPVar12->rgwtMin[3]);
                                }
                            }
                        }
                        ...
                        if (0 < cKillFact) {
                            ...
                            pPVar12 = (PLANET *)lppl;
                            local_54._6_2_ =
                                (*(int *)(pPVar12->rgbImp + 2) - (int)((ulong)lVar20 >> 0x10)) - (uint)(*(uint *)pPVar12->rgbImp < (uint)lVar20) & 0xfff0;
                        ...
                        if (0 < (long)uVar18) {
                            ...
                            uVar15 = (undefined2)((ulong)lppl >> 0x10);
                            pPVar12 = (PLANET *)lppl;
                            uVar5 = (ulonglong)CONCAT22((*(int *)(pPVar12->rgbImp + 2) - (int)((ulong)lVar20 >> 0x10)) -
                                                            (uint)(*(uint *)pPVar12->rgbImp < (uint)lVar20),
                                                        *(uint *)pPVar12->rgbImp - (uint)lVar20) &
                                    0xfff00;
                        ...
                        if ((-1 < pctTerra._2_2_) && ((0 < pctTerra._2_2_ || ((uint)pctTerra != 0)))) {
                            ...
                            cKillPeople = lVar20;
                            cKillMine = uVar18;
                            lVar20 = __ftol((double)CONCAT26(2, CONCAT24(in_stack_0000ffa4, CONCAT22(unaff_SI, unaff_DI))));
                            ...
                            while (true) {
                                ...
                                if ((int)uVar9 < 1) {
                                    if ((int)uVar9 < 0) {
                                        ...
                                        if ((pctTerra._2_2_ <= iVar11) && ((pctTerra._2_2_ < iVar11 || ((uint)pctTerra <= -uVar9)))) {
                                            local_54._0_6_ = CONCAT24(-(uint)pctTerra, (undefined4)local_54);
                                            local_54 = CONCAT26(iVar4, (undefined6)local_54);
                                        }
                                        ((PLANET *)lppl)->rgEnvVar[local_54._2_2_] =
                                            ((PLANET *)lppl)->rgEnvVar[local_54._2_2_] - (char)((ulonglong)local_54 >> 0x20);
                                        iVar4 = local_54._6_2_ - local_54._4_2_;
                                        local_54 = CONCAT26(iVar4, (undefined6)local_54);
                                    }
                                } else {
                                    if ((pctTerra._2_2_ <= (int)uVar9 >> 0xf) && ((pctTerra._2_2_ < (int)uVar9 >> 0xf || ((uint)pctTerra <= uVar9)))) {
                                        local_54._0_6_ = CONCAT24((uint)pctTerra, (undefined4)local_54);
                                        local_54 = CONCAT26(iVar4, (undefined6)local_54);
                                    }
                                    ((PLANET *)lppl)->rgEnvVar[local_54._2_2_] =
                            ...
                            if (0 < (int)local_54._6_2_) {
                                ...
                                FSendPlrMsg(((FLEET *)lpfl)->iPlayer, MVar10, lpfl->id | 0x8000, lpfl->id, lppl->id, local_54._6_2_, 0, 0, 0, 0);
                                if (fMulti == 0) {
                                    MVar10 = idmHasRetroBombedUndoingTerraforming;
                                } else {
                                    MVar10 = idmFleetsHaveRetroBombedUndoingTerraforming2;
                                }
                                FSendPlrMsg(((PLANET *)lppl)->iPlayer, MVar10, lppl->id, lpfl->id, lppl->id, local_54._6_2_, 0, 0, 0, 0);
                                lVar20 = cKillPeople;
                                uVar18 = cKillMine;
                            }
                        }
                        ...
                        if (cPPE < 1) {
                            if (0 < lVar20) {
                                ...
                                FSendPlrMsg(((FLEET *)lpfl)->iPlayer, idmSrc, lpfl->id | 0x8000, lpfl->id, lppl->id, (uint)cKillPeople, 0, 0, 0, 0);
                                cKillPeople = lVar20;
                                FSendPlrMsg(((PLANET *)lppl)->iPlayer, idmDst, lppl->id, lpfl->id, lppl->id, (uint)cKillPeople, 0, 0, 0, 0);
                                lVar20 = cKillPeople;
                                uVar18 = cKillMine;
                            }
                        } else {
                            ...
                            BATTLE_GenericBombMsg:
                                cKillPeople = lVar20;
                                cKillMine = uVar18;
                                FSendPlrMsg(((FLEET *)lpfl)->iPlayer, idmSrc, lpfl->id | 0x8000, lpfl->id, lppl->id, (short)lVar20, (int)cPPE, 0, 0, 0);
                                FSendPlrMsg(((PLANET *)lppl)->iPlayer, idmDst, lppl->id, lpfl->id, lppl->id, (uint)cKillPeople, (int)cPPE, 0, 0, 0);
                                lVar20 = cKillPeople;
                                uVar18 = cKillMine;
                            } else {
                                if (fMulti == 0) {
                                ...
                                if ((lVar20 < 0) || ((lVar20 < 0x10000 && (bVar16 = false, (uint)cKillPeople == 0)))) {
                                    ...
                                    __aFfcompp();
                                    if (bVar16) {
                                        FSendPlrMsg(((FLEET *)lpfl)->iPlayer, idmSrc, lpfl->id | 0x8000, lpfl->id, lppl->id, (int)cPPE, 0, 0, 0, 0);
                                        FSendPlrMsg(((PLANET *)lppl)->iPlayer, idmDst, lppl->id, lpfl->id, lppl->id, (int)cPPE, 0, 0, 0, 0);
                                        lVar20 = cKillPeople;
                                        uVar18 = cKillMine;
                                    } else {
                                        idmSrc = idmSrc + 5;
                                        ...
                                        FSendPlrMsg(((FLEET *)lpfl)->iPlayer, idmSrc, lpfl->id | 0x8000, lpfl->id, lppl->id, (int)cPPE, (short)lVar20, sVar6,
                                                    sVar22, sVar24);
                                        sVar24 = 0;
                                        sVar22 = 0;
                                        sVar6 = 0;
                                        lVar20 = __ftol((double)((ulonglong)unaff_DI << 0x30));
                                        FSendPlrMsg(((PLANET *)lppl)->iPlayer, idmDst, lppl->id, lpfl->id, lppl->id, (int)cPPE, (short)lVar20, sVar6, sVar22,
                                                    sVar24);
                                        lVar20 = cKillPeople;
                                        uVar18 = cKillMine;
                                    }
                                    ...
                                    uVar18 = cKillMine;
                                    if (bVar16)
                                        goto BATTLE_GenericBombMsg;
                                    idmSrc = idmSrc + 5;
                                    idmDst = idmDst + 5;
                                    sVar22 = 0;
                                    sVar6 = 0;
                                    lVar20 = __ftol((double)((ulonglong)CONCAT22(unaff_SI, unaff_DI) << 0x20));
                                    FSendPlrMsg(((FLEET *)lpfl)->iPlayer, idmSrc, lpfl->id | 0x8000, lpfl->id, lppl->id, (uint)cKillPeople, (int)cPPE,
                                                (short)lVar20, sVar6, sVar22);
                                    sVar22 = 0;
                                    sVar6 = 0;
                                    lVar20 = __ftol((double)((ulonglong)CONCAT22(unaff_SI, unaff_DI) << 0x20));
                                    FSendPlrMsg(((PLANET *)lppl)->iPlayer, idmDst, lppl->id, lpfl->id, lppl->id, (uint)cKillPeople, (int)cPPE, (short)lVar20,
                                                sVar6, sVar22);
                                    lVar20 = cKillPeople;
                                    uVar18 = cKillMine;
                                }
