...

{
  ...
  if (sVar2 == 0) {
    if (fClear == 0) {
      ...
      fSuccess = DialogBox(0,IDD_DLG93_93,hwndFrame,lpDlgProc);
          ...
          if (message == WM_LBUTTONDOWN) {
            ...
            *ppcVar7 = pcVar4;
            ...
            if (local_3a._2_2_ == local_3a._6_2_ + -1) {
              ...
              sVar6 = DialogBox(0,IDD_DLG89_89,hwnd,lpDlgProc);
              FreeProcInstance(lpDlgProc);
              if (sVar6 == 0) {
  ...
  do {
    ...
    if ((-1 < (long)uVar14) && ((uVar14 != 0 || (i != 1)))) {
      ...
      for (k = 0; k < 4; k = k + 1) {
        ...
        SelectObject(hdc,rghfontArial8[1]);
        SetTextColor(hdc,CONCAT22(*(undefined2 *)(iVar8 * 4 + rgcrMinerals_0x2),
                                  *(undefined2 *)(iVar8 * 4 + rgcrMinerals)));
        ...
        sVar6 = _wsprintf(szWork,PCTLD,(int)rgCost[k],
                          *(undefined2 *)((int)rgCost + k * 4 + 2));
        RightTextOut
                  (hdc,(rc.right - (int)DVar13) + -2,rc.bottom,(char *)szWork,sVar6,
                   dxMaxMineralQuan);
        if (k < 3) {
...

{
  ...
  if (message == WM_PAINT) {
    ...
    TextOut(hdc_00,(short)(local_3c._2_2_ + 8),(int)local_38 - (dyArial8 >> 1),
  ...
  if (iResTechNow != 0) {
    uVar9 = 0x14f8;
    sVar6 = DialogBox(0,IDD_DLG2019_2019,hwndFrame,local_36);
    puVar8 = &stack0xffba;
    pvVar3 = local_36;
  ...
  if (wParam == 0x816) {
    ...
    *(undefined2 *)(puVar8 + -1) = 0x5ca0;
    uVar10 = __aFulshr(*puVar8,(ushort)puVar8[1]);
    *(byte *)((int)(ZIPPRODQ1 *)&vrgZipProd[0].u_ZIPPRODQ_0x000e.zpq1 +
             iResTechNow * 0x28) = (byte)uVar10 & 1;
