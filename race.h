...
/* functions */
int16_t RaceWizardDlg6(uint16_t hwnd, uint16_t message, uint16_t wParam, int32_t lParam);  /* PASCAL */  /* MEMORY_RACE:0x3bae */
int16_t RaceWizardDlg5(uint16_t hwnd, uint16_t message, uint16_t wParam, int32_t lParam);  /* PASCAL */  /* MEMORY_RACE:0x378e */
int16_t RaceWizardDlg4(uint16_t hwnd, uint16_t message, uint16_t wParam, int32_t lParam);  /* PASCAL */  /* MEMORY_RACE:0x320a */
...
void DrawRace3(uint16_t hwnd, uint16_t hdc, int16_t iDraw);  /* MEMORY_RACE:0x2aa4 */
void InvalidateAdvPtsRect(uint16_t hwnd);  /* MEMORY_RACE:0x54d4 */
int16_t SetRaceStat(PLAYER *pplr, int16_t iStat, int16_t iVal);  /* MEMORY_RACE:0x3114 */
void SetRCWTitle(uint16_t hwnd, int16_t iStep);  /* MEMORY_RACE:0x5ab8 */
void DrawRace2(uint16_t hwnd, uint16_t hdc, int16_t iDraw);  /* MEMORY_RACE:0x179a */
int16_t FTrackRaceDlg3(uint16_t hwnd, POINT pt, int16_t kbd);  /* MEMORY_RACE:0x2fb8 */
int16_t FTrackRaceDlg2(uint16_t hwnd, POINT pt, int16_t kbd);  /* MEMORY_RACE:0x2204 */
